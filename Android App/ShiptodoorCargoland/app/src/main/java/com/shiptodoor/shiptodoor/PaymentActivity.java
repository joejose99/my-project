opackage com.shiptodoor.shiptodoor;
...
private int error =0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       ed1 = (EditText) findViewById(R.id.txtCard);
        ...
        butPay.setText(txtPrice.toString() + " Pay Now" );
...
private String splitCurrency(String cur1,String cur){
    ...
    private void performCharge() {
        ...
        txtEmail =intent3.getStringExtra("txtEmail");
            txtUserId=intent3.getStringExtra("txtUserId");
         String  strDollars= intent3.getStringExtra("txtDollar");
            txtDollar=  Integer.parseInt(strDollars);
...
*/
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    postDataParams.put("paymentType", txtPaymentType);
