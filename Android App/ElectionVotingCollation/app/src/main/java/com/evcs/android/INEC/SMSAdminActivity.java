...
import com.eciels.android.INEC.databinding.ActivitySmsadminBinding;

public class SMSAdminActivity extends AppCompatActivity  implements OnItemSelectedListener {
...
/*
    String HttpURL = "https://www.evcs.ng/project/fcm.php";
 ...
 */
String HttpURL = "https://evcs.ng/project/fcm.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try{
            setContentView(R.layout.activity_smsadmin);
 ...
 */
    ...
    public void addListenerOnButton() {
            ...
            public void onClick(View v) {
			    ...
			    */
                ...
                if(CheckEditText){
                    ...
                    Toast.makeText(SMSAdminActivity.this, "Please fill all form fields.", Toast.LENGTH_LONG).show();
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SMSAdminActivity.this, MenuAdminActivity.class);
    ...
    public void SendMessagePage(final String Message, final String Spanner1, final String Spanner2 , final String Spanner3, final String Spanner4 , final String Spanner5, final String Spanner6){
        ...
        class MessageClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(SMSAdminActivity.this,"Sending ....",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                if(httpResponseMsg.trim().equalsIgnoreCase("Success")){
                    ...
                    Toast.makeText(SMSAdminActivity.this,httpResponseMsg,Toast.LENGTH_LONG).show();
                    ed1.setText("") ;
                }
                else{
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    postDataParams.put("msg", UserNameHolder);
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        if(ctr ==1)
        {
            Toast.makeText(SMSAdminActivity.this,"Data Not Found!!",Toast.LENGTH_LONG).show();
            ctr=0;
        }
