...
public class SMS extends AppCompatActivity implements OnItemSelectedListener {
	...
	public void addItemsOnSpinner2() {
		...
		spinner2.setAdapter(dataAdapter2);
			...
			b2.setOnClickListener(new View.OnClickListener() {
		        ...
		        public void onClick(View v) {
		                ...
		                finish();
		                 ...
		                 Intent intent = new Intent(SMS.this, Menu_app_election.class);
		  ...
		  private void loadIntoListView(String json) throws JSONException {
		      ...
		      if(ctr ==1)
		      {
		    	  Toast.makeText(SMS.this,"Data Not Found!!",Toast.LENGTH_LONG).show();
		    	  ctr=0;
		      }
