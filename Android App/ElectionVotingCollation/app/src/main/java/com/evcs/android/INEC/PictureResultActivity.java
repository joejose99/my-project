...
public class PictureResultActivity extends AppCompatActivity implements OnItemSelectedListener {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (ids == R.id.spinner2) {
            ...
            Log.e("************* POLLING UNIT**************", sp5.toString());
            //txtSpinnerPop4 = (String) spinner4.getSelectedItem();
    ...
    public void addListenerOnButton() {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PictureResultActivity.this, MenuAdminActivity.class);
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        if(ctr ==1)
        {
            Toast.makeText(PictureResultActivity.this,"Data Not Found!!",Toast.LENGTH_LONG).show();
            ctr=0;
        }
        ...
        class WardsClass extends AsyncTask<String,Void,String> {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    postDataParams.put("status", "picture");
...
int ctr=0;
        ...
        for(int x=0;x<result.length();x++) {
            ...
            foodlist.add(new FoodDomain(obj3.getString("pollingUnit"),obj3.getString("ward"),obj3.getString("pollingUnit"),obj3.getString("image_path")));
...
if(ctr == 0){
        ...
        PopularAdapter  adapter3 = new PopularAdapter(foodlist);
...
/*
***
*  SELECT POLLING UNIT TO GET RESULT OF THE UNIT
*
*
 */
    ...
    private void loadIntoPolUnit_RST(String json) throws JSONException {
       ...
       // listPol.clear();
        ...
        //Log.i("Length Data","Result Length  *******" + result2.length() );
       // Log.i("CTR Data","Counters  *******" + ctr );
 ...
 */
    ...
    /*
     *
     * POPULATING POLLING UNIT RST ENDS HERE
     *
     * */
