...
import com.eciels.android.INEC.ShowVideoDetails;
...
public class VideoAdapter extends RecyclerView.Adapter<VideoAdapter.ViewHolder> {
    ArrayList<VideoDomain>videoDomains;
Context context;
    public VideoAdapter(ArrayList<VideoDomain> VideoDomains) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_video, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
         ...
         holder.category.setText(videoDomains.get(position).getWard());
        String titles=videoDomains.get(position).getTitle();
        if(titles.length()>12){
 ...
 */
        ...
        //Picasso.get().load(videoDomains.get(position).getPic()).into(holder.pic);
        ...
        holder.addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(holder.itemView.getContext(), ShowVideoDetails.class);
                intent.putExtra("object", videoDomains.get(position));
