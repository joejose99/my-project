...
public class VideoDomain implements Serializable {
    ...
    public VideoDomain(String pollingunit, String ward,  String title, String pic) {
        this.title = title;
        this.pic = pic;
    ...
    public VideoDomain(String pollingunit, String ward,  String title, String pic , int numberInCart) {
        this.title = title;
        this.pic = pic;
        this.pollingunit = pollingunit;
        this.ward = ward;
