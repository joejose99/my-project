...
import com.cargoland.cargolandfoods.databinding.ActivityPasswordBinding;
        ...
        try{
            ...
            butBack.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try{
                        Intent intent = new Intent(password.this,email.class);
            ...
            butPwd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try{
                        ...
                        {
                            Intent intent = new Intent(password.this,address.class);
                            ...
                            Toast.makeText(password.this, "Please fill all form fields Correctly.", Toast.LENGTH_LONG).show();
                        }
