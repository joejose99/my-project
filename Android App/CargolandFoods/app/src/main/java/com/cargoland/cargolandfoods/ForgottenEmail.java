...
public class ForgottenEmail extends AppCompatActivity {
    ...
    //private String HttpURL = "https://www.eciesl.com/inventory/forgotten_email.php";
    //String HttpURL="https://www.admin.lfcasaba.org/forgotten-email";
    //private String HttpURL = "https://www.cargoland.shiptodoor.com/cargoland/forgotten_email.php";
    String HttpURL="https://www.cargoland.shiptodoor.com/forgotten-email-foods";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        butBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ForgottenEmail.this,UserLogin.class);
