...
import com.cargoland.cargolandfoods.Show_Detail;
...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String titles=foodDomains.get(position).getItemName();
        if(titles.length()>12){
 ...
 */
        ...
        holder.addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("Data","Popular Click ************** "+myDataString.getCategory_Type());
                ...
                else if(foodDomains.get(position).getTitle().trim().equals("Food")){

                    Log.i("Data","INN Popular Click FOOOD ************** ");
                    myDataString.setCategory_title(foodDomains.get(position).getTitle());
