...
import com.cargoland.cargolandfoods.Activity.IntroActivity;
...
import com.cargoland.cargolandfoods.databinding.ActivityThankYouBinding;
        ...
        butThank.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(getUserId().equals(null)){
                    Intent intent = new Intent(Thank_You.this,UserLogin.class);
                    startActivity(intent);


                    finish();
                }else{
                    Intent intent = new Intent(Thank_You.this, IntroActivity.class);
                    startActivity(intent);
