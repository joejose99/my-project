...
public class HttpGetImage {
    ...
    // public String getImage(String HttpUrlHolder){
    ...
    public String postRequest(String HttpUrlHolder) throws Exception {{
...
/*
                bufferedWriter.write("cargoland");
