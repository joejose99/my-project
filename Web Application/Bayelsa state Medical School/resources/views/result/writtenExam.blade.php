...
@section('content')
         ...
         <script src="{{ asset('../js/jquery-3.4.1.js') }}"></script>     
            ...
            <!--
             ...
             <div style="float:right; width:155px; margin-top:5px; text-align:right; max"> 
            <input name="delete" value="Multiple Delete" type="button" class="delete"  id="multiDel"> </div>
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          
              <div style="float:right; width:155px; margin-top:5px; text-align:right; max">   <input name="butInsert" type="submit" value="Insert Data"   id="exp" class="but" onClick="window.location.href='insert-written-exam'" > </div>
...
<div style="float:left; text-align:center; width:68%;">

<span ><img src="../../image/arrow.gif" width="5" height="10" />&nbsp&nbsp;Written Exam</span> 
 &nbsp;&nbsp; 
	...
	//console.log(data[0].optionA);
	  ...
	  /* if($.trim(role) == 'Super Admin')
			{ */
			 ...
			 var table="<table width='98%' bgcolor='#FFFFFF ' cellpadding='2' cellspacing='2'  align='center' id='+ tbl +'<tr > <th bgcolor='#ffffff ' align='left' valign='top' style=' text-align:center;' width='150' >Student Id</th> <th   width='150' bgcolor='#ffffff ' align='left' valign='top' style='  text-align:center;  ' >First Name</th><th width='  150'bgcolor='#ffffff' align='left' valign='top' style='text-align:center;' >Middle Name</th> <th width='150'bgcolor=' #ffffff ' align='left' valign='top' style='text-align:center;' >Surname</th> <th width='150'bgcolor='#ffffff' align='left' valign='top' style='text-align:center;' >Academic Session</th> <th width='150'bgcolor=' #ffffff' align='  left' valign='top' style='text-align:center;' >Course</th> <th width='160'bgcolor='' align=' left  ' valign='top' style='text-align:center;' >Total Mark Score</th> <th width='150'bgcolor='#ffffff ' align='left' valign='top' style='text-align:center;'>Date</th> <th  width='50' bgcolor=' #ffffff ' align='left'  valign='  top  ' style='  text-align:center;  '><strong> </strong> </th>  <th  width='50' bgcolor=' #ffffff ' align='left'  valign='  top  ' style='  text-align:center;  '><strong> </strong> </th>  </tr>";
   ...
   $("#tbl").html(table);
	  ...
	  /* 
	   ...
	   for (i=0;i < data.length;i++)
		...
		var editLink=data[i].rstId+'_'+'Written Exam';		
			 		
					
option +="<tr><td align='left'    valign='top' class='table-td' ><span  style='margin:8px; display:block;'>" + data[i].stdId +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].fName +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].midName +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].surname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].academic_session +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].cosId +" &nbsp;- &nbsp;" + data[i].course +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].mark +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].created_at +"</span></td >  <td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='edit-result/ " +editLink +" ' class='update'>Edit</a> </span></td > <td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox' onClick='get_Values(" + data[i].rstId +")' value='" +data[i].rstId +" ' id='" +data[i].rstId +"'  </span><input name='"+ txts.concat(data[i].rstId) +"' id='"+ txts.concat(data[i].rstId) +"' type='hidden' value='"+ data[i].fName +"'><select name='lst' id='lst' hidden=''  ></select></td ></tr>"
  ...
  $("#txtSearch").keyup(function(ev) {
	...
	var ctr =0;
     ...
     $.ajax({ 
	  dataType:"json", 
	    type:"POST",
         url:'search-student-result',
         data:{"_token":$('#signup-token').val(),"search":$("#txtSearch").val(),"session":$("#session").val(),"resultType":exam},
		 processData:"false",
         success: function(data) {
   ...
   $("#tbl").html(table);
	  ...
	  /* 
	   ...
	   for (i=0;i < data.length;i++)
		...
		var editLink=data[i].rstId+'_'+'Assignment';		
