...
@section('content')
         ...
         <script src="{{ asset('../js/jquery-3.4.1.js') }}"></script>     
            ...
            <input name="delete" value="Multiple Delete" type="button" class="delete"  id="multiDel"> </div>
              ...
              <div style="float:right; width:155px; margin-top:5px; text-align:right; max">   <input name="butInsert" type="submit" value="Insert Data"   id="exp" class="but" onClick="window.location.href='insert-test'" > </div>
...
<span ><img src="../../image/arrow.gif" width="5" height="10" />&nbsp&nbsp;Test Result</span> 
 &nbsp;&nbsp; 
   ...
   $("#tbl").html(table);
	  ...
	  /* 
	   ...
	   for (i=0;i < data.length;i++)
		...
		var editLink=data[i].rstId+'_'+'Test';		
