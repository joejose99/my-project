...
@section('content')
         ...
         <script src="{{ asset('../js/jquery-3.4.1.js') }}"></script>     
            ...
            <!--
             ...
             <div style="float:right; width:130px; margin-top:5px; text-align:right; max"> 
            <input name="delete" value="Multiple Delete" type="button" class="delete"  id="multiDel"> </div>
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          
              <div style="float:right; width:130px; margin-top:5px; text-align:right; max">   <input name="butInsert" type="submit" value="Insert Data"   id="exp" class="but " onClick="window.location.href='insert-assignment-mark'"  > </div>
...
<div style="float:left; text-align:center; width:72%;">

<span ><img src="../../image/arrow.gif" width="5" height="10" />&nbsp&nbsp;Assignment Mark</span> 
 &nbsp;&nbsp; 
