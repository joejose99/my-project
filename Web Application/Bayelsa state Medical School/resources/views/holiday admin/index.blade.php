 ...
 th
{
 ...
 <div class="panel panel-default">
                <div class="panel-heading">
                  ...
                  <div style="float:right; width:290px; margin-top:-5px; text-align:right;"><label  id="SelectError"> </label>  <input name="butInsert" type="button" value="Insert Data" onClick="window.location.href='insert-holiday'" class="but">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="delete" value="Multiple Delete" type="button" class="delete"  id="multiDel"></div>
                  &nbsp&nbsp;
...
<tr > 
 ...
 <th width=''bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Holiday</th> 
...
<td align='left' bgcolor=''  valign ='top' class="table-td mainbody" >
 <span  style="margin:8px; display:block; font-weight:normal;" class="mainbody">
...
{!!$rst->created_at!!}
  ...
  <td align='left' bgcolor='#1D4B6D'  valign ='top' ><span  style="margin:8px; display:block;"> <a href ='edit-holiday/{{ $rst->id }}' class='update'>Edit</a></span></td >
...
<script>
	...
	{	
	  ...
	  dataType:"json", 
	    type:"POST",
         url:'delete-multiple-holiday/quesId',
...
option +="<tr>   <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].details.substring(0,50) +"..</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>"+ data[i].status   +" </span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].created_at +"</span></td ><td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='edit-holiday/ " +data[i].id +" ' class='update'>Edit</a> </span></td ><td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <a href ='#'  class= 'del'  onClick='destroy("+ data[i].id +" )'>Delete</a>  </span></td ><td align='center' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox'  onClick='get_Values(" +data[i].id +")' value='" +data[i].id +" ' id='" +data[i].id +"'  </span><input name='"+ txts.concat(data[i].id) +"' id='"+ txts.concat(data[i].id) +"' type='hidden' value='"+ data[i].details.substring(0,50) +"'><select name='lst' id='lst' hidden=''  ></select></td >";
