         ...
         <script src="{{ asset('../js/jquery-3.4.1.js') }}"></script>     
            ...
            <!--
             ...
             {{-- {{ csrf_field() }} --}} -->
              ...
              <div style="float:right; width:310px; margin-top:5px; text-align:right;">   <input name="butInsert" type="submit" value="Insert Data"  class="but" id="insert" onClick="window.location.href='insert-total-result'" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<span ><img src="../../image/arrow.gif" width="5" height="10" />&nbsp&nbsp;Total Result</span> 
 &nbsp;&nbsp; 
...
<div id="totSch" style="float:left; margin:-4px; width:37%; text-align:center; margin-left:4%;">   <input name="txtsearch" type="text" id="txtSearch" class="searchTextbox" placeholder="Search Student Id" onkeypress="return isNumberKey(event) " onblur="if(this.value=='') 
this.value='';" onfocus="if(this.value=='Search Student Id')"  >

</div>

<div style="float:right; width:20%; margin-top:-4px;  margin-bottom:10px; text-align:left;">   <input name="exp" type="submit" value="Export Data"  class="but hide_question" id="exp"></div>
...
<tr > 
 ...
 <th width='50'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;" >Grade</th>
...
<select name="lst" id="lst" hidden=""   ></select>
 <input name="txt{!!$rst-> totId!!}" id="txt{!!$rst-> totId!!}" type="hidden" value="{!!$rst->fName!!}">
...
{{-- @if (trim($role['role']) --}} =='Super Admin') -->
 ...
 <span  style="margin:8px; display:block;">
 <input name="" type="checkbox" value=" {!! $rst-> totId !!}" onClick="get_Values('{!! $rst-> totId !!}')">
...
<script>
 ...
 $("#multiDel").click(function(ev) {
	...
	{	
	  ...
	  dataType:"json", 
	    type:"POST",
         url:'delete-multiple-total-result/quesId',
   ...
   $("#txtSearch").keyup(function(ev) {
	...
	var ctr =0;
     ...
     $.ajax({ 
	  dataType:"json", 
	    type:"POST",
         url:'search-student-total-result',
         data:{"_token":$('#signup-token').val(),"search":$("#txtSearch").val() ,"session":$("#session").val()},
		 processData:"false",
         success: function(data) {
