...
<div id="error-page" style="text-align:center; font-weight:bold;"> </div>
  ...
  <div class="form-group{{ $errors->has('optionA') ? ' has-error' : '' }}"  >
          <label for="optionA" class="col-md-4 control-label " style="margin-top:15px; width:200px;text-align:right; " >Name:* &nbsp;</label>

        <div class="col-md-6" style="margin-top:10px;">
          <input id="optionA" type="text" class="form-control" name="optionA" value="{{ Auth::user()->name }}" required autofocus autocomplete="off">
     ...
     <label for="optionB" class="col-md-4 control-label" style="margin-top:15px;width:200px;text-align:right;">Role:* &nbsp;</label>

                            <div class="col-md-6" style="margin-top:10px;">
      <input id="optionB" type="text" class="form-control" name="optionB" value="{{ Auth::user()->role }}" required autofocus autocomplete="off">
   ...
   <div class="form-group{{ $errors->has('optionD') ? ' has-error' : '' }}"   >
                            ...
                            <div class="col-md-6" style="margin-top:10px;">
                                <input id="optionD" type="text" class="form-control" name="optionD" value="{{ Auth::user()->email }}" required autofocus autocomplete="off" >

 
 <input id="id" type="hidden" class="form-control" name="id" value="{{ Auth::user()->id }}" required autofocus autocomplete="off" >
...
<input name="butBack" id="butBack" type="button" value="&nbsp;&nbsp;Back &nbsp;&nbsp;" class="but" onClick="window.location.href='../profile'" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
/*	$('#form1').validate({ // initialize the plugin
	...
	var errors= '<span class=rstclass style=color:#C63A26;> &nbsp;&nbsp;  Name is required !! &nbsp;</span>';
