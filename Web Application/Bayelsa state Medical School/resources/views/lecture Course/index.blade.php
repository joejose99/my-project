...
<script src="{{asset('../js/jquery-3.4.1.js') }}"></script>
 ...
 <div class="panel panel-default" >
                <div class="panel-heading">
                  ...
                  <span  class="mainbody"><img src="../../image/arrow.gif" width="5" height="10" class="mainbody" />&nbsp&nbsp;Lecture Course</span>
                  
                 <div style="float:right; width:290px; margin-top:-5px; text-align:right;"> <input name="butInsert" type="button" value="Insert Data" onClick="window.location.href='insert-Lecture-Course'" class="but">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="delete" value="Multiple Delete" type="button" class="delete"  id="multiDel"></div>
                  
                  
             <div id="totSch" style="float:right; margin-top:-5px; width:54%; text-align:center;" class="mainbody">  <input name="txtsearch" type="text" id="txtSearch" class="searchTextbox" placeholder="Search First Name" onkeypress="return isNumberKey(event) " onblur="if(this.value=='') 
...
<tr > 
 ...
 <th width='150'bgcolor='' align='left' valign='top' style="text-align:center;">Course Title </th> 
 
 <th width='120'bgcolor='' align='left' valign='top' style="text-align:center;">Course Unit</th> 
  
 
   
  
 <th width='120'bgcolor='' align='left' valign='top' style="text-align:center;">Registered Date</th> 

  
 

<th width='60'bgcolor='' align='left' valign='top' style="text-align:center;"></th> 

  <th width='50'bgcolor='' align='left' valign='top' style="text-align:center;"></th> 
...
@foreach($query as $rst)
 ...
 <a   href="#popup1"  onclick="getCourseDetails({{ $rst->lecId }})">
  {!!$rst->cosId!!}  
  </a>
</span>
 ...
 <input name="txt{!! $rst->lecId !!}" id="txt{!! $rst->lecId !!}" type="hidden" value="{!!$rst->course!!}" /></td >
<input name="txtDetails{!! $rst->lecId !!}" id="txtDetails{!! $rst->lecId !!}" type="hidden" value="{!!$rst->courseDetails!!}" />
<input name="txtCosId{!! $rst->lecId !!}" id="txtCosId{!! $rst->lecId !!}" type="hidden" value="{!!$rst->cosId!!}" />

<input name="txtfName{!! $rst->lecId !!}" id="txtfName{!! $rst->lecId !!}" type="hidden" value="{!!$rst->fName!!}" />
<input name="txtSurname{!! $rst->lecId !!}" id="txtSurname{!! $rst->lecId !!}" type="hidden" value="{!!$rst->surname!!}" />

<input name="txtTitle{!! $rst->lecId !!}" id="txtTitle{!! $rst->lecId !!}" type="hidden" value="{!!$rst->title!!}" />
...
{!!$rst->created_at!!}
   ...
   <!--
   <a href ='editCourse/{{ $rst->lecId }}' class='update'>Edit</a>
   -->

 
  
    <td align='left' bgcolor='#980905'  valign ='top' ><span  style="margin:8px; display:block;"> <a href ='#' class="del"onclick="destroy({{ $rst->lecId }})">Delete</a> </span>
    </td >

  
<td align='center' bgcolor='#980905'  valign ='top' class="table-td" ><span  style="margin:8px; display:block;">
      <input name="input" type="checkbox" value=" {!! $rst->lecId !!}" onclick="get_Values('{!! $rst->lecId !!}')" />
    </span></td >
...
<script>
	...
	{	
	  ...
	  dataType:"json", 
	    type:"POST",
         url:'delete_multiple-lecture-course/quesId',
...
var table="<table width='98%' bgcolor='#FFFFFF ' cellpadding='2' cellspacing='2'  align='center' id='+ tbl +'<tr ><th  width='150' bgcolor='#ffffff' align='left' valign='top' style='text-align:center;'>Course Code</th><th  width='150' bgcolor='#ffffff ' align='left' valign='top' style='text-align:center;'>Course </th><th width='120' bgcolor='#ffffff' align='left' valign='top' style='  text-align:center;'>Course Unit</th>  <th   width='120' bgcolor='#ffffff ' align='left' valign='top' style='  text-align:center;'>Registered Date</th> <th width='60'bgcolor='#ffffff ' align='left' valign='top'   scope='col'style='text-align:center;  '> </th> <th  width='50'bgcolor=' #ffffff ' align='left'  valign='  top  ' style='  text-align:center;  '><strong> </strong> </th></tr>";
...
option +="<tr> <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'> <a   href='#popup1' onclick='getCourseDetails("+ data[i].lecId +")'>" + data[i].cosId +"</a></span></td > <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].course +"</span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>   "+ data[i].courseUnit   +"</span></td >   <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].created_at +"</span></td > <td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <a href ='#'  class= 'del'  onClick='destroy("+ data[i].lecId +" )'>Delete</a>  </span></td ><td align='center' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox'  onClick='get_Values(" +data[i].lecId +")' value='" +data[i].lecId +" ' id='" +data[i].lecId +"'  </span><input name='"+ txts.concat(data[i].lecId) +"' id='"+ txts.concat(data[i].lecId) +"' type='hidden' value='"+ data[i].course	 +"'><input name='"+ txtDetails.concat(data[i].lecId) +"' id='"+ txtDetails.concat(data[i].lecId) +"' type='hidden' value='"+ data[i].courseDetails+"'><input name='"+ txtCosId.concat(data[i].lecId) +"' id='"+ txtCosId.concat(data[i].lecId) +"' type='hidden' value='"+ data[i].cosId	 +"'><select name='lst' id='lst' hidden=''  ></select> <input name='"+ txtfName.concat(data[i].lecId)+"' id='"+  txtfName.concat(data[i].lecId)+"' type='hidden' value='"+ data[i].fName+"'><input name='"+ txtSurname.concat(data[i].lecId)+"' id='"+ txtSurname.concat(data[i].lecId)+"' type='hidden' value='"+ data[i].surname +"' /> <input name='"+ txtTitle.concat(data[i].lecId)+"' id='"+ txtTitle.concat(data[i].lecId)+"' type='hidden' value='"+ data[i].title+"' /></td ></tr> ";
	...
	function getCourseDetails(quesId)	
	{
		 ...
		 var txtfNames= txtfName.concat(quesId);
		 var txtSurnams= txtSurname.concat(quesId);
		 var txtTitles= txtTitle.concat(quesId);
		...
		var cosIds= cosId.concat(quesId);
		  ...
		  var details = document.getElementById(txtDetailss).value;
		   ...
		   var fName = document.getElementById(txtfNames).value;
		   
		   var title = document.getElementById(txtTitles).value;
		    
		  
		  var surname = document.getElementById(txtSurnams).value;
		  
		  
		
		  $("#contents").html('<h3>'+ courseId +'  Course Description</h3>'); 
		  
		   var conts =title.concat(' ').concat(fName).concat(' ').concat(surname);
		   
		   
		  
		  
		  $("#contents").append('<strong> Lecturers: '+conts +'<br><br> </<srong>'); 
