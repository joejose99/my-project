...
<select class="selectAdmin" name="program1" id="program1"> 
        ...
        <a class="button" href="#popup1"  onclick="getPrgCourse()">Lectured Course</a>
...
option +="<tr> <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].cosId	 +"</span></td > <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].course +"</span></td > <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>   "+ data[i].courseUnit   +"</span></td ><td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>   "+ data[i].courseDetails.substring(0,50)   +"..</span></td > <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].courseMode +"</span></td >  <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].created_at +"</span></td ><td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='editProgramCourse/"+data[i].prcId +"' class='update'>Edit</a> </span></td ><td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <a href ='#'  class= 'del'  onClick='destroy("+ data[i].prcId +" )'>Delete</a>  </span></td ><td align='center' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox'  onClick='get_Values(" +data[i].prcId +")' value='" +data[i].prcId +" ' id='" +data[i].prcId +"'  </span><input name='"+ txts.concat(data[i].prcId) +"' id='"+ txts.concat(data[i].prcId) +"' type='hidden' value='"+ data[i].course	 +"'><select name='lst' id='lst' hidden=''  ></select></td >";
	...
	{ 
	  ...
	  dataType:"json", 
	    type:"POST",
         url:'delete-lecture-course/quesId',
         data:{"_token":$('#signup-token').val(),"quesId":quesId,"lcrId":prgId},
		 processData:"false",
         success: function(data) {
		...
		var table="<table width='98%'   cellpadding='2' cellspacing='2'  align='center' id='+ tbl +'<tr ><th  width='130' bgcolor='#ffffff' align='left' valign='top' style='text-align:center;'>Course Code</th><th  width='180' bgcolor='#ffffff ' align='left' valign='top' style='text-align:center;'>Course Title </th><th width='120' bgcolor='#ffffff' align='left' valign='top' style='  text-align:center;'>Course Unit</th>   <th width='60'bgcolor='#ffffff ' align='left' valign='top'   scope='col'style='text-align:center;  '> </th> </tr>";
...
option +="<tr> <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].cosId	 +" <input type='hidden' name='"+ txtcode.concat(data[i].courseId) +"' id='"+ txtcode.concat(data[i].courseId) +"' value='"+ data[i].cosId +"'></span></td > <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].course +"</span></td > <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>   "+ data[i].courseUnit   +"</span></td >  <td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='#' class='update' onClick='insertPrgCourse("+data[i].courseId +" )'>Add Course</a> </span></td > </tr> ";
 ...
 var dataArray= JSON.stringify(dtArray);
	  ...
	  dataType:"json", 
	    type:"POST",
         url:'create-lecture-course-view',
         data:{"_token":$('#signup-token').val(),"dataArray":dataArray},
		 processData:"false",
         success: function(data) {
...
$("#prg").html("<span style='text-align: center; font-family: Tahoma, Arial, sans-serif;color: #3C8DBC; margin: 80px 0;'>"+ data[0].title  +" &nbsp;"+ data[0].fName  +" &nbsp;"+ data[0].surname  +"</span> ");
		
		var table="<table class='table' width='98%'   cellpadding='2' cellspacing='2'  align='center' id='+ tbl +'<tr ><th  width='160' bgcolor='#ffffff' align='left' valign='top' style='text-align:center;'>Course Code</th><th  width='320' bgcolor='#ffffff ' align='left' valign='top' style='text-align:center;'>Course Title </th><th width='180' bgcolor='#ffffff' align='left' valign='top' style='  text-align:center;'>Course Unit</th>    <th width='100'bgcolor='#ffffff ' align='left' valign='top'   scope='col'style='text-align:center;  '> </th> </tr>";
...
option +="<tr> <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].cosId	 +"</span></td > <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].course +"</span></td > <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>   "+ data[i].courseUnit   +"</span></td >  <td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <a href ='#'  class= 'del'  onClick='destroy("+ data[i].lecId +" )'>Delete</a>  </span></td ><input name='"+ txts.concat(data[i].lecId) +"' id='"+ txts.concat(data[i].lecId) +"' type='hidden' value='"+ data[i].course	 +"'></tr>";
...
function insertPrgCourse(quesId)	
	{
		...
		{
		  alert('Select  Faculty Mismatch ');
		  
		  var errors= '<span class=rstclass style=color:#C63A26;> &nbsp;&nbsp; Select  Faculty Mismatch !! &nbsp;</span>';
	  $("#error-page").html(errors);
		  return false;
		 ...
		 if(dpt1 !=dpt2 )
		{
		  alert('Select  Department Mismatch ');
		  
		  var errors= '<span class=rstclass style=color:#C63A26;> &nbsp;&nbsp; Select  Department Mismatch !! &nbsp;</span>';
	  $("#error-page").html(errors);
		  return false;
	  ...
	  $("#error-page").html(errors);
		 ...
		 if(txtSearch !='' && jQuery.trim(txtSearch)!= jQuery.trim(schss))
		 {
			 
		 
			  var errors= '<span class=rstclass style=color:#C63A26;> &nbsp;&nbsp;error Select Course From Lecturer Department  !! &nbsp;</span>';
	  $("#error-page").html(errors);
		  return false;
...
//var dataArray= JSON.stringify(dtArray);
     ...
     $.ajax({ 
	  dataType:"json", 
	    type:"POST",
         url:'search-course-fal-dpt-lecture-course',
   ...
   var sel="Select Lecturer";
			 ...
			 option ='<option value="">'+sel+'</option>';
				 ...
				 for (i=0;i < data.length;i++)
				{
					...
					option+='<option value ="'+data[i].lcrId +'">'+data[i].title +'&nbsp; '+ data[i].fName+' &nbsp;'+ data[i].surname+'</option>';
...
var table="<table width='98%'   cellpadding='2' cellspacing='2'  align='center' id='+ tbl +'<tr ><th  width='100' bgcolor='#ffffff' align='left' valign='top' style='text-align:center;'>Course Code</th><th  width='170' bgcolor='#ffffff ' align='left' valign='top' style='text-align:center;'>Course Title </th><th width='90' bgcolor='#ffffff' align='left' valign='top' style='  text-align:center;'>Course Unit</th>    <th width='90'bgcolor='#ffffff ' align='left' valign='top'   scope='col'style='text-align:center;  '> </th></tr>";
...
option +="<tr> <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.cosId	 +" <input type='hidden' name='"+txtcode.concat(val.courseId) +"' id='"+txtcode.concat(val.courseId) +"' value='"+ val.cosId +"'> </span></td > <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.course +"</span></td > <td align='left'     valign='top' class='table-td'><span  style='margin:8px; display:block;'>   "+ val.courseUnit   +"</span></td >    <td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='#' class='update' onClick='insertPrgCourse("+val.courseId +" )'>Add Course</a> </span></td ></tr> ";
