...
@section('content')
 ...
 <div class="panel panel-default">
  <div class="panel-heading">
                  ...
                  <div style="float:right; width:290px; margin-top:-5px; text-align:right;">  <input name="butInsert" type="button" value="Insert Data" onClick="window.location.href='insertCourse'" class="but">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="delete" value="Multiple Delete" type="button" class="delete"  id="multiDel"></div>
...
<tr > 
 ...
 <th width='100'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Course Type</th> 
...
@foreach($query as $rst)
 ...
 <span  style="margin:8px; display:block;">
  <a   href="#popup1"  onclick="getCourseDetails({{ $rst->courseId }})">
  {!!$rst->cosId!!} </a> 
</span>

 <select name="lst" id="lst" hidden=""  > </select>

 <input name="txt{!! $rst->courseId !!}" id="txt{!! $rst->courseId !!}" type="hidden" value="{!!$rst->course!!}" /></td >

<input name="txtDetails{!! $rst->courseId !!}" id="txtDetails{!! $rst->courseId !!}" type="hidden" value="{!!$rst->courseDetails!!}" />
<input name="txtCosId{!! $rst->courseId !!}" id="txtCosId{!! $rst->courseId !!}" type="hidden" value="{!!$rst->cosId!!}" />

  </td > 
  <td align='left' bgcolor=''  valign ='top' class="table-td" >
 <span  style="margin:8px; display:block;">
  {!! str_limit($rst->course,50)!!}  
</span>
 ...
 <span  style="margin:8px; display:block;">
  ...
  <td align='left' bgcolor=''  valign ='top' class="table-td" >
 <span  style="margin:8px; display:block;">
  {!!  str_limit($rst->courseDetails,50)!!}  
</span>
...
{!!$rst->created_at!!}
  ...
  <td align='left' bgcolor='#1D4B6D'  valign ='top' ><span  style="margin:8px; display:block;"> <a href ='editCourse/{{ $rst->courseId }}' class='update'>Edit</a></span></td >
    <td align='left' bgcolor='#980905'  valign ='top' ><span  style="margin:8px; display:block;"> <a href ='#' class="del"onclick="destroy({{ $rst->courseId }})">Delete</a> </span>
    </td >

  
<td align='center' bgcolor='#980905'  valign ='top' class="table-td" ><span  style="margin:8px; display:block;">
      <input name="input" type="checkbox" value=" {!! $rst->courseId !!}" onclick="get_Values('{!! $rst->courseId !!}')" />
    </span></td >
...
<script>
	...
	{	
	  ...
	  dataType:"json", 
	    type:"POST",
         url:'delete_multiple_course/quesId',
...
var table="<table width='98%' bgcolor='#FFFFFF ' cellpadding='2' cellspacing='2'  align='center' id='+ tbl +'<tr ><th  width='150' bgcolor='#ffffff' align='left' valign='top' style='text-align:center;'>Course Code</th><th  width='150' bgcolor='#ffffff ' align='left' valign='top' style='text-align:center;'>Course </th><th width='120' bgcolor='#ffffff' align='left' valign='top' style='  text-align:center;'>Course Unit</th> <th width='' bgcolor='#ffffff' align='left' valign='top' style='  text-align:center;'>Course Description</th> <th   width='120' bgcolor='#ffffff ' align='left' valign='top' style='  text-align:center;'>Registered Date</th> <th width='60'bgcolor='#ffffff ' align='left' valign='top'   scope='col'style='text-align:center;  '> </th><th  width='60'bgcolor=' #ffffff ' align='left'  valign='top'style='  text-align:center;  '><strong> </strong> </th><th  width='50'bgcolor=' #ffffff ' align='left'  valign='  top  ' style='  text-align:center;  '><strong> </strong> </th></tr>";
...
option +="<tr> <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'><a   href='#popup1' onclick='getCourseDetails("+ data[i].courseId +")'>" + data[i].cosId	 +"</a></span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].course +"</span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>   "+ data[i].courseUnit   +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>   "+ data[i].courseDetails.substring(0,50)   +"..</span></td >  <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].created_at +"</span></td ><td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='editCourse/"+data[i].courseId +"' class='update'>Edit</a> </span></td ><td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <a href ='#'  class= 'del'  onClick='destroy("+ data[i].courseId +" )'>Delete</a>  </span></td ><td align='center' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox'  onClick='get_Values(" +data[i].courseId +")' value='" +data[i].courseId +" ' id='" +data[i].courseId +"'  </span><input name='"+ txts.concat(data[i].courseId) +"' id='"+ txts.concat(data[i].courseId) +"' type='hidden' value='"+ data[i].course	 +"'><input name='"+ txtDetails.concat(data[i].courseId) +"' id='"+ txtDetails.concat(data[i].courseId) +"' type='hidden' value='"+ data[i].courseDetails+"'><input name='"+ txtCosId.concat(data[i].courseId) +"' id='"+ txtCosId.concat(data[i].courseId) +"' type='hidden' value='"+ data[i].cosId	 +"'><select name='lst' id='lst' hidden=''  ></select></td ></tr>";
...
$(function() {
 ...
 $("#faculty1").change(function(ev) {
	...
	var ctr =0;
	  ...
	  if($("#faculty1").val() == "Select Department")
	{
...
option +="<tr> <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'><a   href='#popup1' onclick='getCourseDetails("+ val.courseId +")'>" + val.cosId	 +"</a></span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.course +"</span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>   "+ val.courseUnit   +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>   "+ val.courseDetails.substring(0,50)   +"..</span></td >  <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.created_at +"</span></td ><td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='editCourse/"+val.courseId +"' class='update'>Edit</a> </span></td ><td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <a href ='#'  class= 'del'  onClick='destroy("+ val.courseId +" )'>Delete</a>  </span></td ><td align='center' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox'  onClick='get_Values(" +val.courseId +")' value='" +val.courseId +" ' id='" +val.courseId +"'  </span><input name='"+ txts.concat(val.courseId) +"' id='"+ txts.concat(val.courseId) +"' type='hidden' value='"+ val.course	 +"'><input name='"+ txtDetails.concat(val.courseId) +"' id='"+ txtDetails.concat(val.courseId) +"' type='hidden' value='"+ val.courseDetails+"'><input name='"+ txtCosId.concat(val.courseId) +"' id='"+ txtCosId.concat(val.courseId) +"' type='hidden' value='"+ val.cosId	 +"'><select name='lst' id='lst' hidden=''  ></select></td >";
...
var table="<table width='98%'   cellpadding='2' cellspacing='2'  align='center' id='+ tbl +'<tr ><th  width='150'  align='left' valign='top' style='text-align:center;'>Course Code</th><th  width='150'   align='left' valign='top' style='text-align:center;'>Course </th><th width='120'   align='left' valign='top' style='  text-align:center;'>Course Unit</th> <th width=''   align='left' valign='top' style='  text-align:center;'>Course Description</th> <th   width='120'   align='left' valign='top' style='  text-align:center;'>Registered Date</th> <th width='60'  align='left' valign='top'   scope='col'style='text-align:center;  '> </th><th  width='60'  align='left'  valign='top'style='  text-align:center;  '><strong> </strong> </th><th  width='50'bgcolor=' #ffffff ' align='left'  valign='  top  ' style='  text-align:center;  '><strong> </strong> </th></tr>";
