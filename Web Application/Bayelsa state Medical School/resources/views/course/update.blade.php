...
<div id="error-page" style="text-align:center; font-weight:bold;"> </div>
  ...
  <div class="form-group{{ $errors->has('optionA') ? ' has-error' : '' }}"  >
          <label for="optionA" class="col-md-4 control-label " style="margin-top:10px; width:200px;" >Course Code:* &nbsp;</label>

        <div class="col-md-9" >
          <input id="optionA" type="text" class="form-control" name="optionA" value="{!!$query[0]->cosId!!}" required autofocus autocomplete="off">
     ...
     <label for="optionB" class="col-md-4 control-label" style="margin-top:15px;width:200px;">Course Title:* &nbsp;</label>
                            ...
                            <div class="col-md-9" >
                             <input id="optionB" type="text" class="form-control" name="optionB" value="{!!$query[0]->course!!}" required autofocus autocomplete="off">
     ...
     <label for="optionB" class="col-md-4 control-label" style="margin-top:15px;width:200px;">Course Unit:* &nbsp;</label>
                            ...
                            <div class="col-md-9" >
                             <input id="optionC" type="text" class="form-control" name="optionC" value="{!!$query[0]->courseUnit!!}" required autofocus autocomplete="off">
             ...
             <label for="optionC" class="col-md-4 control-label" style="margin-top:15px;width:200px;">Course Type:* &nbsp;</label>

                 <div class="col-md-9" >
           <select name="courseType"  id="courseType" class="select">
                               <option  value="{!!$query[0]->courseType!!}">{!!$query[0]->courseType!!} </option> 
                             
                                 
   <option value="None GS"> None GS </option>
   <option value="GS">  GS </option>
     ...
     <label for="optionB" class="col-md-4 control-label" style="margin-top:15px;width:200px;">Course Description:* &nbsp;</label>
                            ...
                            <div class="col-md-10" >
                              <textarea name="txtOptionB" rows="5" autofocus="autofocus" required="required" class="form-control" id="txtOptionB" autocomplete="off">{!!$query[0]->courseDetails!!}</textarea>
            ...
            <div class="form-group{{ $errors->has('optionC') ? ' has-error' : '' }}"   >
             <label for="optionC" class="col-md-4 control-label" style="margin-top:15px;width:200px;">Faculty:* &nbsp;</label>
                 ...
                 <div class="col-md-9" >
           <select name="faculty" class="term" id="faculty">
   ...
   @endforeach 
          ...
          <select name="dpt" class="dpt" id="dpt">
                            ...
                            <input id="id" type="hidden" class="form-control" name="id" value="{!!$query[0]->cosId !!}" required autofocus autocomplete="off" >
             ...
             <label for="optionC" class="col-md-4 control-label" style="margin-top:15px;width:200px;">Level:* &nbsp;</label>
                 ...
                 <div class="col-md-9">
          <select name="dpt" class="cls" id="cls">
   ...
   <div class="form-group{{ $errors->has('optionC') ? ' has-error' : '' }}"   >
             <label for="optionC" class="col-md-4 control-label" style="margin-top:15px;width:200px;">Semester:* &nbsp;</label>
                 ...
                 <div class="col-md-9">
          <select name="dpt" class="term" id="term">
...
var dataArray= JSON.stringify(dtArray);
     ...
     $.ajax({ 
	  dataType:"json", 
	    type:"POST",
         url:'/editCourse/{{$query[0]->courseId}}',
