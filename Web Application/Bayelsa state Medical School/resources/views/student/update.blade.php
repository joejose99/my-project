...
<div id="error-page" style="text-align:center; font-weight:bold;"> </div>
  ...
  <div class="form-group{{ $errors->has('optionA') ? ' has-error' : '' }}"  >
        ...
        <div class="col-md-6" style="margin-top:10px;">
          <input id="txtStudentId" readonly="readonly" type="text" class="form-control" name="txtStudentId" value="{!!$query[0]->stdId!!}" required autofocus autocomplete="off">
 ...
 <input id="id" type="hidden" class="form-control" name="id" value="{!!$query[0]->stdId !!}" required autofocus autocomplete="off" >
