...
<div id="container_text_Admin" class="rstAdmin">
...
<div class="hide_question">
        ...
        <div class="col-md-6" style="margin-top:10px;">
          <input id="optionA" type="text" class="form-control" name="optionA" value="{!!$query[0]->acdId !!}" required autofocus autocomplete="off">
 
 <input id="txtActivate" type="hidden" class="form-control mainbody" name="txtActivate" readonly value="{!!$query[0]->activate !!}" required autofocus autocomplete="off" >
 
 <input id="txtPub" type="hidden" class="form-control mainbody" name="txtPub" readonly value="{!!$query[0]->publish !!}" required autofocus autocomplete="off" >
 ...
 <div style=" margin-bottom:20px;margin-left:5%; " class="rstclass" > <label style=" float:left;margin-top:10px; width:190px; text-align:right ">  Student Id:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>  
   ...
   <div class="col-md-7" style="width:300px;position:relative; " >
     <input id="optionB" type="text" class="form-control mainbody" name="optionB" value=" {!!$query[0]->stdId !!}" required autofocus autocomplete="off" >
 </div>
    
    <div class="col-md-2" style="width:100px;position:relative;  text-align:left;" >
     <input name="butSearch" id="butSearch" type="submit" value="Search" class="but hide_question" />
     </div>
    </div>
 ...
 <div style=" margin-bottom:20px;margin-left:5%; margin-top:10px; position:relative;" class="rstclass" > <label style=" float:left;margin-top:10px; width:170px;  text-align:right"> First Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</label>  
   ...
   <div class="col-md-7 mainbody" style="width:400px; margin-top:10px;position:relative;" >
     <input id="fName" type="text" class="form-control mainbody" name="fName" readonly value=" {!!$query[0]->fName !!}" required autofocus autocomplete="off" >
 </div>
 ...
 <div style=" margin-bottom:20px;margin-left:5%; margin-top:10px; position:relative;" class="rstclass" > <label style=" float:left;margin-top:10px; width:170px;  text-align:right"> Surname:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</label>  
   ...
   <div class="col-md-7 mainbody" style="width:400px; margin-top:10px;position:relative;" >
     <input id="surname" type="text" class="form-control mainbody" name="surname" readonly value=" {!!$query[0]->surname !!}" required autofocus autocomplete="off" >
 </div>
  ...
  <div id="insertsActivate" class="result_bg">                        
  ...
  @if(trim($query[0]->activate) =='Activate')
  ...
  <input name="optionE" type="radio" id="optHide" onClick="hideOption()" value="Activate"  checked="checked" />  &nbsp; &nbsp;
   ...
   <input name="optionE" type="radio" id="optShow" onClick="showOption()"   /> 
    ...
    @if(trim($query[0]->activate) =='Deactivate')
  
  <label style=" margin-top:10px; " for="optHide">&nbsp;Activate Account:</label>
  <input name="optionE" type="radio" id="optHide" onClick="hideOption()" value="" />  &nbsp; &nbsp;
   <label style="margin-top:10px; " for="optShow">&nbsp;Deactivate Account:</label>
   <input name="optionE" type="radio" id="optShow" onClick="showOption()"  value="Deactivate"  checked="checked"   /> 
 ...
 <div style=" margin-bottom:20px;margin-left:5%; margin-top:10px; position:relative;" class="rstclass"  id="lbl1"> <label style=" float:left;margin-top:10px; width:170px;  text-align:right"> Details:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</label>  
    
     
   <div class="col-md-7 mainbody" style="width:70%; margin-top:10px;position:relative;" >
     <textarea name="dActivate" cols="60" rows="7" autofocus required class="form-control mainbody" id="dActivate" autocomplete="off">{!!$query[0]->activate_details !!}</textarea>
   </div>
  ...
  <div id="insertsPublish" class="result_bg" >                        
       ...
       <div style=" margin-bottom:25px;margin-top:10px; margin-left:32%; " class="rstclass"> 
        ...
        @if(trim($query[0]->publish) =='Publish')                     
  ...
  <input name="optionP" type="radio" id="optPublish" onClick="hidePublish()" value="Publish"  checked="checked" />  &nbsp; &nbsp;
   ...
   <input name="optionP" type="radio" id="optUnpublish" onClick="showUnpublish()"   /> 
    ...
    @endif 
     ...
     @if(trim($query[0]->publish) =='Unpublish')                     
  <div class="col-md-6" style="width:540px;" >
  <label style=" margin-top:10px; " for="optPublish">&nbsp;Publish Result:</label>
  <input name="optionP" type="radio" id="optPublish" onClick="hidePublish()"  checked="Unchecked"    />  &nbsp; &nbsp;
   <label style="margin-top:10px; " for="optUnpublish">&nbsp;Unpublish Result:</label>
   <input name="optionP" type="radio" id="optUnpublish" onClick="showUnpublish()"  checked="checked" value="Unpublish"  /> 
 ...
 <div style=" margin-bottom:20px;margin-left:5%; margin-top:10px; position:relative;" class="rstclass hide_question"  id="lbl2"  > <label style=" float:left;margin-top:10px; width:170px;  text-align:right"> Details:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</label>  
   ...
   <div class="col-md-7 mainbody" style="width:70%; margin-top:10px;" >
     <textarea id="txtPublish" name="txtPublish"   cols="60" rows="7" autofocus required class="form-control mainbody"  autocomplete="off">{{ old('dPublish') }}</textarea></div>
   ...
   <div style="clear:both"> </div>
    ...
    @if(trim($query[0]->publish) =='Unpublish') 
 <div style=" margin-bottom:20px;margin-left:5%; margin-top:10px; position:relative;" class="rstclass"  id="lbl2" > <label style=" float:left;margin-top:10px; width:170px;  text-align:right"> Details:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</label>  
    
     
   <div class="col-md-7 mainbody" style="width:70%; margin-top:10px;" >
     <textarea id="txtPublish" name="txtPublish"   cols="60" rows="7" autofocus required class="form-control mainbody"  autocomplete="off">{!! trim($query[0]->publish_details) !!}</textarea> </div> 
...
var dataArray= JSON.stringify(dtArray);
     ...
     $.ajax({  
	    type:"POST",
         url:"edit-action-on-student",
         data:{"_token":$('#signup-token').val(),"dataArray":dataArray,"id":id},
		  dataType:"JSON",
		 processData:"false",
         success: function(data) {
    var saved= '<span class=rstclass style=color:#2965A0;> &nbsp;&nbsp; Data Successfully Saved &nbsp;</span>';
