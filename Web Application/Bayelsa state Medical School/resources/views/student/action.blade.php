 ...
 <div class="panel panel-default">
                <div class="panel-heading">
                 ...
                 <span ><img src="../../image/arrow.gif" width="5" height="10" />&nbsp&nbsp;Student</span>
                  ...
                  <div style="float:right; width:290px; margin-top:-5px; text-align:right;"><label  id="SelectError"> </label>  <input name="butInsert" type="button" value="Insert Data" onClick="window.location.href='insert-action-on-student'" class="but">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="delete" value="Multiple Delete" type="button" class="delete"  id="multiDel"></div>
...
<th width='180'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Academic Session</th> 
...
<th width='150'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Details</th> 
...
@foreach($query as $rst)
 ...
 <span  style="margin:8px; display:block;">
  ...
  <a href='#popup1' onclick='getStudentDetails({{$rst->aosId }})'>
{!!$rst->stdId!!}
</a>
</span>
...
<select name="lst" id="lst" hidden=""  > </select>
 ...
 <input name="txt{!! $rst->aosId !!}" id="txt{!! $rst->aosId !!}" type="hidden" value="{!! $rst->fName !!}" /> 
...
Result: &nbsp;{!!$rst->publish!!}
 ...
 <td align='left' bgcolor=''  valign ='top' class="table-td" >
 <span  style="margin:8px; display:block;">
Account: &nbsp; {!! str_limit(trim($rst->activate_details),40) !!}

<input id="txtActivate" type="hidden" class="form-control mainbody" name="txtActivate" readonly value="trim($rst->activate_details)" required autofocus autocomplete="off" >
<br /> 

Result: &nbsp; {!! str_limit(trim($rst->publish_details),40) !!}

<input id="txtActivate" type="hidden" class="form-control mainbody" name="txtActivate" readonly value="trim($rst->publish_details)" required autofocus autocomplete="off" >
</span>
 </td>
...
{!!$rst->created_at!!}
  ...
  <td align='left' bgcolor='#1D4B6D'  valign ='top' ><span  style="margin:8px; display:block;"> <a href ='edit-action-on-student/{{ $rst->aosId }}' class='update'>Edit</a></span></td >
     

  
<td align='center' bgcolor='#980905'  valign ='top' class="table-td" ><span  style="margin:8px; display:block;">
      <input name="input" type="checkbox" value=" {!! $rst->aosId !!}" onclick="get_Values('{!! $rst->aosId !!}')" />
    </span></td >
...
<th width='150'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Surname</th> 
 ...
 <th width='150'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Account</th> 



<th width='150'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Account Details</th> 

 
  <th width='150'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Result</th> 



<th width='150'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Result Details</th> 
...
<script>
	...
	{	
	  ...
	  dataType:"json", 
	    type:"POST",
         url:'delete-multiple-action-on-student/quesId',
   ...
   var table="<table width='98%' bgcolor='#FFFFFF ' cellpadding='2' cellspacing='2'  align='center' id='+ tbl +'<tr ><th  width='300' bgcolor='#ffffff' align='left' valign='top' style='text-align:center;'>Student Id</th><th  width='300' bgcolor='#ffffff' align='left' valign='top' style='text-align:center;'>First Name</th><th width='300' bgcolor='#ffffff' align='left' valign='top' style='  text-align:center;'>Surname</th><th width='300' bgcolor='#ffffff ' align='left' valign='top' style='  text-align:center;'>Academic Session</th><th   width='300' bgcolor='#ffffff ' align='left' valign='top' style='  text-align:center;'>Semester</th> <th   width='300' bgcolor='#ffffff ' align='left' valign='top' style='  text-align:center;'>Status</th><th   width='300' bgcolor='#ffffff ' align='left' valign='top' style='  text-align:center;'>Details</th> <th   width='300' bgcolor='#ffffff ' align='left' valign='top' style='  text-align:center;'>Registered Date</th>    <th  width='70'bgcolor=' #ffffff ' align='left'  valign='top'style='  text-align:center;  '><strong> </strong> </th><th  width='70'bgcolor=' #ffffff ' align='left'  valign='  top  ' style='  text-align:center;  '><strong> </strong> </th></tr>";
...
option +="<tr><td align='left'  valign='top' class='table-td'><span  style='margin:8px; display:block;'> <a   href='#popup1' onclick='getCourseDetails("+ data[i].stdId +")'>" + data[i].stdId +"</a></span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].fName +"</span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].surname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].academic_session +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].semester +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>Account: &nbsp;" + data[i].activate +"Result:&nbsp;" + data[i].publish +"</span></td ><td align='left' valign='top' class='table-td'><span  style='margin:8px; display:block;'>Details: &nbsp;" + data[i].activate_details.substr(0,40) +"Result:&nbsp;" + data[i].publish_details.substr(0,40) +"<input id='txtActivate' type='hidden' class='form-control mainbody' name='txtActivate ' readonly value="+ data[i].activate_details +" required autofocus autocomplete='off' ><input id='txtPublish' type='hidden' class='form-control mainbody' name='txtPublish ' readonly value="+ data[i].publish_details +" required autofocus autocomplete='off' ></span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].created_at +"</span></td > <td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='edit-action-on-student/"+data[i].aosId +"' class='update'>Edit</a> </span></td > <td align='center' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox'  onClick='get_Values(" +data[i].aosId +")' value='" +data[i].aosId +" ' id='" +data[i].aosId +"'  </span><input name='"+ txts.concat(data[i].aosId) +"' id='"+ txts.concat(data[i].aosId) +"' type='hidden' value='"+ data[i].fName +"'><select name='lst' id='lst' hidden='' ></select></td >";
...
option +="<tr><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'> <a   href='#popup1' onclick='getCourseDetails("+ data[i].stdId +")'>" + data[i].stdId +"</a></span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].fName +"</span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].midName +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].surname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].address +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].mobileNo +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].email +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].created_at +"</span></td > <td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='editStudent/"+data[i].stdId +"' class='update'>Edit</a> </span></td ><td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <a href ='#'  class= 'del'  onClick='destroy("+ data[i].studentId +" )'>Delete</a>  </span></td ><td align='center' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox'  onClick='get_Values(" +data[i].studentId +")' value='" +data[i].studentId +" ' id='" +data[i].studentId +"'  </span><input name='"+ txts.concat(data[i].studentId) +"' id='"+ txts.concat(data[i].studentId) +"' type='hidden' value='"+ data[i].fName +"'><select name='lst' id='lst' hidden=''  ></select></td >";
	...
	function getStudentDetails(quesId)	
	{
	  ...
	  dataType:"json", 
	    type:"POST",
         url:'search-action-on-student-details',
   ...
   // console.log(data[0].question);
	//console.log(data[0].optionA);
	  //console.log(data.success);
	   ...
	   $("#prg").html("<span style='text-align: center; font-family: Tahoma, Arial, sans-serif;color: #3C8DBC; margin: 80px 0;'>Created Date: "+ data[0].created_at  +"</span> ");
	   
   var table="<table width='98%' bgcolor='#FFFFFF ' cellpadding='2' cellspacing='2'  align='center' id='+ tbl2 +'<tr ><th  width='200' bgcolor='#ffffff' align='left' valign='top' style='text-align:center;'>Student Id</th><th  width='300' bgcolor='#ffffff' align='left' valign='top' style='text-align:center;'>First Name</th><th  width='300' bgcolor='#ffffff ' align='left' valign='top' style='text-align:center;'>Surname</th><th width='200' bgcolor='#ffffff' align='left' valign='top' style='  text-align:center;'>Account</th><th width='350' bgcolor='#ffffff ' align='left' valign='top' style='  text-align:center;'>Account Details</th><th   width='200' bgcolor='#ffffff ' align='left' valign='top' style='  text-align:center;'>Result</th> <th   width='350' bgcolor='#ffffff ' align='left' valign='top' style='  text-align:center;'>Result Details</th>     </tr>";
...
option +="<tr><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[0].stdId +"</span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[0].fName +"</span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[0].surname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[0].activate +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[0].activate_details +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[0].publish +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[0].publish_details +"</span></td ></tr> ";
 ...
 $("#txtSearch").keyup(function(ev) {
	...
	document.getElementById('txtSearchSt').value='';
     ...
     $.ajax({ 
	  dataType:"json", 
	    type:"POST",
         url:'search-action-on-student-fname',
  ...
  $("#txtSearchSt").keyup(function(ev) {
	...
	document.getElementById('txtSearch').value='';
     ...
     $.ajax({ 
	  dataType:"json", 
	    type:"POST",
         url:'search-action-on-student-stdId-like',
