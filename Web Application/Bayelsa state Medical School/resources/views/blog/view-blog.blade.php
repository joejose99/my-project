...
function nightFall()
{
	...
	document.getElementById('main').style.color="#FF9500";
...
else
{
	...
	document.getElementById('main').style.color="#1E2C2C";
...
option +="<input name='but1' id='but"+ ctr +"' type='button' class='button-white' value='"+y+"' onClick='updateTime_full("+y+",6)'/>"
 ...
 function count_days()
 {
 	...
 	var stDay =document.getElementById('time').value;
  
 
 
	var stMonth=document.getElementById('txtStartMonth').value;
  
	var stYear =document.getElementById('txtStartYear').value;
	
	
  
	var enDay=document.getElementById('txtEndDay').value;
 
  
	var enMonth =parseInt(document.getElementById('txtEndMonth').value);
  
	var enYear =document.getElementById('txtEndYear').value;
...
<body onload="hide_date_time(),scrolling(),getAutoColour()">
...
<div id="setUp" style="font-size:27px; color:#C1C1C1; text-align:center; padding-bottom:10px;" >Blog  </div>
...
<input name="txtReply" type="hidden" value='' id="txtReply" />

<input name="txtLike" type="hidden" value='' id="txtLike" />
<input name="txtDislike" type="hidden" value='' id="txtDislike" />
...
<div class="modal-content-blog" >
    <div class="modal-header" style="background: #C7DEF1;">
    <h4> <span class="header-title" style="color:#999;">Comment</span></h4>
    ...
    <div class="modal-body">
      ...
      <div id="tb"   class="div-table">
      <div class="div-table-row" id="hours_minutes_sec_row">  </div>
       
      @foreach($comment as $rst)
      
     <div class="div-table-row" id="hours_minutes_sec_row">  
      <div id="img-div" class="div-table-col drop-down-menu ">
      <img src="../timer/images/default_avatar.webp"  class="img" /> </div>
      <div id="details-div" class="div-table-col  drop-down-menu minutesId"   >
      <span style=" color:#3497D1; font-weight:bold;">
      {!! $rst->name!!}&ensp; {!! $rst->created_at!!}</span>
      <br />
      {!! $rst->details!!}
      
      <br /><br />
      <div style="text-align:center;" class="textBoxComment1"> 
        
        
       <input name="" id="butLike{!!  $ctr !!}" type="button" class="button-blue-reply spacing-button-reply"  value="Like this {!!$rst->likes !!}" onClick='like({!!$rst->com_Id !!}, {!!  $ctr !!},"comments")'/>
       
        <input name="" id="butDisableLike{!!  $ctr !!}" type="button" class=" button-blue-reply-clicked spacing-button-reply"  value="Like this {!!$rst->likes !!}" style="display:none;" />
      
       
         
       <input name="" id="butDis{!!  $ctr !!}" type="button" class="button-blue-reply spacing-button-reply"  value="Dislike this  {!!$rst->disLike !!}" onClick='unLike({!!$rst->com_Id !!},  {!!  $ctr !!},"comments")'/>
       
       <input name="" id="butDisableDis{!!  $ctr !!}" type="button" class="button-blue-reply-clicked  spacing-button-reply"  value="Dislike this  {!!$rst->disLike !!}" style="display:none;" />
       
       
       <input name="" id="but10" type="button" class="button-blue-reply spacing-button-reply"  value="Reply" onClick='reply({!!$rst->com_Id !!})'/> </div>
       ...
       @foreach($reply as $rst1)
       
       @if(trim($rst->com_Id) ==  trim($rst1->id_comments))
     <div class="div-table-row" id="hours_minutes_sec_row">  
      <div id="img-div2" class="div-table-col drop-down-menu ">
      <img src="../timer/images/default_avatar.webp"  class="img2" /> </div>
      <div id="details-div2" class="div-table-col  drop-down-menu minutesId"   >
      <span style=" color:#3497D1; font-weight:bold;">
      {!! $rst1->name!!}&ensp; {!! $rst1->created_at!!}</span>
      <br />
      {!! $rst1->details!!}
      ...
      <div style="text-align:center;" class="textBoxComment1"> 
       ...
       <input name="" id="butLike{!! $ctr !!}" type="button" class="button-blue-reply spacing-button-reply"  value="Like this {!!$rst1->likes !!}" onClick='like({!!$rst1->id !!}, {!! $ctr!!},"reply")'/>
       
     <input name="" id="butDisableLike{!!  $ctr !!}" type="button" class=" button-blue-reply-clicked spacing-button-reply"  value="Like this {!!$rst1->likes !!}" style="display:none;" />
        
       
         
       <input name="" id="butDis{!! $ctr!!}" type="button" class="button-blue-reply spacing-button-reply"  value="Dislike this {!!$rst1->disLike !!}" onClick='unLike({!!$rst1->id !!}, {!! $ctr!!},"reply")'/>
       
        <input name="" id="butDisableDis{!!  $ctr !!}" type="button" class="button-blue-reply-clicked  spacing-button-reply"  value="Dislike this  {!!$rst1->disLike !!}" style="display:none;" />
      ...
      <!--  END OF REPLY COMMENT -->
       ...
       <div class="div-table-row" id="hours_minutes_sec_row">  </div>
       <div class="title-head-line" style="position:relative; width:86%;"></div>
       
        <div class="div-table-row" id="hours_minutes_sec_row">  </div>
        <div id="details-div" class="div-table-col  drop-down-menu minutesId"   ></div>
...
<div id="cmt" class="mainbody" style="text-align:center; width:98%;" >
<div style=" height:auto; display:inline-block;" class="textBoxComment" > 
 ...
 <input id="txtName" type="text" class="form-control textBoxComment" name="txtName"   value="{{ old('txtName') }}" required autofocus autocomplete="off" style=" text-align:left; max-width:240;"  placeholder="Full Name" >         
   ...
   <div style=" height:auto; display:inline-block;" class="textBoxComment" > 
    <br />
         ...
         <input id="txtEmail" type="text" class="form-control " name="txtEmail"   value="{{ old('txtEmail') }}" required autofocus autocomplete="off" style=" text-align:left;  "  placeholder="Email" >         
 ...
 <div style=" height:auto; display:inline-block;" class="textBoxComment" > 
   ...
   <br />
     ...
     <textarea name="txtComment" rows="5" autofocus="autofocus" required="required" class="form-control " id="txtComment" style=" text-align:left; " placeholder="Comment" autocomplete="off">{{ old('txtComment') }}</textarea>         
...
<div class="mainbody" style="text-align:center;" ><label class="container" > 
  <input type="checkbox"  id="chk"  onclick="anonymous()" value="1">&nbsp;<span  style="font-size:13px;">Anonymous</span>
...
<div class="form-group mainbody"style="text-align:center;">
        <label for="captcha" class="container">Captcha</label>
          {!! NoCaptcha::renderJs() !!}
          {!! NoCaptcha::display() !!}
 ...
 <li  id="resume_but" style="display:none;">
  ...
  <li id="butSubmit" >
   <input class="pauseButton btn btn-success btn-lg mb-1"  type="submit" name="button" id="but_Submit"   value="Submit Comment" style="z-index:-2;"    /> 
...
<div id="main3" class="mainDiv card mb-5" style="margin-top:-28px; display:inline-block; min-width:88%; display:none;" >
...
<span class="mainbody">
  <div  id="footer"class="footer">Copyright ©2019 timeer.com All Rights Reserved.</div>
       ...
       <a href="javascript:void(0)" style="text-align:right; float:right; margin:5px;"  onclick="scrolling()">Top </a>
 ...
 $("#but_Submit").click(function(ev) {
	...
	if(document.getElementById('txtComment').value =="")
	{
		...
		var errors= '<span class=rstclass style=color:#C63A26;> &nbsp;&nbsp; Comment is required !! &nbsp;</span>';
...
var id='{{$query[0]->id}}';
     ...
     $.ajax({  
	    type:"POST",
         url:"/create-blog-view",
         data:{"_token":$('#signup-token').val(),"txtName":$("#txtName").val(),"txtEmail":$("#txtEmail").val(),"blog":$("#txtComment").val(),"reply":$("#txtReply").val(),"id":id},
		  dataType:"JSON",
		 processData:"false",
	...
	var txtD= "butDisableLike";
	  var butDis="butDis"
	  var butDisableDis="butDisableDis";
		 
     option =" <div class='div-table-row' id='hours_minutes_sec_row'> &nbsp; </div>"
	 $("#tb").html(option);
      ...
      // var valables=val.com_Id +","+ctr+", comments";
      
 option +="<div class='div-table-row' id='hours_minutes_sec_row'>  <div id='img-div' class='div-table-col drop-down-menu '   text-align:center;'><img src='../timer/images/default_avatar.webp' class='img' /> </div><div  id='details-div' class='div-table-col  drop-down-menu minutesId'><span style='color:#3497D1; font-weight:bold;'>"+ val.name +"&ensp;"+ val.created_at +"</span><br />"+ val.details +"<br /><br />"
 
  
  
 option +="<div style='text-align:center;' class='textBoxComment1'>  <input id='"+txts.concat(ctr)+"' type='button' class='button-blue-reply spacing-button-reply'  value='Like this "+val.likes+"' onclick='like("+ val.com_Id +","+ctr +","+comments+" )'/>"
 
 
   option +="<input id='"+txtD.concat(ctr)+"' type='button' class='button-blue-reply-clicked spacing-button-reply'  value='Like this "+val.likes+"' style='display:none;' />" 
   
    option +="<input name='' id='"+butDis.concat(ctr)+"' type='button' class='button-blue-reply spacing-button-reply' value='Dislike this "+val.disLike+"' onClick='unLike("+ val.com_Id +","+ctr+","+comments+")'/>"
	
	 option +="<input name='' id='"+butDisableDis.concat(ctr)+"' type='button' class='button-blue-reply-clicked spacing-button-reply' value='Dislike this "+val.disLike+"' style='display:none;' /> "
	 
	 option +="<input id='butRep10' type='button' class='button-blue-reply spacing-button-reply' value='Reply' onClick='reply("+ val.com_Id +")'/> </div> <br><br>";
	 
	 console.log('Comment reply: '+val.com_Id)
 
  
 ctr++;
 
  $.each(data['reply'],function(key,val2)
		 
		{ 
		  if(val.com_Id ==  val2.id_comments)
       
	  {
 option +="<div class='div-table-row' id='hours_minutes_sec_row'>  <div id='img-div2' class='div-table-col drop-down-menu '   text-align:center;'><img src='../timer/images/default_avatar.webp' class='img2' /> </div><div  id='details-div2' class='div-table-col  drop-down-menu minutesId'><span style='color:#3497D1; font-weight:bold;'>"+ val2.name +"&ensp;"+ val2.created_at +"</span><br />"+ val2.details +"<br /><br /> <div style='text-align:center;' class='textBoxComment1'><input id='"+ txts.concat(ctr)+"' type='button' class='button-blue-reply spacing-button-reply'  value='Like this "+val2.likes+"' onClick='like("+ val2.id +","+ctr+","+reply+")'/><input id='"+ txtD.concat(ctr)+"' type='button'class='button-blue-reply-clicked spacing-button-reply'  value='Like this "+val2.likes+"'style='display:none;'  /> <input name='' id='"+butDis.concat(ctr) +"' type='button' class='button-blue-reply spacing-button-reply' value='Dislike this "+val2.disLike +"' onClick='unLike("+ val2.id +","+ctr+","+reply+")'/><input name='' id='"+butDisableDis.concat(ctr) +"' type='button' class='button-blue-reply-clicked  spacing-button-reply' value='Dislike this "+val2.disLike +"'  style='display:none;'/> <input id='but10' type='button' class='button-blue-reply spacing-button-reply' value='Reply' onClick='reply("+ val.com_Id +")'/> </div>   </div></div> <br />";
  
	//console.log('reply: '+val2.com_Id)
 ...
 option +="<div class='div-table-row' id='hours_minutes_sec_row'>  </div><div class='title-head-line'style='position:relative; width:86%;'></div> <div class='div-table-row' id='hours_minutes_sec_row'>  </div> <div id='details-div' class='div-table-col  drop-down-menu minutesId'   ></div> </div></div> <br />"
...
function reply(id)
 {
   ...
   document.getElementById('txtReply').value=id;
   
  
   //console.log('Reply: '+id);
   
   var target =$('a[name=cmt]')
   
     
   var test =document.getElementById('cmt');
   var testTop =test.offsetTop;
   
    
    $('html,body').animate({scrollTop:testTop},1000);
...
function unLike(id, btnId , st)
 {
     
	  
	/*
     alert('im here Like '+btnId);
	...
	var btn='butDis'+btnId;
	var  val7 ;
	var btn2='butLike'+btnId;
	
	document.getElementById('txtDislike').value='butDis'+btnId;
	var val=document.getElementById(btn).value
	
	
	//alert(val.substr(12,15));
	var val1 =parseInt(val.substr(12,17))
	
	//console.log('Dislike '+ val1)
	if(isNaN(val1))
	{
	   val1=0;
	}
	...
	if(val1>=0)
	{
	 ...
	 /* THIS CHECK IF THE ELEMENT IS VISIBLE */
	  var val3 =document.getElementById(btn2).offsetLeft;
	 
	 if(val3 == 0)
	 {
		  var val5   = document.getElementById(btn2).value
		 var val6=parseInt(val5.substr(9,17))
		   val7 =val6-1;
		 document.getElementById(btn2).value='Like this '+val7;
	 }	 
	 else
	 {
		  var val5   = document.getElementById(btn2).value
	...
	document.getElementById(btn).value='Dislike this '+val1;
	
	var ds= 'butDisableDis'+btnId
	
	var ds2= 'butDisableLike'+btnId
	document.getElementById(ds2).style.display="none";
	
	document.getElementById(ds).value='Dislike this '+val1;
	...
	document.getElementById(ds).style.display="inline-block";
	 ...
	 $.ajax({  
	    type:"POST",
         url:"/edit-blog-view-like",
         data:{"_token":$('#signup-token').val(),"dislike":val1,"like":val7,"id":id,"status":st},
		  dataType:"JSON",
		 processData:"false",
         success: function(data) {
     var saved= '<span class=rstclass style=color:#2965A0;> &nbsp;&nbsp; '+ data +' &nbsp;</span>';
...
function like(id,btnId,st)
 {
	...
	var btn='butLike'+btnId;
	var  val7;
	var btn2='butDis'+btnId;
	
	document.getElementById('txtLike').value='butLike'+btnId; 
	var val=document.getElementById(btn).value
	//alert(val.substr(9,15));
	var val1 =parseInt(val.substr(9,17))
	//console.log('like '+ val1)
	if(isNaN(val1))
	{
	   val1=0;
	}
	if(val1>=0)
	{
	 ...
	 {
		 var val5   = document.getElementById(btn2).value
		 var val6=parseInt(val5.substr(12,17))
		    val7 =val6-1;
		 document.getElementById(btn2).value='Dislike this '+val7;
	 }	 
	 else
	 { 
	 	 var val5   = document.getElementById(btn2).value
	...
	document.getElementById(btn).value='Like this '+val1;
	
	var ds= 'butDisableLike'+btnId
	//butDisableLike
	
	/* DISPLAY CLICK BUTTON */
	document.getElementById(ds).value='Like this '+val1;
	
	/* HIDE LIKED BUTTON */
	document.getElementById(btn).style.display="none";
	
	/* DISPLAY FADED BUTTON */
	document.getElementById(ds).style.display="inline-block";
	
	/* DISPLAY DISLIKE BUTTON INCASE IS HIDDEN */
	 var btn1='butDis'+btnId;
	 document.getElementById(btn1).style.display="inline-block";
	 
	 /* HIDE DISABLE BUTTON INCASE IS NOT HIDDEN */
	 var ds2= 'butDisableDis'+btnId
	document.getElementById(ds2).style.display="none";
	...
	$.ajax({  
	    type:"POST",
         url:"/edit-blog-view-like",
         data:{"_token":$('#signup-token').val(),"dislike":val7,"like":val1,"id":id,"status":st},
		  dataType:"JSON",
		 processData:"false",
         success: function(data) {
     var saved= '<span class=rstclass style=color:#2965A0;> &nbsp;&nbsp; '+ data +' &nbsp;</span>';
