...
<div id="error-page" style="text-align:center; font-weight:bold;"> </div>
  ...
  <div class="form-group{{ $errors->has('optionA') ? ' has-error' : '' }}"  >
   ...
   <input id="gender" type="hidden"  name="gender" value="" />
              ...
              <label for="answer" class="col-md-4 control-label" style="margin-top:15px; width:200px;text-align:right;">Title:* &nbsp;</label>
                        <div class="col-md-6" style="margin-top:10px;">
                

                               <select name="term" class="title" id="title">
  ...
  <div class="form-group{{ $errors->has('txtNextKinPhone') ? ' has-error' : '' }}"   >
             <label for="txtNextKinPhone" class="col-md-4 control-label" style="margin-top:15px;width:200px; text-align:right;">Department:* &nbsp;</label>
...
/*	$('#form1').validate({ // initialize the plugin
	...
	if(document.getElementById('title').value =='Select')
	{
		...
		var errors= '<span class=rstclass style=color:#C63A26;> &nbsp;&nbsp; Select Title  !! &nbsp;</span>';
	  $("#error-page").append(errors);
		ctr++;
	}
