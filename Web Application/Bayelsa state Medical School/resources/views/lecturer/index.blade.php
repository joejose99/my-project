...
@section('content')
 ...
 <div class="panel panel-default">
                <div class="panel-heading">
                 ...
                 <span ><img src="../../image/arrow.gif" width="5" height="10" />&nbsp&nbsp;Lecturer</span>
                  
                  <div style="float:right; width:330px; margin-top:-5px; text-align:right;"><label  id="SelectError"> </label>  <input name="butInsert" type="button" value="Insert Data" onClick="window.location.href='insertLecturer'" class="but">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="delete" value="Multiple Delete" type="button" class="delete"  id="multiDel"></div>
                  
                  
             <div id="totSch" style="float:right; margin-top:-5px; width:56%; text-align:center;" >  <input name="txtsearch" type="text" id="txtSearch" class="searchTextbox" placeholder="Search First Name" onkeypress="return isNumberKey(event) " onblur="if(this.value=='') 
...
{!!$rst->lcrId!!}
 ...
 <a href='#popup1' onclick='getStudentDetails({{$rst->lcrId }})'>
...
<select name="lst" id="lst" hidden=""  > </select>
 ...
 <input name="txt{!! $rst->lcrId !!}" id="txt{!! $rst->lcrId !!}" type="hidden" value="{!! $rst->fName !!}" /></td >
...
{!!$rst->created_at!!}
  ...
  <td align='left' bgcolor='#1D4B6D'  valign ='top' ><span  style="margin:8px; display:block;"> <a href ='editLecturer/{{ $rst->lcrId }}' class='update'>Edit</a></span></td >
    <td align='left' bgcolor='#980905'  valign ='top' ><span  style="margin:8px; display:block;"> <a href ='#' class="del"onclick="destroy({{ $rst->lcrId }})">Delete</a> </span>
    </td >

  
<td align='center' bgcolor='#980905'  valign ='top' class="table-td" ><span  style="margin:8px; display:block;">
      <input name="input" type="checkbox" value=" {!! $rst->lcrId !!}" onclick="get_Values('{!! $rst->lcrId !!}')" />
    </span></td >
	...
	<div class="popup">
        ...
        <div id="details"> </div>
		<div class="content" id="contents" style="max-height:480px;overflow-y:scroll; " >
			<!-- Thank to pop me out of that button, but now i'm done so you can close this window. -->


    
    <table width="98%" bgcolor="#FFFFFF"   border=" "  height="auto" cellpadding="2" cellspacing="2"  align="center"  id="tbl2"  >
<tr > 
...
<th width='150'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Next of Kin.</th>
 ...
 <div style="height:20px;"> </div>
   ...
   <table width="98%" bgcolor="#FFFFFF" height="auto"   border=" "  cellpadding="2" cellspacing="2"  align="center"  id="tb2"  >
<tr > 
...
<th width='150'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Next of Kin.</th>
 ...
 <th width=''bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Next of Kin Address.</th>
 ...
 <div style="height:20px;"> </div>
   ...
   <table width="98%" bgcolor="#FFFFFF" height="auto"   border=" "  cellpadding="2" cellspacing="2"  align="center"  id="tbl3"  >
<tr > 
	
   
 
 
<th width='150'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Course Id.</th>
...
<script>
	...
	{	
	  ...
	  dataType:"json", 
	    type:"POST",
         url:'delete_multiple_lecturer/quesId',
...
option +="<tr> <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'> <a   href='#popup1' onclick='getCourseDetails("+ data[i].lcrId +")'>" + data[i].fName +"</a></span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].midName +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].surname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].address +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].mobileNo +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].email +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].created_at +"</span></td ><td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='fullDetails/ " +data[i].lcrId +" ' class='update'>Full Details</a> </span></td ><td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='editLecturer/ " +data[i].lcrId +" ' class='update'>Edit</a> </span></td ><td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <a href ='#'  class= 'del'  onClick='destroy("+ data[i].lcrId +" )'>Delete</a>  </span></td ><td align='center' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox'  onClick='get_Values(" +data[i].lcrId +")' value='" +data[i].lcrId +" ' id='" +data[i].lcrId +"'  </span><input name='"+ txts.concat(data[i].lcrId) +"' id='"+ txts.concat(data[i].lcrId) +"' type='hidden' value='"+ data[i].fName +"'><select name='lst' id='lst' hidden=''  ></select></td >";
...
option +="<tr> <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'> <a   href='#popup1' onclick='getCourseDetails("+ data[i].lcrId +")'>" + data[i].fName +"</a></span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].midName +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].surname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].address +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].mobileNo +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].email +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].created_at +"</span></td > <td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='editLecturer/ " +data[i].lcrId +" ' class='update'>Edit</a> </span></td ><td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <a href ='#'  class= 'del'  onClick='destroy("+ data[i].lcrId +" )'>Delete</a>  </span></td ><td align='center' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox'  onClick='get_Values(" +data[i].lcrId +")' value='" +data[i].lcrId +" ' id='" +data[i].lcrId +"'  </span><input name='"+ txts.concat(data[i].lcrId) +"' id='"+ txts.concat(data[i].lcrId) +"' type='hidden' value='"+ data[i].fName +"'><select name='lst' id='lst' hidden=''  ></select></td >";
   ...
   // console.log(data[0].question);
	//console.log(data[0].optionA);
	  //console.log(data.success);
	   ...
	   $("#prg").html("<span style='text-align: center; font-family: Tahoma, Arial, sans-serif;color: #3C8DBC; margin: 80px 0;'>"+ data[0].department  +"</span> ");
...
option +="<tr><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[0].lcrId +"</span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:4px; display:block;'>" + data[0].fName +"</span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:4px; display:block;'>" + data[0].midName +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:4px; display:block;'>" + data[0].surname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:4px; display:block;'>" + data[0].address +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:4px; display:block;'>" + data[0].mobileNo +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:4px; display:block;'>" + data[0].email +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[0].created_at +"</span></td ></tr> ";
...
option +="<tr><td align='left'    valign='top' class='table-td'><span  style='margin:4px; display:block;'>" + jQuery.trim(data[0].state)+"</span></td > <td align='left'    valign='top' class=' '><span  style='margin:4px; display:block;'>" + jQuery.trim(data[0].LGA) +"</span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:4px; display:block;'>" + jQuery.trim(data[0].nextOfKin) +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:4px; display:block;'>" + jQuery.trim(data[0].nextOfKinAddress) +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:4px; display:block;'>" + jQuery.trim(data[0].nextOfKinMobile) +"</span></td ></tr> ";
			 ...
			 //}
				...
				table="";
				   ...
				   table="<table  class='tbl3' width='98%' bgcolor='#FFFFFF ' cellpadding='2' cellspacing='2'  align='center' id='+ tb2 +'<tr ><th  width='300' bgcolor='#ffffff' align='left' valign='top' style='text-align:center;'>Course Id</th>  <th width='300' bgcolor='#ffffff' align='left' valign='top' style='  text-align:center;'>Course</th>  </tr>";
...
option +="<tr><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].cosId +"</span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].course +"</span></td >  </tr> ";
...
option +="<tr>  <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'> <a   href='#popup1' onclick='getCourseDetails("+ val.lcrId +")'>" + val.fName +"</a></span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.midName +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.surname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.address +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.mobileNo +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.email +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.created_at +"</span></td > <td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='editLecturer/"+ val.lcrId +"' class='update'>Edit</a> </span></td ><td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='fullDetails/ " +val.lcrId +" ' class='update'>Full Details</a> </span></td ><td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <a href ='#'  class= 'del'  onClick='destroy("+ val.lcrId +" )'>Delete</a>  </span></td ><td align='center' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox'  onClick='get_Values(" + val.lcrId +")' value='" + val.lcrId +" ' id='" + val.lcrId +"'  </span><input name='"+ txts.concat(val.lcrId) +"' id='"+ txts.concat(val.lcrId) +"' type='hidden' value='"+ val.fName +"'><select name='lst' id='lst' hidden=''  ></select></td >";
...
//var dataArray= JSON.stringify(dtArray);
     ...
     $.ajax({ 
	  dataType:"json", 
	    type:"POST",
         url:'search_lecturer_fal_dpt_prg',
