         ...
         <script src="{{ asset('../js/jquery-3.4.1.js') }}"></script>     
            ...
            <!--
             ...
             {{-- {{ csrf_field() }} --}} -->
              ...
              <div style="float:right; width:310px; margin-top:5px; text-align:right;">    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            
          <!--  {{--  @if (trim($role['role'])--}} =='Super Admin') -->
            <input name="delete" value="Multiple Delete" type="button" class="delete"  id="multiDel"> {{--@endif --}}</div>
...
<span ><img src="../../image/arrow.gif" width="5" height="10" />&nbsp&nbsp;User Activity</span> 
 &nbsp;&nbsp; 
...
<div style="float:right; width:310px; margin-top:-19px;  margin-bottom:10px; text-align:left;">   <input name="exp" type="submit" value="Export Data"  class="but hide_question" id="exp"></div>
...
<tr > 
 ...
 <th width='360'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;" >Details</th> 
...
<select name="lst" id="lst" hidden=""   ></select>
 <input name="txt{!!$rst-> id!!}" id="txt{!!$rst-> id!!}" type="hidden" value="{!!$rst->name!!}">
  ...
  <td align='left' bgcolor=''  valign ='top' class="table-td mainbody" >
 <span  style="margin:8px; display:block;">
{!!$rst->details!!}
</span>
...
{{-- @if (trim($role['role']) --}} =='Super Admin') -->
 ...
 <span  style="margin:8px; display:block;">
 <input name="" type="checkbox" value=" {!! $rst-> id !!}" onClick="get_Values('{!! $rst-> id !!}')">
...
<script>
 ...
 $("#multiDel").click(function(ev) {
	...
	{	
	  ...
	  dataType:"json", 
	    type:"POST",
         url:'delete-multiple-activity/quesId',
         ...
         success: function(data) {
			 ...
			 var table="<table width='98%' bgcolor='#FFFFFF ' cellpadding='2' cellspacing='2'  align='center' id='+ tbl +'<tr > <th bgcolor='#ffffff ' align='left' valign='top' style=' text-align:center;' width='150' >Name</th> <th   width='150' bgcolor='#ffffff ' align='left' valign='top' style='  text-align:center;  ' >Details</th><th width='  150'bgcolor='#ffffff' align='left' valign='top' style='text-align:center;' >Academic Session</th> <th width='150'bgcolor=' #ffffff ' align='left' valign='top' style='text-align:center;' >Date</th>     <th  width='50' bgcolor=' #ffffff ' align='left'  valign='  top  ' style='  text-align:center;  '><strong> </strong> </th>  </tr>";
...
option +="<tr><td align='left'    valign='top' class='table-td' ><span  style='margin:8px; display:block;'>" + data[i].name +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].details +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].academic_session +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].updated_at +"</span></td >  <td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox' onClick='get_Values(" + data[i].id +")' value='" +data[i].id +" ' id='" +data[i]. totId +"'  </span><input name='"+ txts.concat(data[i]. id) +"' id='"+ txts.concat(data[i].id) +"' type='hidden' value='"+ data[i].name +"'><select name='lst' id='lst' hidden=''  ></select></td ></tr>"
...
$(function() {
  ...
  //document.getElementById('txtYear').value=fullYear;
     ...
     $.ajax({  
	    type:"POST",
         url:"faculty-total-Result",
         data:{"_token":$('#signup-token').val(),"falId":$("#faculty1").val(),"session":$("#session").val()},
		  dataType:"JSON",
		 processData:"false",
         success: function(data) {
		...
		// document.getElementById('faculty1').value="Select";
		 ...
		 /*
			...
			{ */
			 ...
			 var table="<table width='98%' bgcolor='#FFFFFF ' cellpadding='2' cellspacing='2'  align='center' id='+ tbl +'<tr > <th bgcolor='#ffffff ' align='left' valign='top' style=' text-align:center;' width='150' >Student Id</th> <th   width='150' bgcolor='#ffffff ' align='left' valign='top' style='  text-align:center;  ' >First Name</th><th width='  150'bgcolor='#ffffff' align='left' valign='top' style='text-align:center;' >Middle Name</th> <th width='150'bgcolor=' #ffffff ' align='left' valign='top' style='text-align:center;' >Surname</th> <th width='150'bgcolor='#ffffff' align='left' valign='top' style='text-align:center;' >Academic Session</th> <th width='150'bgcolor=' #ffffff' align='  left' valign='top' style='text-align:center;' >Course</th> <th width='160'bgcolor='' align=' left  ' valign='top' style='text-align:center;' >Total Mark Score</th><th width='50'bgcolor='' align=' left  ' valign='top' style='text-align:center;' >Grade</th> <th width='150'bgcolor='#ffffff ' align='left' valign='top' style='text-align:center;'>Date</th>   <th  width='50' bgcolor=' #ffffff ' align='left'  valign='  top  ' style='  text-align:center;  '><strong> </strong> </th>  </tr>";
...
option +="<tr><td align='left'    valign='top' class='table-td' ><span  style='margin:8px; display:block;'>" + val.stdId +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.fName +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.midName +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.surname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.academic_session +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.cosId +" &nbsp;- &nbsp;" + val.course +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.mark +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.grade +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + val.created_at +"</span></td >  <td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox' onClick='get_Values(" + val. totId +")' value='" +val. totId +" ' id='" +val. totId +"'  </span><input name='"+ txts.concat(val. totId) +"' id='"+ txts.concat(val. totId) +"' type='hidden' value='"+ val.fName +"'><select name='lst' id='lst' hidden=''  ></select></td ></tr>"
...
option +="<tr><td align='left'    valign='top' class='table-td' ><span  style='margin:8px; display:block;'>" + data.query[i].studentId +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data.query[i].fname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data.query[i].midname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data.query[i].surname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data.query[i].school +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data.query[i].class +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data.query[i].term +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data.query[i].subject +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data.query[i].totalMark +"</span></td ></tr> "
  ...
  $("#schools").change(function(ev) {
     ...
     $.ajax({  
	    type:"POST",
         url:"faculty-department-total-result",
         data:{"_token":$('#signup-token').val(),"falId":$("#faculty1").val(),"dptId":$("#schools").val(),"session":$("#session").val()},
		  dataType:"JSON",
		 processData:"false",
         success: function(data) {
...
option +="<tr><td align='left'    valign='top' class='table-td' ><span  style='margin:8px; display:block;'>" + data[i].stdId +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].fName +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].midName +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].surname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].academic_session +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].cosId +" &nbsp;- &nbsp;" + data[i].course +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].mark +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].grade +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].created_at +"</span></td >  <td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox' onClick='get_Values(" + data[i]. totId +")' value='" +data[i]. totId +" ' id='" +data[i]. totId +"'  </span><input name='"+ txts.concat(data[i]. totId) +"' id='"+ txts.concat(data[i]. totId) +"' type='hidden' value='"+ data[i].fName +"'><select name='lst' id='lst' hidden=''  ></select></td ></tr>"
...
option +="<tr><td align='left'    valign='top' class='table-td' ><span  style='margin:8px; display:block;'>" + data[i].studentId +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].fname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].midname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].surname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].school +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].class +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].term +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].subject +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].totalMark +"</span></td >  </td ></tr>"
 ...
 //var dataArray= JSON.stringify(dtArray);
     ...
     $.ajax({ 
	  dataType:"json", 
	    type:"POST",
         url:'search-level-total-result',
         data:{"_token":$('#signup-token').val(),"levId":$("#clss").val(),"falId":$("#faculty1").val(),"dptId":$("#schools").val(),"session":$("#session").val()},
		 processData:"false",
         success: function(data) {
...
//var dataArray= JSON.stringify(dtArray);
     ...
     $.ajax({ 
	  dataType:"json", 
	    type:"POST",
         url:'search-level-semester-total-result',
         data:{"_token":$('#signup-token').val(),"levId":$("#clss").val(),"falId":$("#faculty1").val(),"semId":$("#terms").val(),"dptId":$("#schools").val(),"session":$("#session").val()},
		 processData:"false",
         success: function(data) {
...
//var dataArray= JSON.stringify(dtArray);
     ...
     $.ajax({ 
	  dataType:"json", 
	    type:"POST",
         url:'search-level-semester-course-total-result',
         data:{"_token":$('#signup-token').val(),"falId":$("#faculty1").val(),"levId":$("#clss").val(),"semId":$("#terms").val(),"cosId":$("#subjects").val(),"dptId":$("#schools").val(),"session":$("#session").val()},
		 processData:"false",
         success: function(data) {
	...
	//console.log(data[0].optionA);
	  ...
	  /* if($.trim(role) == 'Super Admin')
			{ */
			 ...
			 var table="<table width='98%' bgcolor='#FFFFFF ' cellpadding='2' cellspacing='2'  align='center' id='+ tbl +'<tr > <th bgcolor='#ffffff ' align='left' valign='top' style=' text-align:center;' width='150' >Student Id</th> <th   width='150' bgcolor='#ffffff ' align='left' valign='top' style='  text-align:center;  ' >First Name</th><th width='  150'bgcolor='#ffffff' align='left' valign='top' style='text-align:center;' >Middle Name</th> <th width='150'bgcolor=' #ffffff ' align='left' valign='top' style='text-align:center;' >Surname</th> <th width='150'bgcolor='#ffffff' align='left' valign='top' style='text-align:center;' >Academic Session</th> <th width='150'bgcolor=' #ffffff' align='  left' valign='top' style='text-align:center;' >Course</th> <th width='160'bgcolor='' align=' left  ' valign='top' style='text-align:center;' >Total Mark Score</th><th width='50'bgcolor='' align=' left  ' valign='top' style='text-align:center;' >Grade</th> <th width='150'bgcolor='#ffffff ' align='left' valign='top' style='text-align:center;'>Date</th><th  width='50' bgcolor=' #ffffff ' align='left'  valign='  top  ' style='  text-align:center;  '><strong> </strong> </th>    <th  width='50' bgcolor=' #ffffff ' align='left'  valign='  top  ' style='  text-align:center;  '><strong> </strong> </th>  </tr>";
...
option +="<tr><td align='left'    valign='top' class='table-td' ><span  style='margin:8px; display:block;'>" + data[i].stdId +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].fName +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].midName +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].surname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].academic_session +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].cosId +" &nbsp;- &nbsp;" + data[i].course +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].mark +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].grade +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].created_at +"</span></td ><td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='edit-total-result/ " +data[i].totId +" ' class='update'>Edit</a> </span></td >  <td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox' onClick='get_Values(" + data[i]. totId +")' value='" +data[i]. totId +" ' id='" +data[i]. totId +"'  </span><input name='"+ txts.concat(data[i]. totId) +"' id='"+ txts.concat(data[i]. totId) +"' type='hidden' value='"+ data[i].fName +"'><select name='lst' id='lst' hidden=''  ></select></td ></tr>"
...
option +="<tr><td align='left'    valign='top' class='table-td' ><span  style='margin:8px; display:block;'>" + data[i].studentId +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].fname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].midname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].surname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].school +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].class +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].term +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].subject +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].totalMark +"</span></td ></tr> "
 ...
 $("#exp").change(function(ev) {
	  ...
	  if($("#clss").val() == "Selcet")
	{
	 ...
	 if($("#schools").val() == "Selcet")
	{
		
		//document.getElementById('error-page').style.height="25px";
	
		var errors= '<span class=rstclass style=color:#C63A26;> &nbsp;&nbsp;  Subject Value is required !! &nbsp;</span>';
	  $("#SelectError").html(errors);
		ctr++;
	}  
...
//var dataArray= JSON.stringify(dtArray);
     ...
     $.ajax({ 
	  dataType:"json", 
	    type:"POST",
         url:'search_class_term_subj_rst',
         data:{"_token":$('#signup-token').val(),"LGA":$("#LGAS").val(),"clsId":$("#clss").val(),"terms":$("#terms").val(),"subjects":$("#subjects").val(),"school":$("#schools").val(),"fullYear":fullYear},
		 processData:"false",
         success: function(data) {
...
option +="<tr><td align='left'    valign='top' class='table-td' ><span  style='margin:8px; display:block;'>" + data[i].stdId +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].fName +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].midName +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].surname +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].academic_session +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].cosId +" &nbsp;- &nbsp;" + data[i].course +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].mark +"</span></td >><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].grade +"</span></td ><td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].created_at +"</span></td >  <td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox' onClick='get_Values(" + data[i]. totId +")' value='" +data[i]. totId +" ' id='" +data[i]. totId +"'  </span><input name='"+ txts.concat(data[i]. totId) +"' id='"+ txts.concat(data[i]. totId) +"' type='hidden' value='"+ data[i].fName +"'><select name='lst' id='lst' hidden=''  ></select></td ></tr>"
				  ...
				  $("#tbl").append(option); 
				<?php // return PDF::load($option,'A4','portrait')->download('my_pdf'); ?>
