...
@section('content')
 ...
 <div class="panel panel-default">
                <div class="panel-heading">
                  ...
                  <span ><img src="../../image/arrow.gif" width="5" height="10" />&nbsp&nbsp;Semester</span>
                  
                  <div style="float:right; width:280px; margin-top:-5px; text-align:right;"><label  id="SelectError"> </label>  <input name="butInsert" type="button" value="Insert Data" onClick="window.location.href='insertSemester'" class="but">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="delete" value="Multiple Delete" type="button" class="delete"  id="multiDel"></div>
                  
                  
             <div id="totSch" style="float:right; margin-top:-5px; width:60%; text-align:center;" >  <input name="txtsearch" type="text" id="txtSearch" class="searchTextbox" placeholder="Search Semester" onkeypress="return isNumberKey(event) " onblur="if(this.value=='') 
...
{!!$rst->created_at!!}
 ...
 <input name="txt{!! $rst->semId !!}" id="txt{!! $rst->semId !!}" type="hidden" value="{!! $rst->semester !!}" />
</td>   
  ...
  <td align='left' bgcolor='#1D4B6D'  valign ='top' ><span  style="margin:8px; display:block;"> <a href ='editSemester/{{ $rst->semId }}' class='update'>Edit</a></span></td >
    <td align='left' bgcolor='#980905'  valign ='top' ><span  style="margin:8px; display:block;"> <a href ='#' class="del"onclick="destroy({{ $rst->semId }})">Delete</a> </span>
    </td >

  
<td align='center' bgcolor='#980905'  valign ='top' class="table-td" ><span  style="margin:8px; display:block;">
      <input name="input" type="checkbox" value=" {!! $rst->semId !!}" onclick="get_Values('{!! $rst->semId !!}')" />
    </span></td >
...
<script>
	...
	{	
	  ...
	  dataType:"json", 
	    type:"POST",
         url:'delete_multiple_semester/quesId',
...
option +="<tr> <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].semester +"</span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].created_at +"</span></td ><td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='editLSemester/ " +data[i].semId +" ' class='update'>Edit</a> </span></td ><td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <a href ='#'  class= 'del'  onClick='destroy("+ data[i].semId +" )'>Delete</a>  </span></td ><td align='center' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox'  onClick='get_Values(" +data[i].semId +")' value='" +data[i].semId +" ' id='" +data[i].semId +"'  </span><input name='"+ txts.concat(data[i].semId) +"' id='"+ txts.concat(data[i].semId) +"' type='hidden' value='"+ data[i].semester +"'><select name='lst' id='lst' hidden=''  ></select></td >";
...
option +="<tr> <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].semester +"</span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].created_at +"</span></td ><td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='editSemester/ " +data[i].semId +" ' class='update'>Edit</a> </span></td ><td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <a href ='#'  class= 'del'  onClick='destroy("+ data[i].semId +" )'>Delete</a>  </span></td ><td align='center' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox'  onClick='get_Values(" +data[i].semId +")' value='" +data[i].semId +" ' id='" +data[i].semId +"'  </span><input name='"+ txts.concat(data[i].semId) +"' id='"+ txts.concat(data[i].semId) +"' type='hidden' value='"+ data[i].semester +"'><select name='lst' id='lst' hidden=''  ></select></td >";
