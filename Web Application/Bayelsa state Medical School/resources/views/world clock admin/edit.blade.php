...
<div id="error-page" style="text-align:center; font-weight:bold;"> </div>
   ...
   <div class="form-group{{ $errors->has('optionC') ? ' has-error' : '' }}"   >
             <label for="optionC" class="col-md-4 control-label" style="margin-top:15px;width:200px;">Country:* &nbsp;</label>
  ...
  <div class="form-group{{ $errors->has('optionA') ? ' has-error' : '' }}"  >
          <label for="optionA" class="col-md-4 control-label " style="margin-top:15px; width:200px;  " >City:* &nbsp;</label>

        <div class="col-md-9" >
          <input id="optionA" type="text" class="form-control" name="optionA" value="{!!$query[0]->state !!}" required autofocus autocomplete="off">
          ...
          <div class="form-group{{ $errors->has('optionA') ? ' has-error' : '' }}"  >
          <label for="optionA" class="col-md-4 control-label " style="margin-top:15px; width:200px;  " >Time Zone:* &nbsp;</label>

        <div class="col-md-9" >
          <input id="timezone" type="text" class="form-control" name="timezone" value="{!!$query[0]->time_zone !!}" required autofocus autocomplete="off">
  ...
  <div class="form-group{{ $errors->has('optionA') ? ' has-error' : '' }}"  >
          <label for="optionD" class="col-md-4 control-label"  style="margin-top:15px; width:200px;  " >Activate City Time:* &nbsp;</label>
...
<input name="optionD" type="checkbox" value="0" id="optionD"   onclick="changeValue()" />
     ...
     <label for="optionB" class="col-md-4 control-label" style="margin-top:15px;width:200px;">Details:* &nbsp;</label>
                            ...
                            <div class="col-md-10" >
                              <textarea name="txtOptionB" rows="5" autofocus="autofocus" required="required" class="form-control" id="ckview" autocomplete="off">{!!$query[0]->details !!}</textarea>
                    ...
                    <div class="form-group{{ $errors->has('optionC') ? ' has-error' : '' }}"   >
             <label for="optionC" class="col-md-4 control-label" style="margin-top:15px;width:200px;">UTC Time:* &nbsp;</label>

                 <div class="col-md-9" >
           <select name="term" class="term" id="term">
                               
                            <option  value="{!!$query[0]->utc_value!!}"> {!!$query[0]->utc_select!!}</option>
