...
<div id="error-page" style="text-align:center; font-weight:bold;"> </div>
  ...
  <div class="form-group{{ $errors->has('optionA') ? ' has-error' : '' }}"  >
     ...
     <label for="optionB" class="col-md-4 control-label" style="margin-top:15px;width:200px;">Description:* &nbsp;</label>
...
/*	$('#form1').validate({ // initialize the plugin
	...
	var errors= '<span class=rstclass style=color:#C63A26;> &nbsp;&nbsp; Building Name is required !! &nbsp;</span>';
	...
	if(document.getElementById('txtOptionB').value =="")
	{
		...
		var errors= '<span class=rstclass style=color:#C63A26;> &nbsp;&nbsp; Description is required !! &nbsp;</span>';
