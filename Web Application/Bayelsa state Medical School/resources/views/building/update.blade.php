...
<h1>Dashboard  &nbsp;&nbsp;&nbsp;&nbsp;<span class="welcome-heading-page">{{ Auth::user()->name }} </span></h1>  <span class="mainbody" style="margin-left:1px;">Building Page</span>
...
<div id="error-page" style="text-align:center; font-weight:bold;"> </div>
  ...
  <div class="form-group{{ $errors->has('optionA') ? ' has-error' : '' }}"  >
          <label for="optionA" class="col-md-4 control-label " style="margin-top:15px; width:200px;" >Building:* &nbsp;</label>

        <div class="col-md-9" >
          <input id="optionA" type="text" class="form-control" name="optionA" value="{!!$query[0]->building!!}" required autofocus autocomplete="off">
     ...
     <label for="optionB" class="col-md-4 control-label" style="margin-top:15px;width:200px;">Details:* &nbsp;</label>
                            ...
                            <div class="col-md-10" >
                              <textarea name="txtOptionB" rows="5" autofocus="autofocus" required="required" class="form-control" id="txtOptionB" autocomplete="off">{!!$query[0]->description!!}</textarea>

 <input id="id" type="hidden" class="form-control" name="id" value="{!!$query[0]->buiId !!}" required autofocus autocomplete="off" >
...
<input name="butBack" id="butBack" type="button" value="&nbsp;&nbsp;Back &nbsp;&nbsp;" class="but" onClick="window.location.href='../building'" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
var dataArray= JSON.stringify(dtArray);
     ...
     $.ajax({ 
	  dataType:"json", 
	    type:"POST",
         url:'/edit-building/{{$query[0]->buiId}}',
