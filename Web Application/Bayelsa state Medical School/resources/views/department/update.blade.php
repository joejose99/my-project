...
<h1>Dashboard  &nbsp;&nbsp;&nbsp;&nbsp;<span class="welcome-heading-page">{{ Auth::user()->name }} </span></h1>  <span class="mainbody" style="margin-left:1px;">Department Page</span>
...
<div id="error-page" style="text-align:center; font-weight:bold;"> </div>
  ...
  <div class="form-group{{ $errors->has('optionA') ? ' has-error' : '' }}"  >
          <label for="optionA" class="col-md-4 control-label " style="margin-top:10px; width:200px;" >Department:* &nbsp;</label>

        <div class="col-md-9" >
          <input id="optionA" type="text" class="form-control" name="optionA" value="{!!$query[0]->department!!}" required autofocus autocomplete="off">
     ...
     <label for="optionB" class="col-md-4 control-label" style="margin-top:15px;width:200px;">Details:* &nbsp;</label>
                            ...
                            <div class="col-md-10">
                              <textarea name="txtOptionB" rows="5" autofocus="autofocus" required="required" class="form-control" id="txtOptionB" autocomplete="off">{!!$query[0]->details!!}</textarea>
...
<input id="id" type="hidden" class="form-control" name="id" value="{!!$query[0]->dptId !!}" required autofocus autocomplete="off" >
             </select>                  
                      ...
                      <div class="form-group{{ $errors->has('optionC') ? ' has-error' : '' }}"   >
             <label for="optionC" class="col-md-4 control-label" style="margin-top:15px;width:200px;">Head Of Department:* &nbsp;</label>
<!-- Comment on blade 
  {{--   
  ...
  -->               <div class="col-md-9">
          <select name="cls" class="cls" id="cls">
                                ...
                                @if($query[0]->fName  != "NA")
                                  <option  value="{!!$query[0]->lcrId!!}">{!!$query[0]->fName!!}  &nbsp;&nbsp; {!!$query[0]->surname!!}</option>
...
<input name="butBack" id="butBack" type="button" value="&nbsp;&nbsp;Back &nbsp;&nbsp;" class="but" onClick="window.location.href='../department'" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
var dataArray= JSON.stringify(dtArray);
     ...
     $.ajax({ 
	  dataType:"json", 
	    type:"POST",
         url:'/editDepartment/{{$query[0]->dptId}}',
