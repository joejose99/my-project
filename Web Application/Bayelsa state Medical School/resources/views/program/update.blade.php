...
<div id="error-page" style="text-align:center; font-weight:bold;"> </div>
  ...
  <div class="form-group{{ $errors->has('optionA') ? ' has-error' : '' }}"  >
        ...
        <div class="col-md-9" >
          <input id="optionA" type="text" class="form-control" name="optionA" value="{!!$query[0]->program!!}" required autofocus autocomplete="off">
     ...
     <label for="optionB" class="col-md-2 control-label" style="margin-top:15px;width:200px;">Details:* &nbsp;</label>

                            <div class="col-md-10" >
                              <textarea  name="txtOptionB" cols="150" rows="10" autofocus="autofocus" required="required" class="form-control" id="txtOptionB" autocomplete="off">{!!$query[0]->details!!}</textarea>
            ...
            <div class="form-group{{ $errors->has('optionC') ? ' has-error' : '' }}"   >
             <label for="optionC" class="col-md-4 control-label" style="margin-top:15px;width:200px;">Faculty:* &nbsp;</label>
                 ...
                 <div class="col-md-9">
           <select name="term" class="faculty" id="faculty">
   ...
   @endforeach 
              ...
              <label for="answer" class="col-md-4 control-label" style="margin-top:15px; width:200px;">Honour:* &nbsp;</label>
                       ...
                       <option  value="{!!$query[0]->honour!!}">{!!$query[0]->honour!!}</option>
...
var dataArray= JSON.stringify(dtArray);
   ...
   var saved= '<span class=rstclass style=color:#2965A0;> &nbsp;&nbsp; Data Successefully Saved &nbsp;</span>';
	 ...
	 alert('Data Successefully Saved');
         },
		 error: function(data) {
