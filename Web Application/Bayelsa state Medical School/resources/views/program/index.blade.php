...
@section('content')
 ...
 <div class="panel panel-default">
                <div class="panel-heading">
                  ...
                  <span ><img src="../../image/arrow.gif" width="5" height="10" />&nbsp&nbsp;Program</span>
                  
                  <div style="float:right; width:290px; margin-top:-5px; text-align:right;"><label  id="SelectError"> </label>  <input name="butInsert" type="button" value="Insert Data" onClick="window.location.href='insertProgram'" class="but">&nbsp;&nbsp;&nbsp;<input name="delete" value="Multiple Delete" type="button" class="delete"  id="multiDel"></div>
                  
                  
             <div id="totSch" style="float:right; margin-top:-5px;width:55%; text-align:center;" >  <input name="txtsearch" type="text" id="txtSearch" class="searchTextbox" placeholder="Search Department" onkeypress="return isNumberKey(event) " onblur="if(this.value=='') 
this.value='';" onfocus="if(this.value=='Search Department')"  >  </div>
   ...
   @endforeach 
                               ...
                               &nbsp;&nbsp;&nbsp;&nbsp;
                               <label>Department: </label>&nbsp;&nbsp; <select class="selectAdmin" name="dpt1" id="dpt1"> 
...
<tr > 
 ...
 <th width='250'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Program</th> 

<th width=''bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Program Details</th> 

<th width='150'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Program Leader</th>  
...
{!!$rst->lcrId!!}
 ...
 <span  style="margin:8px; display:block;">
  <a   href="#popup1"  onclick="getCourseDetails({{ $rst->prgId }})">
{!!$rst->program!!}
</a>
</span>
...
<select name="lst" id="lst" hidden=""  > </select>
 ...
 <input name="txt{!! $rst->prgId !!}" id="txt{!! $rst->prgId !!}" type="hidden" value="{!! $rst->program !!}" /></td >
      
      <input name="txtDetails{!! $rst->prgId !!}" id="txtDetails{!! $rst->prgId !!}" type="hidden" value="{!!$rst->details!!}" />
<input name="txtCosId{!! $rst->prgId !!}" id="txtCosId{!! $rst->prgId !!}" type="hidden" value="{!!$rst->program!!}" />
...
{!!$rst->created_at!!}
  ...
  <td align='left' bgcolor='#1D4B6D'  valign ='top' ><span  style="margin:8px; display:block;"> <a href ='editProgram/{{ $rst->prgId }}' class='update'>Edit</a></span></td >
    <td align='left' bgcolor='#980905'  valign ='top' ><span  style="margin:8px; display:block;"> <a href ='#' class="del"onclick="destroy({{ $rst->prgId }})">Delete</a> </span>
    </td >

  
<td align='center' bgcolor='#980905'  valign ='top' class="table-td" ><span  style="margin:8px; display:block;">
      <input name="input" type="checkbox" value=" {!! $rst->prgId !!}" onclick="get_Values('{!! $rst->prgId !!}')" />
    </span></td >
	...
	<div class="popup">
		...
		<div class="content" id="contents" style="max-height:400px;overflow-y:scroll; " >
 ...
 function getCourseDetails(quesId)	
	{
		...
		var cosIds= cosId.concat(quesId);
		  ...
		  $("#contents").html('<h3>'+ courseId +'  Program Description</h3>'); 
