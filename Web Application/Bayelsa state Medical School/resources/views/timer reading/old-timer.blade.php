...
<body  >
 ...
 <div id="contact-us" class="rightNav" style="text-align:right">Contact Us</div>
...
<!-- END OF RIGHT MENU  -->
 ...
 <a href="../timer-reading"><i class="material-icons" ><span style=" font-size:17px;">av_timer</span></i>&nbsp;&nbsp;Timer</a> 
  ...
  <a href="canlendar"> <i class='fas fa-calendar-alt'></i> &nbsp;&nbsp;Calendar</a>
...
<div id="main" class="card mb-5 mainDiv" >
 ...
 <!--
  ...
  <a href="timer"><i class="material-icons">av_timer</i><br />Timer</a> 
  ...
  <a href="calendar"> <i class="material-icons">event</i><br />Calendar</a>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="div-table-col">Seconds </div>
      </div>
  ...
  <span> <a href="#"  onclick="playAudio()"><i class="far fa-play-circle" style="color:DodgerBlue; font-size:18px;"> </i></a></span>
  </div>
...
<div id="main3" class="mainDiv card mb-5" style="margin-top:-28px; display:inline-block;" >
 <div  id="title-head" class="title-head">Set an alarm for the specified time </div>
 <br />
...
<div id="main4" class="card mb-5 mainDiv" style="margin-top:-28px;" >
 ...
 <div  id="title-head" class="title-head">How to use the online alarm clock </div>
