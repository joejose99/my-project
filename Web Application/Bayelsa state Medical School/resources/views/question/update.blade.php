...
<div id="success-page" style="height:auto; text-align:center;"> </div>
 ...
 <div style=" margin-bottom:20px;margin-left:5%; " class="rstclass" > <label style="width:200px; float:"> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Month:&nbsp;</label>   
   ...
   <option value=" {!!$query[0]->month!!}"> {!!$query[0]->month!!}</option>
 ...
 <input id="txtYear" type="text" class="form-control" name="txtYear" value="{!!$query[0]->year!!}" required autofocus autocomplete="off" > 
  ...
  <input name="optionE" type="radio" id="optHide" onclick="hideOption()" value="4"  checked="checked" />  &nbsp; &nbsp;
   ...
   <div  id="error-Msg-page" class="top-page" style="text-align:center;">  </div>
       ...
       <textarea name="ckview" cols="20" rows="4" class="form-control" id="ckview"  >{!!$query[0]->question !!}   </textarea>
  ...
  <div class="form-group{{ $errors->has('optionA') ? ' has-error' : '' }}" >
        ...
        <div class="col-md-6" style="margin-top:10px;">
          <input id="optionA" type="text" class="form-control" name="optionA" value=" {!!$query[0]->optionA !!}" required autofocus autocomplete="off">
     ...
     <input name="A" type="checkbox" value=""   onclick="ACheck()" id="A" utocomplete="off"/> 
                         ...
                         <div class="form-group{{ $errors->has('optionB') ? ' has-error' : '' }}" >
                            ...
                            <div class="col-md-6" style="margin-top:10px;">
      <input id="optionB" type="text" class="form-control" name="midName" value=" {!!$query[0]->optionB !!}" required autofocus autocomplete="off">
     ...
     <input name="B" type="checkbox" value=""  onclick="BCheck()" id="B" utocomplete="off"/> 
                 ...
                 <div class="col-md-6" style="margin-top:10px;">
        <input id="optionC" type="text" class="form-control" name="optionC" value=" {!!$query[0]->optionC !!}" required autofocus autocomplete="off" >
   ...
   <div class="form-group{{ $errors->has('optionD') ? ' has-error' : '' }}"   >
                            ...
                            <div class="col-md-6" style="margin-top:10px;">
                                <input id="optionD" type="text" class="form-control" name="optionD" value=" {!!$query[0]->optionD !!}" required autofocus autocomplete="off" >
     ...
     <div id="optE" >
      <div class="form-group{{ $errors->has('optionE') ? ' has-error' : '' }}"   >
                            ...
                            <div class="col-md-6" style="margin-top:10px;">
                                <input id="optionE" type="text" class="form-control" name="optionE" value=" {!!$query[0]->optionE !!}" required autofocus autocomplete="off" >
     ...
     <!-- THIS BELLOW GIVES USER THE OPTION OF CHANGING 4 OPTIONS TO 5 USING JAVASCRIPT -->
     ...
     <!-- OPTION E END HERE -->
                        ...
                        <div class="col-md-6" style="margin-top:10px;">
                                <input id="answer" type="text" class="form-control" name="answer" value=" {!!$query[0]->answer !!}" required autofocus autocomplete="off" >

                              <input id="id" type="text" class="form-control" name="id" value=" {!!$query[0]->queId !!}" required autofocus autocomplete="off" > 
                        ...
                        <div class="col-md-6" style="margin-top:10px;">
                  <input id="mark" type="text" class="form-control" name="mark" value=" {!!$query[0]->mark !!}" required autofocus autocomplete="off" >
...
/*	
	if(document.getElementById('optShow').value=='5' && $("#optionE").val() ==''  )
	{
         document.getElementById('error-page').style.height="25px";
	
		var errors= '<span class=rstclass style=color:#C63A26;> &nbsp;&nbsp;Please Select Option 4 !! &nbsp;</span>';
	  $("#error-page").append(errors);
		ctr++;
	}*/ 
	
	if(document.getElementById('E').checked=='True' && $("#optionE").val() ==''  )
	{
         document.getElementById('error-page').style.height="25px";
...
var dataArray= JSON.stringify(dtArray);
     ...
     $.ajax({ 
	  dataType:"json", 
	    type:"POST",
         url:'/edit-question/{{$query[0]->queId}}',
