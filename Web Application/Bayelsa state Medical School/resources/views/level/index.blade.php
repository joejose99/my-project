...
@section('content')
 ...
 <div class="panel panel-default">
                <div class="panel-heading">
                   ...
                   <span ><img src="../../image/arrow.gif" width="5" height="10" />&nbsp&nbsp;Level</span>
                  
                  <div style="float:right; width:280px; margin-top:-5px; text-align:right;"><label  id="SelectError"> </label>  <input name="butInsert" type="button" value="Insert Data" onClick="window.location.href='insertLevel'" class="but">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="delete" value="Multiple Delete" type="button" class="delete"  id="multiDel"></div>
                  
                  
             <div id="totSch" style="float:right; margin-top:-5px;width:60%; text-align:center;">  <input name="txtsearch" type="text" id="txtSearch" class="searchTextbox" placeholder="Search Level" onkeypress="return isNumberKey(event) " onblur="if(this.value=='') 
...
<tr > 
 ...
 <th width='120'bgcolor='#ffffff' align='left' valign='top' style="text-align:center;">Level</th>   
...
{!!$rst->created_at!!}
 ...
 <input name="txt{!! $rst->levId !!}" id="txt{!! $rst->levId !!}" type="hidden" value="{!! $rst->level !!}" />
</td>   
  ...
  <td align='left' bgcolor='#1D4B6D'  valign ='top' ><span  style="margin:8px; display:block;"> <a href ='editLevel/{{ $rst->levId }}' class='update'>Edit</a></span></td >
  
    <td align='left' bgcolor='#980905'  valign ='top' ><span  style="margin:8px; display:block;"> <a href ='#' class="del"onclick="destroy({{ $rst->levId }})">Delete</a> </span>
    </td >

  
<td align='center' bgcolor='#980905'  valign ='top' class="table-td" ><span  style="margin:8px; display:block;">
      <input name="input" type="checkbox" value=" {!! $rst->levId !!}" onclick="get_Values('{!! $rst->levId !!}')" />
    </span></td >
...
<script>
	...
	{	
	  ...
	  dataType:"json", 
	    type:"POST",
         url:'delete_multiple_level/quesId',
...
option +="<tr> <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].level +"</span></td > <td align='left'    valign='top' class='table-td'><span  style='margin:8px; display:block;'>" + data[i].created_at +"</span></td ><td align='left' bgcolor= #1D4B6D   valign='top' class='table-td'><span  style='margin:8px; display:block;'><a href ='editLevel/ " +data[i].levId +" ' class='update'>Edit</a> </span></td ><td align='left' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <a href ='#'  class= 'del'  onClick='destroy("+ data[i].levId +" )'>Delete</a>  </span></td ><td align='center' bgcolor= #980905   valign='top'class='table-td'><span  style='margin:8px; display:block;'> <input name='' type='checkbox'  onClick='get_Values(" +data[i].levId +")' value='" +data[i].levId +" ' id='" +data[i].levId +"'  </span><input name='"+ txts.concat(data[i].levId) +"' id='"+ txts.concat(data[i].levId) +"' type='hidden' value='"+ data[i].level +"'><select name='lst' id='lst' hidden=''  ></select></td >";
