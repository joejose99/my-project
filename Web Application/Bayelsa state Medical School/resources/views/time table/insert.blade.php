...
<div style=" margin-bottom:25px;margin-top:5px; margin-left:5%; " class=""> 
  ...
  <input name="optionChoice" type="radio" id="optLecture" onClick="lecture()" value="Lecture" checked   />  &nbsp; &nbsp;
   ...
   <input name="optionChoice" type="radio" id="optExam" onClick="exam()"   value="Exam" /> 
    ...
    <div id="error-year" style=" margin-top:10px;float:right; margin-right:20% "  class="mainbody"> </div>
        ...
        <div   id="displayExam"  class="hide_question">
        ...
        <div class="col-md-6" style="margin-top:5px; ">
          <input id="date" type="date" class="form-control" name="date"  value="{{ old('date') }}" required autofocus autocomplete="off" style=" text-align:center">
            ...
            <div style=" margin-bottom:25px;margin-top:5px; margin-left:15%; " id="displayType"  class="hide_question"> 
                            
  <div class="col-md-6" style="width:100%; margin-left:-7%;"  >
  ...
  <input name="optType" type="radio" id="optOnline" onClick="online()" value="Online"    />  &nbsp; &nbsp;
   <label style="margin-top:10px; " for="optPaper">&nbsp;&nbsp;Paper:</label>
   <input name="optType" type="radio" id="optPaper" onClick="paper()"   value="Paper" /> 
    
    
   
    <input name="txtChoice" type="hidden" id="txtType"  value=""   /> 
...
<div id="error-page" style="height:auto; text-align:center;"> </div>
 ...
 <div style=" margin-bottom:20px;margin-left:5%; " class="rstclass" > <label style="width:200px; text-align:right;">Time: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label> 
