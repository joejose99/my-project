...
@section('content_header')
 <h1>Dashboard  &nbsp;&nbsp;&nbsp;&nbsp;<span class="welcome-heading-page">{{ Auth::user()->name }} </span></h1>  <span class="mainbody" style="margin-left:1px;">Edit Page</span>
 ...
 <div style="width:90%; max-width:795px; height:auto;" >  
   ...
   <div class="form-group{{ $errors->has('optionC') ? ' has-error' : '' }}"   >
           ...
           <select name="cls" class="cls" id="cls">
                               ...
                               <option  value="{!!$query[0]->title!!}">{!!$query[0]->title!!}</option>
...
$(function() {
 ...
 $("#butSubmit").click(function(ev) {
	...
	var errors= '<span class=rstclass style=color:#C63A26;> &nbsp;&nbsp; Details Value is required !! &nbsp;</span>';
