...
else
{
	...
	document.getElementById('main8').style.color="#000";
...
<div id="setUp" style="font-size:27px; color:#C1C1C1;" >Set Alarm for {!! $tm!!} </div>
<input name="hrs" id="hr_s" type="hidden" value="{!! $hr!!}" /><input name="mins" type="hidden" value="{!! $min!!}" id="min_s" />
...
<li style="margin-right:10px;" class="hide_question"> <input class="pauseButton btn btn-warning btn-lg mb-1" type="submit" name="butPause" id="reset" value="Reset"   /> 
 ...
 <input name="" type="hidden" id="setTime" /> 
  ...
  <div  id="butSubmit" style="width:98%;">
...
<div id="main7" class="mainDiv card mb-5" style="margin-top:-28px; display:inline-block;  min-width:88%;" >
  <div  id="title-head7" class="title-head">Advert </div>
 <br />
...
<div id="main8" class="mainDiv card mb-5" style="margin-top:-28px; display:inline-block; " >
  <div  id="title-head6" class="title-head">Set an alarm for the Available time </div>
 <br />
 <div id="list-button">
 ...
 <input name="but1" id="but<?php echo $ctr; ?>" type="button" class="button-green spacing-button"  value="<?php echo $items[$ctr]; ?>" onclick="updateTime('<?php echo $items[$ctr]; ?>')"/>
...
<div id="main3" class="mainDiv card mb-5" style="margin-top:-28px; display:inline-block;" >
 <div  id="title-head1" class="title-head">Set an alarm for the specified time </div>
 <br />
 
<input name="but1" id="but1" type="button" class="button-blue spacing-button"  value="4:00 AM" onclick="moreTime('4:00_AM')"/>

 
<input name="but2" id="but2" type="button" class="button-blue spacing-button"  value="4:30 AM"  onclick="moreTime('4:30_AM')"/>

<input name="" id="but3" type="button" class="button-blue spacing-button"  value="5:00 AM"  onclick="moreTime('5:00_AM')"/>
<input name=""  id="but4"type="button" class="button-blue spacing-button"  value="5:15 AM"  onclick="moreTime('5:15_AM')"/>

<input name=""  id="but5"type="button" class="button-blue spacing-button"  value="5:30 AM"  onclick="moreTime('5:30_AM')"/>
<input name=""  id="but6"type="button" class="button-blue spacing-button"  value="5:45 AM"  onclick="moreTime('5:45_AM')"/>


<input name=""  id="but7" type="button"  class="button-blue spacing-button"  value="6:00 AM"  onclick="moreTime('6:00_AM')"/>

<input name=""  id="but7" type="button"  class="button-blue spacing-button"  value="6:15 AM"  onclick="moreTime('6:15_AM')"/>

<input name="" id="but8" type="button" class="button-blue spacing-button"  value="6:30 AM"  onclick="moreTime('6:30_AM')"/>
<input name=""  id="but9" type="button" class="button-blue spacing-button"  value="6:45 AM"  onclick="moreTime('6:45_AM')"/>

<input name=""  id="but10" type="button" class="button-blue spacing-button"  value="7:00 AM"  onclick="moreTime('7:00_AM')"/>

<input name=""  id="but11"type="button" class="button-blue spacing-button"  value="7:15 AM" onclick="moreTime('7:15_AM')"/>

 <input name=""  id="but12" type="button" class="button-blue spacing-button"  value="7:30 AM" onclick="moreTime('7:30_AM')"/>
 <input name=""  id="but13" type="button" class="button-blue spacing-button"  value="7:45 AM" onclick="moreTime('7:45_AM')"/>


<input name="" id="but14" type="button" class="button-blue spacing-button"  value="8:00 AM" onclick="moreTime('8:00_AM')"/>

 <input name="" id="but15"type="button" class="button-blue spacing-button"  value="8:15 AM" onclick="moreTime('8:15_AM')"/>

<input name=""  id="but16" type="button" class="button-blue spacing-button"  value="8:30 AM" onclick="moreTime('8:30_AM')"/>

 <input name=""  id="but17"type="button" class="button-blue spacing-button"  value="8:45 AM" onclick="moreTime('8:45_AM')"/>


<input name="" id="but18" type="button" class="button-blue spacing-button"  value="9:00 AM" onclick="moreTime('9:00_AM')"/>
<input name="" id="but19" type="button" class="button-blue spacing-button"  value="9:30 AM" onclick="moreTime('9:30_AM')"/>

<input name="" id="but20" type="button" class="button-blue spacing-button"  value="10:00 AM" onclick="moreTime('10:00_AM')"/>
<input name="" id="but21" type="button" class="button-blue spacing-button"  value="10:30 AM" onclick="moreTime('10:30_AM')"/>

<input name=""  id="but22" type="button" class="button-blue spacing-button"  value="11:00 AM"  onclick="moreTime('11:00_AM')"/>
<input name="" id="but23" type="button" class="button-blue spacing-button"  value="11:30 AM" onclick="moreTime('11:30_AM')"/>

<input name="" id="but24" type="button" class="button-blue spacing-button"  value="12:00 PM" onclick="moreTime('12:00_PM')"/>
<input name="" id="but26" type="button" class="button-blue spacing-button"  value="12:30 PM" onclick="moreTime('12:30_PM')"/>
...
<div id="main4" class="card mb-5 mainDiv" style="margin-top:-28px;" >
 ...
 <div  id="title-head2" class="title-head">How to use the online alarm clock </div>
...
<div id="main5" class="mainDiv2 card mb-5 mainbody" style="margin-top:-28px; display:inline-block;  min-width:88%;" >
...

{
	...
	if(lstMinutes =="Minutes")
	{
		alert('Select Minutes');
		return false;
	}
	  ...
	  */
	  ...
	  var stHour= document.getElementById('hours').value
	   ...
	   var st_Hour=parseInt(stHour);
		...
		opt+='<option value="Select">Hour</option>'	
...
function updateTime(time)
{
		...
		document.getElementById('lstHour').value="Select";
		document.getElementById('lstMinutes').value="Select";
	...
	$.ajax({ 
	  dataType:"json", 
	    type:"POST", 
         url:"../setAlarm",
         data:{"_token":$('#signup-token').val(),"time":time},
		 processData:"false",
         success: function(data) {
             
             
    //alert(data.tm +': im here')
   
				 $("#setUp").html("<span style='font-size:27px; color:#C1C1C1;'>Set Alarm for "+ data.tm +"</span>"); 
				 
				//  $("#hr").html(data.hrs); 
				// $("#min").html(data.min); 
				 
				  document.getElementById('hr_s').value=data.hrs;
				  //document.getElementById("hr").innerHTML=data.hrs;
				 
				 
				 
				 
				 document.getElementById("min_s").value=data.min;
	    ...
	    type:"POST", 
         ...
         success: function(data) { 
				 ...
				 $("#setUp").html("<span style='font-size:27px; color:#C1C1C1;'>Set Alarm for "+ data.tm +"</span>"); 
				  ...
				  document.getElementById('hr_s').value=data.hr; 
				 
				 
				 var option="";
				 
				 document.getElementById("min_s").value=data.min; 
				 var counts = data.items.length;
				  var ctr =0;
				 ...
				 for (i=0;i < data.items.length;i++)
				  {
			 option +="<input name='but1' id='but"+ ctr +"'  type='button' class='button-green spacing-button' value='"+data.items[i]+"'  onClick="+ eq +"updateTime('"+data.items[i]+"')"+ eq +"/>"
