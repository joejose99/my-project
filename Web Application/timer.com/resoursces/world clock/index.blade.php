...
<title>World Clock</title>
 ...
 <script src="./timer/js/moment-10-year-range.min.js"> </script>
  <!--
  <script src="./timer/js/moment-locales.js"> </script>
-->
...
function changeColour(colour)
{
	...
	document.getElementById('city').style.color=colour;
	
	if(colour=="#000")
	{
		document.getElementById('city').style.color="#C1C1C1";
	}
 ...
 $.ajaxSetup({
   ...
   var  sp="<span id='sp' class='timeSize world-tm'>";
	...
	for (i=0;i < data.length;i++)
	 ...
	 //console.log('Testing Time :'+ data[i].utc_select);
	 
	// <a href ='editFaculty/" +data[i].falId +" '
  
  table+="<div id='wrdClock' class='world-hour' > <span id='spanId'  class='world-head' style='display:inline-block; text-align:center; '><a href ='view-city-utc-time/"+data[i].id +"' class='update'>" + data[i].state +', '+ data[i].value + "</a></span><br><br> <span id='sp' class='timeSize world-tm  clock'  data-timezone='"+data[i].time_zone+"' data-utc='"+UTC_time+" H'> </span>"+"</div>";
...
function updateClocks() {
  ...
  for (let clock of clocks) {
	...
	//let tm = new Date()
//console.log("Heres Time UTC: "+utcTime);
...
if(timDiff=='13.75')
{
	...
	var m= timDiff.indexOf('-');  
	  ...
	  if(m == -1)
	  {
		  ...
		  clock.innerHTML = time.substr(11,20)+"<br>"+sp1+time.substr(0,10) +", +"+timDiff+" H</div>";
...
<body  onload="getCountryTime(), getAutoColour()" >
...
<div id="main" class="card mb-5 mainDiv" >
 ...
 <!--
  ...
  <a class="active" href="./world-clock"><i class="material-icons active">access_time</i> <br /><span class="active">World Clock</span></a>
...
<div style="clear:both"></div>
 ...
 <div  id='city' class="mainbody" style="font-size:15px; margin-bottom:20px; text-align:center;" >Time Now</div>
            <div id="currentTime" class="timeSize-small" style="margin-top:-25px; text-align:center; margin-bottom:20px;  ">00:00:00</div>
            
            <div id="dt" class="timeSize" style="font-size:30px;margin-top:-25px; text-align:center"></div>
...
<div id="main3" class="mainDiv card mb-5" style="margin-top:-28px; display:inline-block; text-align:center;" >
 <div  id="title-head" class="title-head">World Clock for Available Cities</div>
...
<div style="both:clear;"></div>
 ...
 <div  id='butSubmit' class='world-hour-button-bg' style='padding-top:5%;'><input class='btn btn-success btn-lg '  type='submit' name='button' id='button' value='Add' style='z-index:-2;  ' /></div>
...
<div id="main4" class="card mb-5 mainDiv" style="margin-top:-28px; display:inline-block;  min-width:88%;" >
 ...
 <div  id="title-head4" class="title-head">How to use the online  clock </div>
