...
function updateClocks() {
  for (let clock of clocks) {
	...
	// let utcId =clock.dataset.utcId
	  
	let utcState=clock.dataset.utcState
...
<div class="mainbody">Time Zone:&nbsp;<strong> <span id='utcSate'> </span>  &nbsp;{!!$query[0]->time_zone !!} </strong></div>
