...
function rightOpenNav() {
  ...
  document.getElementById("main5").style.transition=".5s";
   ...
   document.getElementById("main9").style.marginRight = "250px";
  document.getElementById("main9").style.transition=".5s";
...
function rightCloseNav() {
  ...
  document.getElementById("main").style.transition=".5s";
   ...
   document.getElementById("main9").style.marginRight= "0";
   document.getElementById("main9").style.transition=".5s";
...
function nightFall()
{
	...
	document.getElementById('main9').style.color="#FF9500";
	...
	document.getElementById('main9').style.backgroundColor="#222D32";
...
else
{
	...
	document.getElementById('main9').style.color="#000";
	...
	document.getElementById('main9').style.backgroundColor="#fff";
...
<body onload="generateHour() ,hide_date_time(), getAutoColour()">
 ...
 <div class="mobileNavOpen"><span style="font-size:30px;cursor:pointer; color:#FFF;" onclick="openNav()"><i class='fas' style='  margin-top:10px;margin-left:4px; margin-right:10px;color:#fff;'>&#xf0c9</i></span></div> 
...
<a class="active" href="./timer-reading"><i class="material-icons" ><span style=" font-size:17px;">av_timer</span></i>&nbsp;&nbsp;Timer</a> 
...
<div id="main9" class="mainDiv card mb-5" style="margin-top:-28px; display:inline-block;" >
...
function toggleFullScreen() {
 ...
 // alert(document.getElementById('txtMobile').value);
  ...
  if(!doc.fullscreenElement && !doc.mozFullScreenElement && !doc.webkitFullscreenElement && !doc.msFullscreenElement) {
	...
	document.getElementById('main8').style.border="none";
	...
	document.getElementById('main8').style.backgroundClip="border-box";
	 
	 document.getElementById('main8').style.border="1px solid rgba(0,0,0,.125)";
 ...
 // var days = Math.floor(distance / (1000 * 60 * 60 * 24));
  ...
  var s = Math.floor((distance % (1000 * 60)) / 1000);
		  ...
		  if(lstHour >= 24)
		{
	 	   GuiTimer.html(font+
		   //GuiTimer.html(font+
		     days+"<span style='font-size:30px'; class='timeSize'>"+day_s+"</span>"+
		    (h < 10 ? '0':'')+ h
		    + ':' 
              + (m < 10 ? '0':'')+m 
            + ':' 
	  ...
	  if(lstHour ==0 )
		...
		console.log('Hours Teting: '+lstHour);
...
function updateTime(time,status)
{
    ...
    var font= "<span class=rstclass style=font-size:"+c +"; text-align:center; > ";
				 ...
				 document.getElementById("min_s").value=00;
				 document.getElementById("sec_s").value=00;
