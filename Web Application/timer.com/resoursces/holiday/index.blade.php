...
function rightOpenNav() {
  ...
  document.getElementById("main8").style.minWidth="69.04%";
   document.getElementById("main8").style.marginRight = "250px";
  document.getElementById("main8").style.transition=".5s";
...
function rightCloseNav() {
  ...
  document.getElementById("main").style.transition=".5s";
   ...
   document.getElementById("main7").style.transition=".5s";
    ...
    document.getElementById("main8").style.minWidth="88%";
   document.getElementById("main8").style.marginRight= "0";
   document.getElementById("main8").style.transition=".5s";
...
function nightFall()
{
	...
	document.getElementById('main8').style.backgroundColor="#222D32";
	...
	document.getElementById('main4').style.color="#FF9500";
	document.getElementById('main8').style.color="#FF9500";
...
document.getElementById('text-main').style.color="#FF9500";
	...
	document.getElementById('title-head8').style.color="#FF9500";
...
else
{
	...
	document.getElementById('main8').style.color="#1E2C2C";
	...
	document.getElementById('title-head8').style.color="#1E2C2C";
	...
	document.getElementById('main8').style.backgroundColor="#fff";
...
<!-- END OF RIGHT MENU  -->
 ...
 <a href="./timer-reading"><i class="material-icons" ><span style=" font-size:17px;">av_timer</span></i>&nbsp;&nbsp;Timer</a> 
  ...
  <a class="active" href="./holiday"><i class='fas fa-hotel'></i> &nbsp;&nbsp;Holiday</a>
</div>
...
<div id="main" class="card mb-5 mainDiv"  >
 ...
 <a href="./add-date"> <i class='fas fa-calendar-alt ' style="font-size:20px;"></i> <br /> Day Calculator</a>
  ...
  <a  class="active" href="./holiday"><i class='fas fa-hotel  active'></i><br /><span class="active">Holiday</span></a>
...
<div  class="zommLink" style="display:none;">
<!--
...
<div id="setUp" style="font-size:27px; color:#C1C1C1;" >Holiday  </div>
...
-->
 ...
 <nav id="nav" role="navigation" style="position:relative; margin-top:40px; display:none;">
...
<div id="main6" class="mainDiv card mb-5 " style="margin-top:-28px; display:inline-block;  position:relative;" >

 
  <div  id="title-head" class="title-head">Countdown to Easter and Good Friday </div>
 <br />
 
  <div id='good_friday' class='world-easter'> <span id='spanId'  class='world-head' style='display:inline-block;'><a  href ='javascript:void(0)' class='update'>&nbsp;&nbsp;Good Friday&nbsp;&nbsp;</a></span><br><br> </div>
 
  
  <div id='wrdClock' class='world-easter'> <span id='spanId'  class='world-head' style='display:inline-block;'><a href ='javascript:void(0)' class='update'>&nbsp;&nbsp;Easter Sunday &nbsp;&nbsp;</a></span><br><br> </div>
  
  
 
 <div id='easter_monday' class='world-easter'> <span id='spanId'  class='world-head' style='display:inline-block;'><a href ='javascript:void(0)' class='update'>&nbsp;&nbsp; Easter Monday&nbsp;&nbsp;</a></span><br><br> </div>
...
<div id="main7" class="mainDiv card mb-5" style="margin-top:-28px; display:inline-block; width:auto ;" >
  <div  id="title-head3" class="title-head">Countdown to Christmas , New Year and ST.Patrick's Day  </div>
 <br />
 
 <div style="clear:both;"> </div>
 
  <div id='christmas_eve' class='world-easter'> <span id='spanId'  class='world-head' style='display:inline-block;'><a href ='javascript:void(0)' class='update'>&nbsp;&nbsp;Christmas Eve&nbsp;&nbsp;</a></span><br><br> </div>
  
 
  <div id='christmas' class='world-easter'> <span id='spanId'  class='world-head' style='display:inline-block;'><a href ='javascript:void(0)' class='update'>&nbsp;&nbsp;Christmas Day&nbsp;&nbsp;</a></span><br><br> </div>
  
  
  <div id='new_year' class='world-easter'> <span id='spanId'  class='world-head' style='display:inline-block;'><a href ='javascript:void(0)' class='update'>&nbsp;&nbsp;New Year&nbsp;&nbsp;</a></span><br><br> </div>
  
  
 
 <div id='saint_p' class='world-easter'> <span id='spanId'  class='world-head' style='display:inline-block;'><a href ='javascript:void(0)' class='update'>&nbsp;&nbsp; Saint Patrick's Day &nbsp;&nbsp;</a></span><br><br> </div>
  
  
   <div id='valentine' class='world-easter'> <span id='spanId'  class='world-head' style='display:inline-block;'><a href ='javascript:void(0)' class='update'>&nbsp;&nbsp; Valentine's Day &nbsp;&nbsp;</a></span><br><br> </div>
  
 
 <div id='luther-king' class='world-easter'> <span id='spanId'class='world-head' style='display:inline-block;'><a href ='javascript:void(0)' class='update'>&nbsp;&nbsp;Martin Luther King Jr Day &nbsp;&nbsp; </a></span><br><br> </div>
...
<!-- EIGHT PHASE STARTS HERE -->

<div style="clear:both;"> </div>
 
 
   
<div id="main8" class="mainDiv card mb-5" style="margin-top:-28px; display:inline-block;  min-width:88%;" >
  <div  id="title-head8" class="title-head">Advert </div>
 <br />
...
<div id="main3" class="mainDiv card mb-5" style="margin-top:-28px; display:inline-block; min-width:88%;" >
 <div  id="title-head1" class="title-head">List of Countries National Holiday </div>
 <br />
 
 <!-- BUTTON LIST IS IN HERE -->
 <div id="list-button-hour">
  
 @foreach($country as $rst)

<input name='{!!$rst->id!!}' id='{!!$rst->id!!}'  type='button' class='button-light-blue spacing-button' value='{!!$rst->value!!}'  onClick="window.location.href='./view-country-holiday/{!!$rst->id!!}'" />
...
<div id="main5" class="mainDiv2 card mb-5 mainbody" style="margin-top:-28px; display:inline-block;  min-width:88%; height:auto;" >
  <div  id="title-head5" class="title-head ">Blog (Holiday)</div>
 <br />
  
  @foreach($query as $rst)
@if(trim($rst->menu) ==  "Holiday")
...
<div  class="title-head" style="position:relative;">
...
<input name="" id="but10" type="button" class="button-blue-read spacing-button"  value="Comment" onClick="window.location.href='./view-blog-page/{!!$rst->id !!}'"/></div>
...
function computus( y ,ddd) {
       ...
       var ddd=parseInt(ddd);
        ...
        date.setMonth( m, d + ( ddd - date.getDay() ) );
 ...
 var colours= sessionStorage.getItem("colour");
	...
	ctDate =  new Date()
	var yyy= ctDate.getFullYear();
	 
	 var  span="<span id='spanId'  style='display:inline-block;'>";
   var  spanclose="</span >";
   
   
   var  sp="<span id='sp' class='timeSize world-tm'>";
	 
	var  sp1="<div id='sp1' class='world-dt' style='color:"+ colours+"'>";
	var cls ="</span>";
	...
	for (i=0;i < 5;i++)
	{
	//if(typeof easter  !='undefined')
	 //{
		 easter =computus( yyy,7 ).substr(0,12);
		 table=" <div><span id='sp' class='world-tm3'><a href ='./easter-sunday/"+ easter +"' class='update-holiday'> Easter Sunday  "+ yyy +" &nbsp; </a></span>  <span class='world-dt3'> "+easter +"</span></div> ";
		// easter =computus( yyy ).substr(0,12) +"<br>";
		// $("#easterId").append(easter);
		
		$("#wrdClock").append(table);
     // console.log(easter);
	 //}
	     yyy =yyy+1
	 ...
	 /*EASTER MONDAY */
	 yyy=ctDate.getFullYear();;
	 for (i=0;i < 5;i++)
	{
	//if(typeof easter  !='undefined')
	 //{
		 easter =computus( yyy,8 ).substr(0,12);
		 table=" <div><span id='sp' class='world-tm3'><a href ='./easter-monday/"+ easter +"' class='update-holiday'>Easter Monday  "+ yyy +" &nbsp; </a></span>  <span class='world-dt3'> "+easter +"</span></div> ";
		// easter =computus( yyy ).substr(0,12) +"<br>";
		// $("#easterId").append(easter);
		
		$("#easter_monday").append(table);
     // console.log(easter);
	 //}
	     yyy =yyy+1
	...
	/*GOOD FRIDAY STARTS HERE */ 
	yyy=ctDate.getFullYear();;
	 for (i=0;i < 5;i++)
	{
	//if(typeof easter  !='undefined')
	 //{
		 easter =computus( yyy,5 ).substr(0,12);
		 table=" <div><span id='sp' class='world-tm3'><a href ='./good-friday/"+ easter +"' class='update-holiday'>Good Friday  "+ yyy +" &nbsp; </a></span>  <span class='world-dt3'> "+easter +"</span></div> ";
		// easter =computus( yyy ).substr(0,12) +"<br>";
		// $("#easterId").append(easter);
		
		$("#good_friday").append(table);
	 ...
	 var full_year;
	 function getHoliday(mm,dd,event)
	 {
	 var today = new Date()
	 
	 //var chYear=today2.getFullYear();
	 var cmas = new Date(today.getFullYear(),mm,dd);
	  
	 
	 if(today.getMonth() ==mm && today.getDate()>dd)
	 {
	 ...
	 //console.log(Math.ceil((cmas.getTime()-today.getTime())/(one_day))+ " Days left Untill Christmas");
	 ...
	 {
		  cmas.setFullYear(cmas.getFullYear()+1);
		  daysleft =Math.ceil((cmas.getTime()-today.getTime())/(one_day));
	}	 
	   // console.log(today.getMonth());
		
		//console.log('full year: '+cmas.toString().substr(11,5));
		full_year=cmas.toString().substr(11,5)+"-"+mm+"-"+dd;
		console.log('full year'+full_year);
	 
	  if(event =='Christmas Eve')
	 {
	 return table=" <div><span id='sp' class='world-tm3'> <a href ='./christmas-eve/"+full_year+"' class='update-holiday'>"+event  + cmas.toString().substr(10,6) +"</a> &nbsp; </span>  <span class='world-dt3'> "+daysleft +" Days left </span></div> ";
	}	 
		
	 
	 if(event =='Christmas')
	 {
	 return table=" <div><span id='sp' class='world-tm3'> <a href ='./christmas/"+full_year+"' class='update-holiday'>"+event  + cmas.toString().substr(10,6) +"</a> &nbsp; </span>  <span class='world-dt3'> "+daysleft +" Days left </span></div> ";
	}	 
		
		if(event =='New Year')
	 {
	 return table=" <div><span id='sp' class='world-tm3'> <a href ='./new-year/"+full_year+"' class='update-holiday'>"+event  + cmas.toString().substr(10,6) +"</a> &nbsp; </span>  <span class='world-dt3'> "+daysleft +" Days left </span></div> ";
	}	 
	 ...
	 return table=" <div><span id='sp' class='world-tm3'> <a href ='./new-year/"+full_year+"' class='update-holiday'>"+event  + cmas.toString().substr(10,6) +"</a> &nbsp; </span>  <span class='world-dt3'> "+daysleft +" Days left </span></div> ";
		...
		if(event =="Valentine's Day")
	 {
	 return table=" <div><span id='sp' class='world-tm3'> <a href ='./valentine/"+full_year+"' class='update-holiday'>"+event  + cmas.toString().substr(10,6) +"</a> &nbsp; </span>  <span class='world-dt3'> "+daysleft +" Days left </span></div> ";
	}
	
	
	if(event =="Saint Patrick's Day")
	 {
	 return table=" <div><span id='sp' class='world-tm3'> <a href ='./saint-partrick/"+full_year+"' class='update-holiday'>"+event  + cmas.toString().substr(10,6) +"</a> &nbsp; </span>  <span class='world-dt3'> "+daysleft +" Days left </span></div> ";
	}	
		
	if(event =="M.Luther King Jr. Day")
	 {
	 return table=" <div><span id='sp' class='world-tm3'> <a href ='./martin-luther-king/"+full_year+"' class='update-holiday'>"+event  + cmas.toString().substr(10,6) +"</a> &nbsp; </span>  <span class='world-dt3'> "+daysleft +" Days left </span></div> ";
	}	 
	 
	 
	} 
  
  /*CHRISTMAS EVE STARTS HERE */
   $("#christmas_eve").append(getHoliday(11,24,"Christmas Eve"))
   
   /* Christmas DAY STARTS HERE */
    $("#christmas").append(getHoliday(11,25,"Christmas"))
 //console.log(full_year);
  
/* NEW YEAR STARTS HERE */

 $("#new_year").append(getHoliday(00,01,"New Year"))
 
 /* SAINT PATRICK'S DAY STARTS HERE */

 $("#saint_p").append(getHoliday(02,17,"Saint Patrick's Day"))
 
 /* VALENTINE'S DAY STARTS HERE */
  $("#valentine").append(getHoliday(01,14,"Valentine's Day"))

/* Martin Luther King Jr Day'S DAY STARTS HERE */
  $("#luther-king").append(getHoliday(00,20,"M.Luther King Jr. Day"))
 //time.substr(13,20)
