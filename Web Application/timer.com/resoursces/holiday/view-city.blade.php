...
<link href="../timer/css/table_city.css" rel="stylesheet" type="text/css" />
...
<div id="main" class="card mb-5 mainDiv"  style="display:inline-block; min-width:88%; "  >
 ...
 <a href="../add-date"> <i class='fas fa-calendar-alt ' style="font-size:20px;"></i> <br /> Day Calculator</a>
  ...
  <a  class="active"  href="../holiday"><i class='fas fa-hotel'></i><br /><span class="active">Holiday</span></a>
...
<div id="setUp" style="font-size:27px; color:#C1C1C1; padding-bottom:10px;" >Country Holiday  </div>
...
<div style=" position:relative; margin-right:auto; margin-left:25%;margin-right:25%;" id="paginate"> {{ $query->links() }}  </div>    
