...
<body onload="getAutoColour(),callCountDown()">
...
<div id="setUp" style="font-size:27px; color:#C1C1C1;" ><?php if($status =='Easter Sunday') {echo $status;  echo  substr($easterDate,7,5); }   ?> <?php if($status =='Easter Monday') {echo $status;  echo  substr($easterDate,7,5);}   ?> <?php if($status =='Good Friday') {echo $status;  echo  substr($easterDate,7,5); }   ?> </div>
...
<input name="txtNow" type="hidden" value='' id="txtNow" />
            ...
            <div id="dt" class="timeSize" style="font-size:40px;margin-top:-25px; text-align:center">
            
            <?php if($status =='Easter Sunday') { echo $easterDate;}   ?> <?php if($status =='Easter Monday') {  echo $easterDate;}   ?> <?php if($status =='Good Friday') { echo $easterDate;}   ?> 
            </div>
...
<div id="main6" class="mainDiv card mb-5" style="margin-top:-28px; display:inline-block; min-width:88%; position:relative;">
...
<div id="main7" class="mainDiv card mb-5" style="margin-top:-28px; display:inline-block;" >
  <div  id="title-head3" class="title-head">About Easter </div>
 <br />
 
 <div  id="text-main" class="mainbody">
 Easter is made up of Easter Sunday and Easter Monday,  Easter Monday is the day after Easter Sunday and is a holiday in some countries. Easter Monday in the Western Christian liturgical calendar is the second day of Eastertide and analogously in the Byzantine Rite is the second day of Bright Week.</div>
...
<div id="main5" class="mainDiv card mb-5 mainbody" style="margin-top:-28px; display:inline-block;min-width:88%; position:relative; height:auto;" >
 <div  id="title-head5" class="title-head">Blog ({!! $status!!})</div>
 <br />
...
<span class="mainbody">
  <div  id="footer"class="footer">Copyright ©2019 timeer.com All Rights Reserved.
...
function callCountDown()
{
	...
	events = new Date(newDate);
	console.log('events :'+events.getMonth());
	var months =events.getMonth();
	  
	
	today.setYear(newDate.substr(7,5))
	 today.setMonth(months)
	today.setDate(newDate.substr(4,2))
