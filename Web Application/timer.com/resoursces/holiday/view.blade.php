...
function rightOpenNav() {
  ...
  document.getElementById("main8").style.transition=".5s";
   ...
   document.getElementById("footer1").style.minWidth="69.04%";
...
function rightCloseNav() {
  ...
  document.getElementById("main").style.transition=".5s";
   ...
   document.getElementById("footer1").style.minWidth="88%";
...
function nightFall()
{
	...
	document.getElementById('setUp').style.color="#FF9500";
...
<body onload="getAutoColour(),callCountDown(),add_Holidays()">
...
<div id="setUp" style="font-size:27px; color:#C1C1C1;" ><?php if($status =='Christmas Eve') {echo $status; }   ?> <?php if($status =='Christmas Day') {echo $status;    }   ?> <?php if($status =='New Year Day') {echo $status;   }   ?> <?php if($status =="Valentine's Day") {echo $status;   }   ?> <?php if($status =="Saint Patrick's Day") {echo $status;   }   ?>  <?php if($status =="M.Luther King Jr. Day") {echo $status;   }   ?> </div>
...
<div id="main5" class="card mb-5 mainDiv " style="margin-top:-28px; display:inline-block;   min-width:88%; position:relative; " >
 <div  id="title-head2" class="title-head"><?php  echo $status;     ?> </div>
<div id='wrdClock' class='world-easter'> <span id='spanId'  class='world-head' style='display:inline-block;'><a href ='#' class='update'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
<?php   if(trim($status)=='Martin Luther King Jr Day')
  {
   echo'M.Luther King Jr. Day';
  }
  else
  {
  echo $status;
...
<div id='good_friday' class='world-easter'> <span id='spanId'  class='world-head' style='display:inline-block;'><a href ='#' class='update'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
<?php   if(trim($status)=='Martin Luther King Jr Day')
  {
   echo'M.Luther King Jr. Day';
  }
...
<div id='easter_monday' class='world-easter'> <span id='spanId'  class='world-head' style='display:inline-block;'><a href ='#' class='update'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php   if(trim($status)=='Martin Luther King Jr Day')
  {
   echo'M.Luther King Jr. Day';
  }
...
<div id="main6" class="mainDiv card mb-5" style="margin-top:-28px; display:inline-block; width:auto ;" >
...
<div id="main7" class="mainDiv card mb-5" style="margin-top:-28px; display:inline-block;" >
  <div  id="title-head" class="title-head">About <?php  echo $status;     ?> </div>
 <br />
...
<div id="main3" class="mainDiv card mb-5" style="margin-top:-28px; display:inline-block;min-width:88%; position:relative;" >
 <div  id="title-head1" class="title-head">Advert </div>
 <br />
...
<div id="main4" class="card mb-5 mainDiv" style="margin-top:-28px;" >
 ...
 <div  id="title-head4" class="title-head">How to use the online timer </div>
<div  id="text-main" class="mainbody">
...
<div id="main8" class="mainDiv card mb-5 mainbody" style="margin-top:-28px; display:inline-block;min-width:88%; position:relative;" >
 <div  id="title-head8" class="title-head ">Blog (<?php  echo $status;?>) &nbsp; &nbsp;</div>
 <br />
  
  
   @foreach($query as $rst)
   
   @if(trim($rst->menu) ==  trim($status))
...
<div  id="footer1" class=" card mb-5 mainDiv"   style="margin-top:0px; display:inline-block;min-width:88%; position:relative;" >
<span class="mainbody">
...
function toggleFullScreen() {
 ...
 // alert(document.getElementById('txtMobile').value);
  ...
  if(!doc.fullscreenElement && !doc.mozFullScreenElement && !doc.webkitFullscreenElement && !doc.msFullscreenElement) {
	...
	document.getElementById('main3').style.border="none";
	...
	if (style == 60){
	 ...
	 document.getElementById('main3').style.backgroundClip="border-box";
	 
	 document.getElementById('main3').style.border="1px solid rgba(0,0,0,.125)";
 ...
 // var days = Math.floor(distance / (1000 * 60 * 60 * 24));
  ...
  var s = Math.floor((distance % (1000 * 60)) / 1000);
		  ...
		  if(days >= 1)
		{
	 	   GuiTimer.html(font+
		   //GuiTimer.html(font+
		     days+"<span style='font-size:30px'; class='timeSize'>Days </span>"+
		    (h < 10 ? '0':'')+ h
...
function staticTime()
{
 ...
 var now = new Date().getTime();
		...
		//console.log('Hour: '+Hours);
		  ...
		  var days = Math.floor(distance / (1000 * 60 * 60 * 24));
		//var days = Math.ceil((1000 * 60 * 60 * 24)/distance);
		var h = Math.floor((distance % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
  var m = Math.floor((distance % (1000 * 60 * 60)) / (1000 * 60));
  var s = Math.floor((distance % (1000 * 60)) / 1000);
...
{
	  var newDate= '<?= trim($easterDate); ?>'
	  
	  
	tday = new Date();
	/*
	 console.log("DX "+newDate.substr(8,2));
	 console.log("MX "+newDate.substr(5,2));
	 console.log("YX "+newDate.substr(0,4));
	*/
	var dx= newDate.substr(8,2);
	 
	 
	var  mx= newDate.substr(5,2); 
	 
	 
	var yx =parseInt(newDate.substr(0,4));
	...
	var now = new Date().getTime();
	   ...
	   $('#dt').html(tday.toString().substr(0,15));
	   
		var countDownDt=tday.getTime()
 ...
 var full_year;
	 ...
	 {
	 return table=" <div><span id='sp' class='world-tm3'> <a href ='../christmas-eve/"+full_year+"' class='update-holiday'>"+event  + cmas.toString().substr(10,6) +"</a> &nbsp; </span>  </div> ";
	}	 
		
	 
	 if(event =='Christmas')
	 {
	 return table=" <div><span id='sp' class='world-tm3'> <a href ='../christmas/"+full_year+"' class='update-holiday'>"+event  + cmas.toString().substr(10,6) +"</a> &nbsp; </span>  </div> ";
	}	 
		
		if(event =='New Year')
	 {
	 return table=" <div><span id='sp' class='world-tm3'> <a href ='../new-year/"+full_year+"' class='update-holiday'>"+event  + cmas.toString().substr(10,6) +"</a> &nbsp; </span>  </div> ";
	}	 
	 ...
	 {
	 return table=" <div><span id='sp' class='world-tm3'> <a href ='../valentine/"+full_year+"' class='update-holiday'>"+event  + cmas.toString().substr(10,6) +"</a> &nbsp; </span>  </div> ";
	}
	
	
	if(event =="Saint Patrick's Day")
	 {
	 return table=" <div><span id='sp' class='world-tm3'> <a href ='../saint-partrick/"+full_year+"' class='update-holiday'>"+event  + cmas.toString().substr(10,6) +"</a> &nbsp; </span>  </div> ";
	}	
		
	if(event =="M.Luther King Jr. Day")
	 {
	 return table=" <div><span id='sp' class='world-tm3'> <a href ='../martin-luther-king/"+full_year+"' class='update-holiday'>"+event  + cmas.toString().substr(10,6) +"</a> &nbsp; </span>  </div> ";
	}	 
...
/* NEW YEAR STARTS HERE */
 ...
 $("#new_year").append(getHoliday(0,1,"New Year"));
 
 /* SAINT PATRICK'S DAY STARTS HERE */

 $("#saint_p").append(getHoliday(2,17,"Saint Patrick's Day"));
 
 /* VALENTINE'S DAY STARTS HERE */
  $("#valentine").append(getHoliday(1,14,"Valentine's Day"));

/* Martin Luther King Jr Day'S DAY STARTS HERE */
  $("#luther-king").append(getHoliday(0,20,"M.Luther King Jr. Day"));
 //time.substr(13,20)
...
function add_Holidays()
 {
	   ...
	   var corrt_date='<?=trim($easterDate);?>'
	  
	  
	  console.log(corrt_date);
	  
	  console.log("DX "+corrt_date.substr(8,2));
	 console.log("MX "+corrt_date.substr(5,2));
	 console.log("YX "+corrt_date.substr(0,4));
	  
	  
	  var y=parseInt(corrt_date.substr(0,4));
	  nowdates =new Date();
	  
	 y=parseInt(nowdates.getFullYear());
	  var m=corrt_date.substr(5,2);
	  var d=corrt_date.substr(8,2);
	 ...
	 for (i=0;i < 38;i++)
	{
		...
		var dateAdd=y+"-"+m+"-"+d;
		 ...
		 table=" <div><span id='sp' class='world-tm3'><a href ='../<?php echo $url?>/"+ dateAdd +"' class='update-holiday'> <?php  echo $status;     ?>  "+ y +" &nbsp; </a></span> </div> ";
