...
else
{
	...
	document.getElementById('main3').style.color="#000";
  ...
  if(id==9)
{
 ...
 document.getElementById('txtHrs').value=hr;
  document.getElementById('txtCheck_Date').value=hr;
 } 
  ...
  if(id==10)
{
	...
	document.getElementById('txtHrs1').value="";
 document.getElementById('txtHrs1').value=hr;
  document.getElementById('txtCheck_Date').value=hr;
 } 
  ...
  if(id==11)
{
	...
	document.getElementById('txtMnt').value="";
 document.getElementById('txtMnt').value=hr;
  document.getElementById('txtCheck_Date').value=hr;
 } 
  ...
  if(id==12)
{
	...
	document.getElementById('txtMnt1').value="";
 document.getElementById('txtMnt1').value=hr;
  document.getElementById('txtCheck_Date').value=hr;
 } 
 ...
 if(id==13)
{
 ...
 document.getElementById('txtSec').value=hr;
  document.getElementById('txtCheck_Date').value=hr;
 } 
  ...
  if(id==14)
{
	...
	document.getElementById('txtSec1').value="";
 document.getElementById('txtSec1').value=hr;
  document.getElementById('txtCheck_Date').value=hr;
 } 
 ...
 document.getElementById('popup_hour3').style.display='none';
   document.getElementById('popup_hour2').style.display='none';
   
    document.getElementById('popup_mnt').style.display='none';
	 document.getElementById('popup_mnt1').style.display='none';
	 
	 document.getElementById('popup_sec').style.display='none';
	 document.getElementById('popup_sec1').style.display='none';
...
document.getElementById('popup_hour').style.display='none';
   ...
   function txtHrsPopUp()
{
 // var ids =id;
  
  
   document.getElementById('popup_hour2').style.display='block';
    document.getElementById('popup_hour3').style.display='none';
    document.getElementById('popup_hour').style.display='none';
 document.getElementById('popup_month').style.display='none';
   document.getElementById('popup_year').style.display='none';
...
//console.log(id);
   ...
   function txtMntPopUp()
{
 // var ids =id;
  
   document.getElementById('popup_mnt').style.display='block';
    document.getElementById('popup_mnt1').style.display='none';
...
//console.log(id);
  ...
  function txtSecPopUp()
{
 // var ids =id;
  
   document.getElementById('popup_sec').style.display='block';
    document.getElementById('popup_sec1').style.display='none';
...
document.getElementById('popup_hour1').style.display='none';
   ...
   function txtHrs1EndPopUp()
{
 // var ids =id;
  
  
   document.getElementById('popup_hour3').style.display='block';
   document.getElementById('popup_hour2').style.display='none';
    document.getElementById('popup_hour').style.display='none';
 document.getElementById('popup_month').style.display='none';
   document.getElementById('popup_year').style.display='none';
...
//console.log(id);
   ...
   function txtMnt1EndPopUp()
{
 // var ids =id;
  
   document.getElementById('popup_mnt1').style.display='block';
    document.getElementById('popup_mnt').style.display='none';
...
//console.log(id);
 ...
 function txtSec1EndPopUp()
{
 // var ids =id;
  
   document.getElementById('popup_sec1').style.display='block';
    document.getElementById('popup_sec').style.display='none';
...
document.getElementById('popup_hour').style.display='none';
 ...
 function generate_Time_Start()
 {
	nw =new Date();
	document.getElementById('txtHrs').value=nw.getHours();
	document.getElementById('txtMnt').value= nw.getMinutes();
	document.getElementById('txtSec').value= nw.getSeconds();
	
	
	}
	
	function generate_Time_End()
 {
	nw =new Date();
	document.getElementById('txtHrs1').value=nw.getHours();
	document.getElementById('txtMnt1').value= nw.getMinutes();
	document.getElementById('txtSec1').value= nw.getSeconds();
	
	
	}
	
	
	 function generate_Time_noon_Start()
 {
	document.getElementById('txtHrs').value="12";
	document.getElementById('txtMnt').value= "00";
	document.getElementById('txtSec').value= "00";
	
	
	}
	
	function generate_Time_noon_End()
 {
	 
	document.getElementById('txtHrs1').value="12";
	document.getElementById('txtMnt1').value= "00";
	document.getElementById('txtSec1').value= "00";
	
	
	}
	
	/* HIDE AND DISPLAY TIME TEXTBOX */
	function hide_display_time()
 {
	 
	var txtTM = parseInt(document.getElementById('txt_tm').value)
	...
	if(txtTM==1)
	{
	  ...
	  $('#incTime').html("<a href='javascript:void(0)'onclick='hide_display_time()'>Remove Time</a>");
	  
		 
		document.getElementById('hours_minutes_sec_row2').style.display="block";
		document.getElementById('hours_minutes_sec_row1').style.display="block";
		
		document.getElementById('hours_minutes_sec_row_txt2').style.display="block";
		document.getElementById('hours_minutes_sec_row_txt1').style.display="block";
		
		document.getElementById('tm_now').style.display="block";
		document.getElementById('tm_now1').style.display="block";
		
		
		document.getElementById('txt_tm').value=0;
		document.getElementById('txt_tm1').value=1;
		
		 
		document.getElementById("CheckedId").style.display="none";
		
	}	
	
	if(txtTM==0)
	{
		$('#incTime').html("<a href='javascript:void(0)'onclick='hide_display_time()'>Include Time</a>");
	   document.getElementById('hours_minutes_sec_row2').style.display="none";
		document.getElementById('hours_minutes_sec_row1').style.display="none";
		
		document.getElementById('hours_minutes_sec_row_txt2').style.display="none";
		document.getElementById('hours_minutes_sec_row_txt1').style.display="none";
		
		document.getElementById('tm_now').style.display="none";
		document.getElementById('tm_now1').style.display="none";
		
		document.getElementById('txt_tm').value=1;
		document.getElementById('txt_tm1').value=0;
...
function generate_Minutes()
 {
	 ...
	 for (i=0;i < 60;i++)
	{
		...
		if(ctr <10)
		{
			...
			table +="<input name='but1' id='but"+ ctr +"' type='button' class='button-white' value='0"+ctr+"' onClick='updateTime_full("+ctr+",11)'/>"

tbl +="<input name='but1' id='but"+ ctr +"' type='button' class='button-white' value='0"+ctr+"' onClick='updateTime_full("+ctr+",12)'/>"
		...
		if(ctr >9){
			...
			table +="<input name='but1' id='but"+ ctr +"' type='button' class='button-white' value='"+ctr+"' onClick='updateTime_full("+ctr+",11)'/>"

tbl +="<input name='but1' id='but"+ ctr +"' type='button' class='button-white' value='"+ctr+"' onClick='updateTime_full("+ctr+",12)'/>"
  ...
  $("#popup_mnt").append(table);
  $("#popup_mnt1").append(tbl);
  //$("#popup_year1").append(option);
...
if(ctr <10)
		{
			...
			table +="<input name='but1' id='but"+ ctr +"' type='button' class='button-white' value='0"+ctr+"' onClick='updateTime_full("+ctr+",13)'/>"

tbl +="<input name='but1' id='but"+ ctr +"' type='button' class='button-white' value='0"+ctr+"' onClick='updateTime_full("+ctr+",14)'/>"
		...
		if(ctr >9){
			...
			table +="<input name='but1' id='but"+ ctr +"' type='button' class='button-white' value='"+ctr+"' onClick='updateTime_full("+ctr+",13)'/>"

tbl +="<input name='but1' id='but"+ ctr +"' type='button' class='button-white' value='"+ctr+"' onClick='updateTime_full("+ctr+",14)'/>"
  ...
  $("#popup_sec").append(table);
  
  $("#popup_sec1").append(tbl);
  //$("#popup_year1").append(option);
 ...
 function count_days()
 {
	...
	var checkTime=parseInt(document.getElementById('txt_tm1').value);
	 ...
	 var nowTM = new Date()
	var h= nowTM.getHours();
	var m= nowTM.getMinutes();
	var s= nowTM.getSeconds();
	...
	if(checkTime==1 )
	{
	   ...
	   var txt_Hours =parseInt(document.getElementById('txtHrs').value);
	   
	    var txt_Minutes =parseInt(document.getElementById('txtMnt').value);
		
		 var txt_Seconds =parseInt(document.getElementById('txtSec').value);
   ...
   if(isNaN(txt_Hours) )
	...
	if(isNaN(txt_Minutes))
	{
	 	txt_Minutes=0;
	 }
	
	
	if(isNaN(txt_Seconds))
	{
	   txt_Seconds=0;
	}
   ...
   /* END TIME STARTS HERE*/
		 ...
		 /* END HOURS */
		  var txt_Hours1 =parseInt(document.getElementById('txtHrs1').value);
	   
	    var txt_Minutes1 =parseInt(document.getElementById('txtMnt1').value);
		
		 var txt_Seconds1 =parseInt(document.getElementById('txtSec1').value);
   ...
   if(isNaN(txt_Hours1) )
	...
	if(isNaN(txt_Minutes1))
	{
	 	txt_Minutes1=0;
	 }
	
	
	if(isNaN(txt_Seconds1))
	{
	   txt_Seconds1=0;
	}
	/*
	...
	*/
	...
	var ed=enYear+"/"+enMonth+"/"+enDay +" "+h +":"+m+":"+s;
	
	var st=stYear+"/"+stMonth+"/"+stDay +" "+h +":"+m+":"+s;
 ...
 // console.log('Before End Date: ' +endDate);
  // console.log('Before Start Date: ' +start_Date);
  
  if(checkTime==1)
  {
	start_Date.setHours(start_Date.getHours()+txt_Hours);
		   
	start_Date.setMinutes(start_Date.getMinutes()+txt_Minutes);
    start_Date.setSeconds(start_Date.getSeconds()+txt_Seconds);
	
	endDate.setHours(endDate.getHours()+txt_Hours1);
	 endDate.setMinutes(endDate.getMinutes()+txt_Minutes1);
    endDate.setSeconds(endDate.getSeconds()+txt_Seconds1);
 }
	 

//console.log('After End Date: ' +endDate);
  // console.log('After Start Date: ' +start_Date);
  
  
  var nextDay;
  var tomorrow;
  if(document.getElementById('chk').checked==true && checkTime!=1)
   
	{
		// nextDay= new Date(ed)
		  ...
		  //nextDay.setFullYear(endDate.getFullYear());
		  // nextDay.setMonth(endDate.getMonth());
	} 
   ...
   var now = new Date().getTime();
	   ...
	   var end_Date;
		var start_Dates=start_Date.getTime()  
		if(document.getElementById('chk').checked!=true)
	{
	...
	if(document.getElementById('chk').checked==true)
	{
		 ...
		 //end_Date=nextDay.getTime()
		  end_Date=endDate.getTime()
		 
	}	
		  //var total_date=end_Date-start_Dates;
		 
		  var total_date=(end_Date-now)-(start_Dates-now);
		  
		  /* SWAPING THE TIME DIFFERENCE TO AVOID NEGATIVE NUMBER */
		 var swap=0;
		if(total_date <0)
		{
		  total_date=(start_Dates-now)-(end_Date-now);
		  swap=1;
		} 
 ...
 var days = Math.floor(date_Diff / (1000 * 60 * 60 * 24));
		 ...
		 var hours = Math.floor((date_Diff % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
  ...
  var hrs =24*days
  var minutes_av =hrs *60;
  var sec_av =minutes_av *60;
  if(checkTime==1)
  {
	  hrs =(24*days)+hours
	   minutes_av =(hrs *60)+minutes;
   sec_av =(minutes_av *60)+seconds;
  ...
  if(document.getElementById('chk').checked!=true && checkTime!=1)
	{
 var rst ="From <span style='font-weight:bold;'>"+ start_Date.toString().substr(0,15)+"</span> to, Excluding <span style='font-weight:bold;'>"+ endDate.toString().substr(0,15)+"</span><br><br>"
  
  
 rst+=" <span style='font-weight:bold;'>Result: "+days+ " day </span><br>It is "+ days + "  day from the start date to the end date, but not including the end date."
 
  rst+="<span style='font-weight:bold;' class='mainbody'><br><br>Alternative Time Units</span><br><li>Days: "+days+"</li><li>Hours: "+hrs+"</li><li>Minutes: "+minutes_av+"</li><li>Seconds: "+sec_av+"</li>";
 }
 ...
 rst+=" <span style='font-weight:bold;'>Result: "+days+ " day ,\n Hours " +hours +", Minutes " +minutes +", Seconds " +seconds +"</span><br>It is "+ days + "  day from the start date to the end date, but not including the end date."
 ...
 if(document.getElementById('chk').checked==true && checkTime==1)
	{
	var rst ="From <span style='font-weight:bold;'>"+ start_Date.toString().substr(0,15)+"</span> to <span style='font-weight:bold;'>"+ endDate.toString().substr(0,15)+"</span><br><br>"
  
  
 rst+=" <span style='font-weight:bold;'>Result: "+days+ " day,\n Hours " +hours +", Minutes " +minutes +", Seconds " +seconds +"  </span><br>It is "+ days + "  day from the start date to the end date,  including the end date."
 ...
 rst+=" <span style='font-weight:bold;'>Result: "+days+ " day </span><br>It is "+ days + "  day from the start date to the end date,  including the end date."
...
$('#rst').html(rst);
  ...
  if(swap==1)
  { 
  var str ="<span class ='mainbody'> Warning <br>The Start date was after the End date, so the Start Date and End Date were swapped.</span>"
...
<body onload="generateHour() ,hide_date_time(), getAutoColour(),generateYear(),generate_Minutes(),generate_Seconds()">
 ...
 <input name="txtMobile" type="hidden" value='' id="txtMobile" />
  ...
  <input name="txt_tm1" type="hidden" value='0' id="txt_tm1" />
  
   <input name="txt_tm" type="hidden" value='1' id="txt_tm" />
...
<!-- END OF RIGHT MENU  -->
 ...
 <a href="./timer-reading"><i class="material-icons" ><span style=" font-size:17px;">av_timer</span></i>&nbsp;&nbsp;Timer</a> 
  ...
  <a href="./add-date"> <i class='fas fa-calendar-alt'></i> &nbsp;&nbsp;Day Calculator</a>
   ...
   <a class="active" href="./count-days"> <i class='fas fa-calendar-plus'></i> &nbsp;&nbsp;Date Calculator</a>
...
<div id="main" class="card mb-5 mainDiv"  style="display:inline-block; min-width:88%; "  >
 ...
 <a href="./add-date"> <i class='fas fa-calendar-alt  ' style="font-size:20px;"></i> <br /> Day Calculator</a>
   ...
   <a class="active" href="./count-days"> <i class='fas fa-calendar-plus active' style="font-size:20px;"></i><br /><span class="active">Date Calculator</span></a>
...
<div id="setUp" style="font-size:27px; color:#C1C1C1; padding-bottom:10px;" >Date Calculator  </div>
...
<input  class="button-white" id="but1" name="but1" type="button" value="01 - Jan"   onclick="updateTime_full('01',2)"/>

 

<input  class="button-white" id="but2" name="but2" type="button" value="02 - Feb"   onclick="updateTime_full('02',2)"/>
<input  class="button-white" id="but3" name="but3" type="button" value="03 - Mar"   onclick="updateTime_full('03',2)"/>
<input  class="button-white" id="but4" name="but4" type="button" value="04 - Apr"   onclick="updateTime_full('04',2)"/>
<input  class="button-white" id="but5" name="but5" type="button" value="05 - May"   onclick="updateTime_full('05',2)"/>
<input  class="button-white" id="but6" name="but6" type="button" value="06 - Jun"   onclick="updateTime_full('06',2)"/>
<input  class="button-white" id="but7" name="but7" type="button" value="07 - Jul"   onclick="updateTime_full('07',2)"/>
<input  class="button-white" id="but8" name="but8" type="button" value="08 - Aug"   onclick="updateTime_full('08',2)"/>
<input  class="button-white" id="but9" name="but9" type="button" value="09 - Sep"   onclick="updateTime_full('09',2)"/>
<input  class="button-white" id="but10" name="but10" type="button" value="10 - Oct"   onclick="updateTime_full(10,2)"/>
<input  class="button-white" id="but11" name="but11" type="button" value="11 - Nov"   onclick="updateTime_full(11,2)"/>
<input  class="button-white" id="but12" name="but12" type="button" value="12 - Dec"   onclick="updateTime_full(12,2)"/>
...
<div id="popup_mnt"  class="popupDate popup_month_year" style="display:none;"  >
<div class="title-head"  >Minutes </div>

</div>

<div id="popup_sec"  class="popupDate popup_month_year" style="display:none;"  >
<div class="title-head"  >Seconds </div>

</div>


<div id="popup_hour2"  class="popupDate popup_month_year"  style="display:none;"  >
<div class="title-head"  >AM </div>
<input  class="button-white" id="buts1" name="but1" type="button" value="1:00 AM - 01"   onclick="updateTime_full(1,9)"/>

<input  class="button-white" id="buts2" name="but2" type="button" value="2:00 AM - 02"   onclick="updateTime_full(2,9)"/>
<input  class="button-white" id="buts3" name="but3" type="button" value="3:00 AM - 03"   onclick="updateTime_full(3,9)"/>
<input  class="button-white" id="buts4" name="but4" type="button" value="4:00 AM - 04"   onclick="updateTime_full(4,9)"/>
<input  class="button-white" id="buts5" name="but5" type="button" value="5:00 AM - 05"   onclick="updateTime_full(5,9)"/>
<input  class="button-white" id="buts6" name="but6" type="button" value="6:00 AM - 06"   onclick="updateTime_full(6,9)"/>
<input  class="button-white" id="buts7" name="but7" type="button" value="7:00 AM - 07"   onclick="updateTime_full(7,9)"/>
<input  class="button-white" id="buts8" name="but8" type="button" value="8:00 AM - 08"   onclick="updateTime_full(8,9)"/>
<input  class="button-white" id="but9" name="but9" type="button" value="9:00 AM - 09"   onclick="updateTime_full(9,9)"/>
<input  class="button-white" id="buts10" name="but10" type="button" value="10:00 AM - 10"   onclick="updateTime_full(10,9)"/>
<input  class="button-white" id="buts11" name="but11" type="button" value="11:00 AM - 11"   onclick="updateTime_full(11,9)"/>
<input  class="button-white" id="buts12" name="but12" type="button" value="12:00 AM - 12"   onclick="updateTime_full(12,9)"/>

 

<div class="title-head">PM </div>

<input  class="button-white" id="but1" name="but1" type="button" value="1:00 PM - 13"   onclick="updateTime_full(13,9)"/>

<input  class="button-white" id="but2" name="but2" type="button" value="2:00 PM - 14"   onclick="updateTime_full(14,9)"/>
<input  class="button-white" id="but3" name="but3" type="button" value="3:00 PM - 15"   onclick="updateTime_full(15,9)"/>
<input  class="button-white" id="but4" name="but4" type="button" value="4:00 PM - 16"   onclick="updateTime_full(16,9)"/>
<input  class="button-white" id="but5" name="but5" type="button" value="5:00 PM - 17"   onclick="updateTime_full(17,9)"/>
<input  class="button-white" id="but6" name="but6" type="button" value="6:00 PM - 18"   onclick="updateTime_full(18,9)"/>
<input  class="button-white" id="but7" name="but7" type="button" value="7:00 PM - 19"   onclick="updateTime_full(19,9)"/>
<input  class="button-white" id="but8" name="but8" type="button" value="8:00 PM - 20"   onclick="updateTime_full(20,9)"/>
<input  class="button-white" id="but9" name="but9" type="button" value="9:00 PM - 21"   onclick="updateTime_full(21,9)"/>
<input  class="button-white" id="but10" name="but10" type="button" value="10:00 PM - 22"   onclick="updateTime_full(22,9)"/>
<input  class="button-white" id="but11" name="but11" type="button" value="11:00 PM - 23"   onclick="updateTime_full(23,9)"/>
<input  class="button-white" id="but12" name="but12" type="button" value="12:00 PM - 00"   onclick="updateTime_full(00,9)"/>
</div>
...
<button  id="toggle" onclick="callDatePicker(1)" class="button-image" ><i class='fas fa-calendar-alt' ></i></button>  </div>
  ...
  <input id="txtPicker" type="hidden" class="form-control" name="txtPicker"   value="{{ old('txtPicker') }}" required autofocus autocomplete="off" style=" text-align:left; width:130px;"  placeholder="picker" >
     ...
     <div class="div-table-row">  
        ...
        <div class="div-table-col" style="width:45px;"><a href="javascript:void(0)"onclick="generate_Date('start')">Today</a> </div>
        <div id="incTime" class="div-table-col" >
       <a href="javascript:void(0)"onclick="hide_display_time()">Include Time</a></div>
      </div>
      
    <!-- TIME START HERE -->
    
     <div  class="div-table-row" id="hours_minutes_sec_row2" style="display:none;">  
      <div id="hoursId" class="div-table-col drop-down-menu" style="width:70px; margin-top:10px; " >Hours: </div>
      <div id="minutesId" class="div-table-col  drop-down-menu" style="width:70px;margin-top:10px;" >Minutes: </div>
      
       <div  id="seconds"class="div-table-col drop-down-menu" style="width:80px;margin-top:10px;">Seconds: </div>    
      
      </div>
      
      
      
      <!-- TEXTBOX TIME STARTS HERE -->
      
      <div  class="div-table-row" id="hours_minutes_sec_row_txt2" style="display:none;" >   
      <div id="hrsId" class="div-table-col  drop-down-menu" style="width:55px; "  >
     
  <input id="txtHrs" type="text" class="form-control" name="txtHrs"   value="{{ old('txtHrs') }}" required autofocus autocomplete="off" style=" text-align:left; width:50px;" onclick="txtHrsPopUp()" placeholder="00" >  
  </div>
   <div id="mntId" class="drop-down-menu div-table-col" style="width:5px; font-weight:bold; line-height:40px; " > /</div>
   
   
      <div id="minId" class="drop-down-menu div-table-col" style="width:55px; " >
      <!-- <span class="custom-select" style="width:100%; height:auto;">-->
   <input id="txtMnt" type="text" class="form-control" name="txtMnt"   value="{{ old('txtMnt') }}" required autofocus autocomplete="off" style=" text-align:left; width:50px;" onclick="txtMntPopUp()" placeholder="00" >
  </div>  
  
  <div id="secIds" class="drop-down-menu div-table-col" style="width:5px; font-weight:bold; line-height:40px;" > /</div>
  
  <div id="secId" class="div-table-col  drop-down-menu" style="width:80px;">
      <!-- <span class="custom-select" style="width:100%; height:auto;">-->  
   <input id="txtSec" type="text" class="form-control" name="txtSec"   value="{{ old('txtSec') }}" required autofocus autocomplete="off" style=" text-align:left; width:80px;" onclick="txtSecPopUp()" placeholder="00" >
       ...
       <div id='tm_now' class="div-table-row" style="display:none;">  
       
        <div class="div-table-col" ><a href="javascript:void(0)"onclick=" generate_Time_Start()">Now</a><span style="color: #D2D2D2;"> &nbsp;| &nbsp;</span><a href="javascript:void(0)"onclick="generate_Time_noon_Start()">Noon</a></div>
      </div>
 <!-- END OF TIME TEXT -->  
...
<!-- END DATE -->
  ...
  <div class="modal-contents">
    <div class="modal-header">
    <h4> <span class="header-title">End Date</span></h4>
...
<div class="title-head">Month </div>
<input  class="button-white" id="but1" name="but1" type="button" value="01 - Jan"   onclick="updateTime_full('01',5)"/>

 

<input  class="button-white" id="but2" name="but2" type="button" value="02 - Feb"   onclick="updateTime_full('02',5)"/>
<input  class="button-white" id="but3" name="but3" type="button" value="03 - Mar"   onclick="updateTime_full('03',5)"/>
<input  class="button-white" id="but4" name="but4" type="button" value="04 - Apr"   onclick="updateTime_full('04',5)"/>
<input  class="button-white" id="but5" name="but5" type="button" value="05 - May"   onclick="updateTime_full('05',5)"/>
<input  class="button-white" id="but6" name="but6" type="button" value="06 - Jun"   onclick="updateTime_full('06',5)"/>
<input  class="button-white" id="but7" name="but7" type="button" value="07 - Jul"   onclick="updateTime_full('07',5)"/>
<input  class="button-white" id="but8" name="but8" type="button" value="08 - Aug"   onclick="updateTime_full('08',5)"/>
<input  class="button-white" id="but9" name="but9" type="button" value="09 - Sep"   onclick="updateTime_full('09',5)"/>
<input  class="button-white" id="but10" name="but10" type="button" value="10 - Oct"   onclick="updateTime_full(10,5)"/>
<input  class="button-white" id="but11" name="but11" type="button" value="11 - Nov"   onclick="updateTime_full(11,5)"/>
<input  class="button-white" id="but12" name="but12" type="button" value="12 - Dec"   onclick="updateTime_full(12,5)"/>
...
<div id="popup_hour3"  class="popupDate  popup_month_year"  style="display:none;">
<div class="title-head"  >AM </div>
<input  class="button-white" id="buts1" name="but1" type="button" value="1:00 AM - 01"   onclick="updateTime_full(1,10)"/>

<input  class="button-white" id="buts2" name="but2" type="button" value="2:00 AM - 02"   onclick="updateTime_full(2,10)"/>
<input  class="button-white" id="buts3" name="but3" type="button" value="3:00 AM - 03"   onclick="updateTime_full(3,10)"/>
<input  class="button-white" id="buts4" name="but4" type="button" value="4:00 AM - 04"   onclick="updateTime_full(4,10)"/>
<input  class="button-white" id="buts5" name="but5" type="button" value="5:00 AM - 05"   onclick="updateTime_full(5,10)"/>
<input  class="button-white" id="buts6" name="but6" type="button" value="6:00 AM - 06"   onclick="updateTime_full(6,10)"/>
<input  class="button-white" id="buts7" name="but7" type="button" value="7:00 AM - 07"   onclick="updateTime_full(7,10)"/>
<input  class="button-white" id="buts8" name="but8" type="button" value="8:00 AM - 08"   onclick="updateTime_full(8,10)"/>
<input  class="button-white" id="but9" name="but9" type="button" value="9:00 AM - 09"   onclick="updateTime_full(9,10)"/>
<input  class="button-white" id="buts10" name="but10" type="button" value="10:00 AM - 10"   onclick="updateTime_full(10,10)"/>
<input  class="button-white" id="buts11" name="but11" type="button" value="11:00 AM - 11"   onclick="updateTime_full(11,10)"/>
<input  class="button-white" id="buts12" name="but12" type="button" value="12:00 AM - 12"   onclick="updateTime_full(12,10)"/>

 

<div class="title-head">PM </div>

<input  class="button-white" id="but1" name="but1" type="button" value="1:00 PM - 13"   onclick="updateTime_full(13,10)"/>

<input  class="button-white" id="but2" name="but2" type="button" value="2:00 PM - 14"   onclick="updateTime_full(14,10)"/>
<input  class="button-white" id="but3" name="but3" type="button" value="3:00 PM - 15"   onclick="updateTime_full(15,10)"/>
<input  class="button-white" id="but4" name="but4" type="button" value="4:00 PM - 16"   onclick="updateTime_full(16,10)"/>
<input  class="button-white" id="but5" name="but5" type="button" value="5:00 PM - 17"   onclick="updateTime_full(17,10)"/>
<input  class="button-white" id="but6" name="but6" type="button" value="6:00 PM - 18"   onclick="updateTime_full(18,10)"/>
<input  class="button-white" id="but7" name="but7" type="button" value="7:00 PM - 19"   onclick="updateTime_full(19,10)"/>
<input  class="button-white" id="but8" name="but8" type="button" value="8:00 PM - 20"   onclick="updateTime_full(20,10)"/>
<input  class="button-white" id="but9" name="but9" type="button" value="9:00 PM - 21"   onclick="updateTime_full(21,10)"/>
<input  class="button-white" id="but10" name="but10" type="button" value="10:00 PM - 22"   onclick="updateTime_full(22,10)"/>
<input  class="button-white" id="but11" name="but11" type="button" value="11:00 PM - 23"   onclick="updateTime_full(23,10)"/>
<input  class="button-white" id="but12" name="but12" type="button" value="12:00 PM - 00"   onclick="updateTime_full(00,10)"/>
</div>
...
<div id="popup_mnt1"  class="popupDate popup_month_year" style="display:none;"  >
<div class="title-head"  >Minutes </div>

</div>

<div id="popup_sec1"  class="popupDate popup_month_year" style="display:none;"  >
<div class="title-head"  >Seconds </div>
...
<div id="popup_hour_list1"  class=" popupDate" style="display:none;"> 
      ...
      <div id="minutesId" class="div-table-col  drop-down-menu" style="width:70px;" >Month: </div>
       ...
       <div  id="seconds"class="div-table-col drop-down-menu" style="width:80px;">Year: </div>
       <div  id="seconds"class="div-table-col drop-down-menu" style="width:40px;margin-top:10px;">Date: </div>
      </div>
  ...
  <input id="txtEndDay" type="text" class="form-control" name="txtEndDay"   value="{{ old('txtEndDay') }}" required autofocus autocomplete="off" style=" text-align:left; width:50px;" onclick="txtTimeEndPopUp()"placeholder="dd" >  
  </div>
   <div id="minutesId" class="drop-down-menu div-table-col" style="width:5px; font-weight:bold; line-height:40px;" > /</div>
      ...
      <div id="minutesId" class="drop-down-menu div-table-col" style="width:55px;" >
      <!-- <span class="custom-select" style="width:100%; height:auto;">-->
   <input id="txtEndMonth" type="text" class="form-control" name="txtEndMonth"   value="{{ old('txtEndMonth') }}" required autofocus autocomplete="off" style=" text-align:left; width:50px;" onclick="txtMonthEndPopUp()" placeholder="mm" >
  </div>  
  ...
  <div id="seconds" class="div-table-col  drop-down-menu" style="width:80px;">
      <!-- <span class="custom-select" style="width:100%; height:auto;">-->  
   <input id="txtEndYear" type="text" class="form-control" name="txtEndYear"   value="{{ old('txtEndYear') }}" required autofocus autocomplete="off" style=" text-align:left; width:80px;" onclick="txtYearEndPopUp()" placeholder="yyyy" >
  </div>
  
  
  <div id="picker_main1"   > 
  <div id="picker1" class="div-table-col" style="width:40px; margin-top:5px;"  >
<button  id="toggle2" onclick="callDatePicker(2)" class="button-image" ><i class='fas fa-calendar-alt' ></i></button>  </div>
   </div>  
     ...
     <div class="div-table-row">  
      <div class="div-table-col"><a href="javascript:void(0)"onclick="generate_Date('end')">Today</a> </div>
     ...
     <div class="div-table-row" id="hours_minutes_sec_row1" style="display:none;">  
      <div id="hoursId" class="div-table-col drop-down-menu" style="width:70px; margin-top:10px; " >Hours: </div>
      <div id="minutesId" class="div-table-col  drop-down-menu" style="width:70px;margin-top:10px;" >Minutes: </div>
      ...
      <div class="div-table-row" id="hours_minutes_sec_row_txt1" style="display:none;" >   
      <div id="hrsId1" class="div-table-col  drop-down-menu" style="width:55px; "  >
     
  <input id="txtHrs1" type="text" class="form-control" name="txtHrs1"   value="{{ old('txtHrs1') }}" required autofocus autocomplete="off" style=" text-align:left; width:50px;" onclick="txtHrs1EndPopUp()" placeholder="00" >  
  </div>
   <div id="mntId" class="drop-down-menu div-table-col" style="width:5px; font-weight:bold; line-height:40px; " > /</div>
   
   
      <div id="minId1" class="drop-down-menu div-table-col" style="width:55px; " >
      <!-- <span class="custom-select" style="width:100%; height:auto;">-->
   <input id="txtMnt1" type="text" class="form-control" name="txtMnt1"   value="{{ old('txtMnt1') }}" required autofocus autocomplete="off" style=" text-align:left; width:50px;" onclick="txtMnt1EndPopUp()" placeholder="00" >
  </div>  
  
  <div id="secIds1" class="drop-down-menu div-table-col" style="width:5px; font-weight:bold; line-height:40px;" > /</div>
  
  <div id="secId1" class="div-table-col  drop-down-menu" style="width:80px;">
      <!-- <span class="custom-select" style="width:100%; height:auto;">-->  
   <input id="txtSec1" type="text" class="form-control" name="txtSec1"   value="{{ old('txtSec1') }}" required autofocus autocomplete="off" style=" text-align:left; width:80px;" onclick="txtSec1EndPopUp()" placeholder="00" >
   
   
  </div>   </div> 
      
      
    <div id="tm_now1" class="div-table-row" style="display:none;">  
       
       <div class="div-table-col" ><a href="javascript:void(0)"onclick="generate_Time_End()">Now</a><span style="color: #D2D2D2;"> &nbsp;| &nbsp;</span><a href="javascript:void(0)"onclick="generate_Time_noon_End()">Noon</a></div>
      </div>
      </div>
 <!-- END OF TIME TEXT -->  
...
<div id="CheckedId" class="mainbody" style="text-align:center;" >
...
<label class="container" >
  ...
  <span class="checkmark5"></span>
                ...
                <div class="timeBut" style="margin-top:4px;">
 ...
 <div id="swap" style="margin-top:10px; text-align:left; margin-left:40px; background:#E1F9DF; display:none;" class="mainbody" > </div>
...
<div id="main4" class="card mb-5 mainDiv" style="margin-top:-28px;display:inline-block; min-width:88%;" >
...
<div id="main3" class="mainDiv2 card mb-5 mainbody" style="margin-top:-28px; display:inline-block; min-width:88%;" >
 <div  id="title-head1" class="title-head">Blog </div>
 <br />
 
 
  @foreach($query as $rst)
@if(trim($rst->menu) ==  "Count Days")
