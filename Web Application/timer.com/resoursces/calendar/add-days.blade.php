...
function generateYearNumber()
 ...
 function count_days()
 {
  ...
  //var startDates =start_Date.toString();
	...
	if(choiceOpt=='Add')
	{
		...
		var st=stYear+"/"+stMonth+"/"+stDay +" "+h +":"+m+":"+s;
		  ...
		  //console.log('start_Date '+start_Date)
		   ...
		   start_Date.setDate(start_Date.getDate()+enDay);
    start_Date.setMonth(start_Date.getMonth()+enMonth);
   
    start_Date.setFullYear(start_Date.getFullYear()+enYear);
   
    
    if(checkTime==1)
		   {
		   		start_Date.setHours(start_Date.getHours()+txt_Hours1);
		   
		     	start_Date.setMinutes(start_Date.getMinutes()+txt_Minutes1);
			    start_Date.setSeconds(start_Date.getSeconds()+txt_Seconds1);
  	 ...
  	 //console.log('After start_Date '+start_Date);
	 
		  startDates =start_Date.toString();
		...
		var va=(start_Date.getTime())-(now.getTime())
		 ...
		 //console.log('Days '+days); */
		   //start_Date.setDate(start_Date.getDate()+daysDal);
   ...
   //console.log('Before start_Date '+start_Date);
		...
		// console.log('New Start Date: '+daysDal);
		...
		//console.log('Start day '+start_Date.toString());
  ...
  if(choiceOpt=='Add' && checkTime!=1)
	{
   
 var rst ="From <span style='font-weight:bold;'>"+ frmDate.toString().substr(0,15)+"</span><br> <span class='mainbody'> Added "+ enYear+" years,  "+ enMonth+" month, "+ en_weerk+" weeks and "+ enDay2+" days</span><br><br>"
 ...
 var rst ="From <span style='font-weight:bold;'>"+ frmDate.toString().substr(0,15)+"</span><br> <span class='mainbody'> Added "+ enYear+" years,  "+ enMonth+" month, "+ en_weerk+" weeks and "+ enDay2+" days\n Hours " +txt_Hours1 +", Minutes " +txt_Minutes1 +", Seconds " +txt_Seconds1 +"</span><br><br>"
  
  //added 9 year, 12 months, 10 weeks and 72 days
  
  //Result: Thursday, 13 November 2029.
 rst+=" <span style='font-weight:bold;'>Result: "+ total_date.toString().substr(0,15)+" Time "+  total_date.toString().substr(15,9) +"  </span>"
   ...
   if(choiceOpt=='Subtract' && checkTime!=1)
	{
		
   
 var rst ="From <span style='font-weight:bold;'>"+ frmDate.toString().substr(0,15)+"</span><br> <span class='mainbody'> Subtracted "+ enYear+" years,  "+ enMonth+" month, "+ en_weerk+" weeks and "+ enDay2+" days</span><br><br>"
 ...
 var rst ="From <span style='font-weight:bold;'>"+ frmDate.toString().substr(0,15)+"</span><br> <span class='mainbody'> Subtracted "+ enYear+" years,  "+ enMonth+" month, "+ en_weerk+" weeks and "+ enDay2+" days\n Hours " +txt_Hours1 +", Minutes " +txt_Minutes1 +", Seconds " +txt_Seconds1 +"</span><br><br>"
...
<!-- END OF RIGHT MENU  -->
 ...
 <a href="./timer-reading"><i class='material-icons' ><span style=" font-size:17px;">av_timer</span></i>&nbsp;&nbsp;Timer</a> 
  ...
  <a class="active" href="./add-date"> <i class='fas fa-calendar-alt'></i> &nbsp;&nbsp;Day Calculator</a>
...
<div id="main" class="card mb-5 mainDiv"  style="display:inline-block; min-width:88%; "  >
 ...
 <a class="active" href="./add-date"> <i class='fas fa-calendar-alt active ' style="font-size:20px;"></i> <br /><span class="active"> Day Calculator</span></a>
...
<div id="setUp" style="font-size:27px; color:#C1C1C1; padding-bottom:10px;" >Day Calculator  </div>
...
<div id="popup_hour_list"  class=" popupDate" style="display:none;" > 
  ...
  <div id="picker_main" class='cal-date'> 
...
<button  id="toggle" onclick="callDatePicker(1)" class="button-image" ><i class='fas fa-calendar-alt' ></i></button>  </div>
  ...
  <input id="txtPicker" type="hidden" class="form-control" name="txtPicker"   value="{{ old('txtPicker') }}" required autofocus autocomplete="off" style=" text-align:left; width:130px;"  placeholder="picker" >
      ...
      <div id="picker_main2" class='cal-date'> 
      </div>
...
<!-- END DATE -->
 ...
 <div id="week_txtAddHead" class="modal-contents week-text-add" style="width:100px; border:none;">
...
<div class="title-head"  >Hour </div>
<input  class="button-white" id="buts1" name="but1" type="button" value="1"   onclick="updateTime_full(1,10)"/>

<input  class="button-white" id="buts2" name="but2" type="button" value="2"   onclick="updateTime_full(2,10)"/>
<input  class="button-white" id="buts3" name="but3" type="button" value="3"   onclick="updateTime_full(3,10)"/>
<input  class="button-white" id="buts4" name="but4" type="button" value="4"   onclick="updateTime_full(4,10)"/>
<input  class="button-white" id="buts5" name="but5" type="button" value="5"   onclick="updateTime_full(5,10)"/>
<input  class="button-white" id="buts6" name="but6" type="button" value="6"   onclick="updateTime_full(6,10)"/>
<input  class="button-white" id="buts7" name="but7" type="button" value="7"   onclick="updateTime_full(7,10)"/>
<input  class="button-white" id="buts8" name="but8" type="button" value="8"   onclick="updateTime_full(8,10)"/>
<input  class="button-white" id="but9" name="but9" type="button" value="9"   onclick="updateTime_full(9,10)"/>
<input  class="button-white" id="buts10" name="but10" type="button" value="10"   onclick="updateTime_full(10,10)"/>
<input  class="button-white" id="buts11" name="but11" type="button" value="11"   onclick="updateTime_full(11,10)"/>
<input  class="button-white" id="buts12" name="but12" type="button" value="12"   onclick="updateTime_full(12,10)"/>

 

 
<input  class="button-white" id="but1" name="but1" type="button" value="13"   onclick="updateTime_full(13,10)"/>

<input  class="button-white" id="but2" name="but2" type="button" value="14"   onclick="updateTime_full(14,10)"/>
<input  class="button-white" id="but3" name="but3" type="button" value="15"   onclick="updateTime_full(15,10)"/>
<input  class="button-white" id="but4" name="but4" type="button" value="16"   onclick="updateTime_full(16,10)"/>
<input  class="button-white" id="but5" name="but5" type="button" value="17"   onclick="updateTime_full(17,10)"/>
<input  class="button-white" id="but6" name="but6" type="button" value="18"   onclick="updateTime_full(18,10)"/>
<input  class="button-white" id="but7" name="but7" type="button" value="19"   onclick="updateTime_full(19,10)"/>
<input  class="button-white" id="but8" name="but8" type="button" value="20"   onclick="updateTime_full(20,10)"/>
<input  class="button-white" id="but9" name="but9" type="button" value="21"   onclick="updateTime_full(21,10)"/>
<input  class="button-white" id="but10" name="but10" type="button" value="22"   onclick="updateTime_full(22,10)"/>
<input  class="button-white" id="but11" name="but11" type="button" value="23"   onclick="updateTime_full(23,10)"/>
<input  class="button-white" id="but12" name="but12" type="button" value="24"   onclick="updateTime_full(24,10)"/>
</div>
