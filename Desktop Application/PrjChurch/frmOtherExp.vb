...
Public Class frmOtherExp

    Private Sub frmOtherExp_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Left = 0
        Me.Top = 100
        Me.Width = 616
        Me.Height = 211
    ...
    Private Sub butEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butEdit.Click
        Try
            ...
            sqlString = "INSERT INTO  Expenses(dpaydate,vYear,vMonth,vUser,vName,vdescrib,mAmount) VALUES(" & _
            "'" & dateapp & "'," & _
             "'" & dYear & "'," & _
              "'" & dMonth1 & "'," & _
            "'" & UserN & "'," & _
            ...
            sqlString = "UPDATE  [acct] SET " & _
              "[mOtherExp] = [mOtherExp] + " & Me.TextBox1.Text & " "
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Try
            ...
            Dim dts1 As Integer
            Call conns()
            str_sql_user_select = "select max(id )AS  [Studentid] from Expenses  "
            ' comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
            'myreader = comUserSelect.ExecuteReader()
            ...
            Call conns()
            str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM   Expenses  where  vName= '" & TextBox3.Text.Trim & "'  and  id =" & dts1 & "  "
            ' comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
            'myreader = comUserSelect.ExecuteReader()
            comUserSelectS = New OleDbCommand(str_sql_user_select, strconss)
            myAccessReader = comUserSelectS.ExecuteReader()
            ...
            If numbs_pay = 0 Then
                ...
                str_sql_user_select = "SELECT *  FROM Expenses WHERE vName ='" & TextBox3.Text.Trim & "'  and    id =" & dts1 & "  "
            ...
            If TextBox1.Text <> "" And TextBox2.Text <> "" Then
                e.Graphics.DrawString("OTHER EXPENSES PAYMENT DETAILS.", headfont, Brushes.Black, X1 + 70, Y + 70)
                ...
                For Each i As String In Me.ListItems.Items(itm).ToString
                    ...
                    While myAccessReader.Read
                        ...
                        e.Graphics.DrawString("OTHER EXPENSES : ", tablefont, Brushes.Black, X1 + 280, Y + 110)
