...
Public Class frmCommentRP

    Private Sub frmCommentRP_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Left = 0
            Me.Top = 100
            Me.Width = 582
            ...
            Call conns()
            str_sql_user_select = " SELECT COUNT(dpaydate)AS [RecordCount]  FROM Comment"
            ...
            If rows <> 0 Then
                ...
                str_sql_user_select = " SELECT DISTINCT(trim(vYear))AS [RecordCount]  FROM Comment"
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Try
            ...
            If ComboBox1.Text <> "" And ComboBox2.Text = "" Then
                ...
                Call conns()
                str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM   Comment where vYear= '" & ComboBox1.Text & "'   "
                ...
                If numbs_pay = 0 Then
                    ...
                    str_sql_user_select = "SELECT *  FROM Comment  where vYear= '" & ComboBox1.Text & "'   "
            ...
            If ComboBox1.Text <> "" And ComboBox2.Text <> "" Then
                ...
                Call conns()
                str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM   Comment where vYear= '" & ComboBox1.Text & "'   and vMonth ='" & ComboBox2.Text & "' "
                'comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
                'myreader = comUserSelect.ExecuteReader()
                ...
                If numbs_pay = 0 Then
                    ...
                    Me.ListItems.Items.Clear()
                    str_sql_user_select = "SELECT *  FROM Comment  where vYear= '" & ComboBox1.Text & "'   and vMonth ='" & ComboBox2.Text & "' "
            ...
            If ComboBox1.Text <> "" And ComboBox2.Text = "" Then
                e.Graphics.DrawString("YEARLY COMMENT  DETAILS", headfont, Brushes.Black, X1 + 50, Y + 70)

                e.Graphics.DrawString("COMMENT: ", tablefont, Brushes.Black, CInt(X1) + 40, CInt(Y) + 110)

                e.Graphics.DrawString("USER NAME: ", tablefont, Brushes.Black, CInt(X1) + 410, CInt(Y) + 110)

                e.Graphics.DrawString("DATE: ", tablefont, Brushes.Black, CInt(X1) + 500, CInt(Y) + 110)


                e.Graphics.DrawString("AMOUNT: ", tablefont, Brushes.Black, CInt(X1) + 570, CInt(Y) + 110)
                ...
                For Each i As String In Me.ListItems.Items(itm).ToString
                    ...
                    While myAccessReader.Read
                        ...
                        e.Graphics.DrawString(myAccessReader("vdescrib"), titlefont, Brushes.Black, CInt(X1) + 40, CInt(Y) + 130)



                        e.Graphics.DrawString(myAccessReader("vUser"), titlefont, Brushes.Black, CInt(X1) + 420, CInt(Y) + 130)


                        e.Graphics.DrawString(myAccessReader("dpaydate"), titlefont, Brushes.Black, CInt(X1) + 500, CInt(Y) + 130)


                        e.Graphics.DrawString(myAccessReader("mAmount"), titlefont, Brushes.Black, CInt(X1) + 575, CInt(Y) + 130)
                ...
                e.Graphics.DrawString(salsum, titlefont, Brushes.Black, CInt(X1) + 575, CInt(Y) + 140)
                e.Graphics.DrawString("---------------", titlefont, Brushes.Black, CInt(X1) + 560, CInt(Y) + 150)
            End If
            ...
            If ComboBox1.Text <> "" And ComboBox2.Text <> "" Then
                e.Graphics.DrawString("MONTHLY COMMENT  DETAILS", headfont, Brushes.Black, X1 + 50, Y + 70)
                ...
                For Each i As String In Me.ListItems.Items(itm).ToString
                    ...
                    str_sql_user_select = "SELECT  dpaydate ,vdescrib ,mAmount,vUser  FROM Comment where vYear= '" & ComboBox1.Text & "'   and dpaydate = '" & studentid & "'"
        ...
        Try
            ...
            If Choices = vbYes Then
                ...
                If ComboBox2.Text <> "" Then
                    ...
                    str_sql_user_select = "SELECT  SUM(mAmount)AS [SALARY]FROM Comment WHERE vMonth='" & ComboBox2.Text & "' "
                ...
                If ComboBox1.Text <> "" And ComboBox1.Text <> "" Then
                    ...
                    str_sql_user_select = "SELECT  SUM(mAmount)AS [SALARY]FROM Comment WHERE vYear='" & ComboBox1.Text & "'"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            If ComboBox2.Text <> "" And ComboBox1.Text <> "" Then
                ...
                str_sql_user_select = "SELECT  SUM(mAmount)AS [SALARY]FROM Comment WHERE vMonth='" & ComboBox2.Text & "' and  vYear='" & ComboBox1.Text & "'"
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        Try
            ...
            Call conns()
            str_sql_user_select = " SELECT count(dpaydate)AS [RecordCount]  FROM Comment where vYear= '" & ComboBox1.Text & "' "
            ...
            If rows <> 0 Then
                ...
                While myAccessReader.Read()
                    ...
                    dtptEdit.Rows(ro).Cells(3).Value = (myAccessReader("dpaydate"))
                    'dtptEdit.Rows(ro).Cells(4).Value = myAccessReader("vName")


                    dtptEdit.Rows(ro).Cells(4).Value = myAccessReader("vUser")
                    'dtptEdit.Rows(ro).Cells(5).Value = myAccessReader("vUser")
                ...
                str_sql_user_select = " SELECT DISTINCT(trim(vMonth))AS [RecordCount]  FROM Comment where vYear ='" & ComboBox1.Text & " '"
    ...
    Private Sub ComboBox2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox2.SelectedIndexChanged
        Try
            ...
            Call conns()
            str_sql_user_select = " SELECT Count(dpaydate)AS [RecordCount]  FROM Comment where vYear= '" & ComboBox1.Text & "' and vMonth ='" & ComboBox2.Text & "'"
    ...
    Private Sub dtptEdit_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dtptEdit.DoubleClick
        code = dtptEdit.CurrentRow.Cells(0).Value()
    End Sub

    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Try
            Dim Choice As String
            Choice = MsgBox("Are you sure you want to Delete Comment?", vbYesNo + vbInformation, "Delete")
            If Choice = vbYes Then
                Call conns()
                str_sql_user_select = "Delete from [Comment] where id=" & code & ""
