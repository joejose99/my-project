...
Public Class frmChildren
    ...
    Private Sub StartForm()
        Try
            Call conns()
            Dim ro As Integer
            str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM  [Church]where vAdultChild ='" & Children & "'  "
            ...
            If rows <> 0 Then
                ...
                Call conns()
                ro = 0
                str_sql_user_select = "SELECT * FROM Church where vAdultChild ='" & Children & "' "
    ...
    Private Sub gTchurch()
        ...
        End Try
    End Sub
    Private Sub frmChildren_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If rows <> 0 Then
                ...
                str_sql_user_select = "SELECT DISTINCT(vState)AS [RecordYear]  FROM Church where vAdultChild ='" & Children & "' "
                ...
                str_sql_user_select = "SELECT DISTINCT(vProfesion)AS [RecordYear]  FROM Church  where vAdultChild ='" & Children & "' "
                ...
                str_sql_user_select = "SELECT  DISTINCT(vLocation)AS [RecordYear]FROM Church  where vAdultChild ='" & Children & "' "
    ...
    Private Sub QueryClass()
        Try
            Call conns()
            Dim ro As Integer
            str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM  [Church]  where vLocation ='" & ComboBox3.Text & "' and vBus_Stop ='" & TextBox1.Text & "' and vAdultChild ='" & Children & "' "
            'str_sql_user_select = "SELECT * FROM Salary where vEmpid= '" & Trim(TextBox16.Text) & "" & "'"
            Dim rows As Integer
            Dim rowme As String = ""
            'comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
            ...
            If rows <> 0 Then
                ...
                Call conns()
                ro = 0
                str_sql_user_select = "SELECT * FROM Church where vLocation ='" & ComboBox3.Text & "' and vBus_Stop ='" & TextBox1.Text & "'and vAdultChild ='" & Children & "' "
    ...
    Private Sub ComboBox2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox2.SelectedIndexChanged
        Try
            Call conns()
            Dim ro As Integer
            str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM  [Church]  where vProfesion ='" & ComboBox2.Text & "'and vAdultChild ='" & Children & "'  "
            'str_sql_user_select = "SELECT * FROM Salary where vEmpid= '" & Trim(TextBox16.Text) & "" & "'"
            Dim rows As Integer
            Dim rowme As String = ""
            'comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
            ...
            If rows <> 0 Then
                ...
                Call conns()
                ro = 0
                str_sql_user_select = "SELECT * FROM Church where vProfesion ='" & ComboBox2.Text & "' and vAdultChild ='" & Children & "' "
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        Try
            Call conns()
            Dim ro As Integer
            str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM  [Church]  where vState ='" & ComboBox1.Text & "' and  vAdultChild ='" & Children & "' "
            'str_sql_user_select = "SELECT * FROM Salary where vEmpid= '" & Trim(TextBox16.Text) & "" & "'"
            Dim rows As Integer
            Dim rowme As String = ""
            'comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
            ...
            If rows <> 0 Then
                ...
                Call conns()
                ro = 0
                str_sql_user_select = "SELECT * FROM Church where vState ='" & ComboBox1.Text & "' and vAdultChild ='" & Children & "' "
    ...
    Private Sub requery()
        ...
        Try
            Call conns()
            Dim ro As Integer
            str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM  [Church]  where vLocation ='" & ComboBox3.Text & "' and vAdultChild ='" & Children & "' "
            'str_sql_user_select = "SELECT * FROM Salary where vEmpid= '" & Trim(TextBox16.Text) & "" & "'"
            Dim rows As Integer
            Dim rowme As String = ""
            'comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
            ...
            If rows <> 0 Then
                ...
                Call conns()
                ro = 0
                str_sql_user_select = "SELECT * FROM Church where vLocation ='" & ComboBox3.Text & "' and vAdultChild ='" & Children & "' "
                ...
                TextBox1.Items.Clear()
                TextBox1.Text = ""
                str_sql_user_select = "SELECT DISTINCT(vBus_Stop)AS [RecordYear]  FROM Church where vLocation ='" & ComboBox3.Text & "' and vAdultChild ='" & Children & "' "
    ...
    Private Sub TextBox2_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextBox2.KeyUp
        ...
        Try
            ...
            If rows <> 0 Then
                ...
                Call conns()
                ro = 0
                str_sql_user_select = "SELECT * FROM Church where vSurname  like '" & TextBox2.Text & "%' and vAdultChild ='" & Children & "' "
    ...
    Private Sub TextBox3_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextBox3.KeyUp
        Try
            ...
            If rows <> 0 Then
                ...
                Call conns()
                ro = 0
                str_sql_user_select = "SELECT * FROM Church where vFName  like '" & TextBox3.Text & "%' and vAdultChild ='" & Children & "' "
    ...
    Private Sub butDel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butDel.Click
        Try
            ...
            If Choice = vbYes Then
                Call conns()
                str_sql_user_select = "Delete  [Church] where vMemberId='" & stid & "'"
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        Try
            ...
            If code = "" And TextBox1.Text = "" And ComboBox3.Text <> "" Then
                ...
                Call conns()
                str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM   Church where vLocation = '" & ComboBox3.Text.Trim & "'" & " and vAdultChild ='" & Children & "'"
                'comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
                'myreader = comUserSelect.ExecuteReader()
                comUserSelectS = New OleDbCommand(str_sql_user_select, strconss)
                myAccessReader = comUserSelectS.ExecuteReader()
                ...
                If numbs_pay = 0 Then
                    ...
                    str_sql_user_select = "SELECT *   FROM   Church where vLocation = '" & ComboBox3.Text.Trim & "'" & " and vAdultChild ='" & Children & "'"
            ...
            If code = "" And TextBox1.Text <> "" And ComboBox3.Text <> "" Then
                ...
                Call conns()
                str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM   Church where vLocation = '" & ComboBox3.Text.Trim & "'" & " and vBus_Stop ='" & TextBox1.Text & "' and vAdultChild ='" & Children & "'"
                'comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
                'myreader = comUserSelect.ExecuteReader()
                ...
                If numbs_pay = 0 Then
                    ...
                    Me.ListItems.Items.Clear()
                    str_sql_user_select = "SELECT *   FROM   Church where vLocation = '" & ComboBox3.Text.Trim & "'" & "and vBus_Stop ='" & TextBox1.Text & "' and vAdultChild ='" & Children & "'"
            ...
            If code = "" And TextBox1.Text = "" And ComboBox1.Text <> "" And ComboBox2.Text = "" And ComboBox3.Text = "" Then
                ...
                Call conns()
                str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM   Church where vState = '" & ComboBox1.Text.Trim & "'" & " and vAdultChild ='" & Children & "'"
                'comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
                'myreader = comUserSelect.ExecuteReader()
                ...
                If numbs_pay = 0 Then
                    ...
                    Me.ListItems.Items.Clear()
                    str_sql_user_select = "SELECT *   FROM   Church where vState = '" & ComboBox1.Text.Trim & "'" & " and vAdultChild ='" & Children & "'"
