...
Public Class frmCancelOffering

    Private Sub frmCancelOffering_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Left = 0
        Me.Top = 100
        Width = 599
        Height = 415
    ...
    Private Sub prYear()
        Try
            ...
            Call conns()
            str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM  [Offering]  "
            ...
            If rows <> 0 Then
                ...
                str_sql_user_select = "SELECT Distinct(vYear) AS [RecordYear] FROM Offering "
    ...
    Private Sub requery()
        Try
            ...
            Call conns()
            str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM  [Offering]  where dpaydate='" & dateapp & "'"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            If codes <> "" And amt <> 0 Then
                ...
                Choices = MsgBox("Are you sure you want to Cancel Offering Payment ?", vbYesNo + vbInformation, "Cancel")

                If Choices = vbYes Then
                    Call conns()
                    str_sql_user_select = "Delete  from [Offering] where  id=" & codes & ""
    ...
    Private Sub ComboBox4_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox4.SelectedIndexChanged
        Try
            ...
            Call conns()
            str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM  [Offering]  where vYear='" & ComboBox4.Text & "'"
            ...
            If rows <> 0 Then
                dtptEdit.Rows.Clear()
                Call conns()
                str_sql_user_select = "SELECT *  FROM Offering where vYear='" & ComboBox4.Text & "'"
                ...
                ComboBox5.Text = ""
                ComboBox5.Items.Clear()
                str_sql_user_select = "SELECT Distinct(vMonth) AS [RecordYear] FROM Offering where vYear= '" & ComboBox4.Text & "' "
    ...
    Private Sub ComboBox5_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox5.SelectedIndexChanged
        Try
            ...
            Call conns()
            str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM  [Offering]  where vYear='" & ComboBox4.Text & "' and vMonth ='" & ComboBox5.Text & "'"
            ...
            If rows <> 0 Then
                dtptEdit.Rows.Clear()
                Call conns()
                str_sql_user_select = "SELECT *  FROM Offering where vYear='" & ComboBox4.Text & "' and vMonth ='" & ComboBox5.Text & "'"
