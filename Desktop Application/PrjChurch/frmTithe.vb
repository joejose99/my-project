...
Public Class frmTithe
    ...
    Private Sub generateId()
        Try
            ...
            Call conns()
            str_sql_user_select = "SELECT COUNT(vMemberId) AS [RecordCount] FROM  [Tithe] where vAuto ='" & status & "'  "
            ...
            If rows <> 0 Then
                ...
                Dim maxId As String = ""
                Call conns()
                str_sql_user_select = "select max(id)AS  [Studentid] from Tithe where vAuto ='" & status & "'  "
                'comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
                'myreader = comUserSelect.ExecuteReader()
                ...
                Call conns()
                str_sql_user_select = "select  [dpaydate] from Tithe where vAuto ='" & status & "' and id =" & maxId & "  "
                'comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
                'myreader = comUserSelect.ExecuteReader()
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Try
            ...
            Dim dts1 As Integer
            Call conns()
            str_sql_user_select = "select max(id )AS  [Studentid] from Tithe  "
            ' comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
            'myreader = comUserSelect.ExecuteReader()
            ...
            Call conns()
            str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM   Tithe  where  vFName= '" & TextBox3.Text.Trim & "'  and  id =" & dts1 & "  "
            ' comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
            'myreader = comUserSelect.ExecuteReader()
            comUserSelectS = New OleDbCommand(str_sql_user_select, strconss)
            myAccessReader = comUserSelectS.ExecuteReader()
            ...
            If numbs_pay = 0 Then
                ...
                str_sql_user_select = "SELECT *  FROM Tithe WHERE vFName ='" & TextBox3.Text.Trim & "'  and    id =" & dts1 & "  "
            ...
            If TextBox1.Text <> "" And TextBox2.Text <> "" Then
                e.Graphics.DrawString(" TITHE PAYMENT DETAILS.", headfont, Brushes.Black, X1 + 70, Y + 70)
    ...
    Private Sub frmTithe_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Left = 0
        Me.Top = 100
    ...
    Private Sub butEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butEdit.Click
        Try
            ...
            Dim sqlString As String = ""
            sqlString = "INSERT INTO  Tithe(dpaydate,vYear,vMonth,vUser,vSurName,vFName,vMemberId,vdescrib,vAuto,mAmount) VALUES(" & _
            "'" & dateapp & "'," & _
             "'" & dYear & "'," & _
              "'" & dMonth1 & "'," & _
               "'" & UserN & "'," & _
            ...
            sqlString = "UPDATE  [acct] SET " & _
              "[mTithe] = [mTithe] + " & Me.TextBox1.Text & " "
