...
Public Class frmPledgeRp

    Private Sub frmPledgeRP_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Call conns()
            str_sql_user_select = " SELECT COUNT(dpaydate)AS [RecordCount]  FROM RedPledge"
            ...
            If rows <> 0 Then
                ...
                str_sql_user_select = " SELECT DISTINCT(trim(vYear))AS [RecordCount]  FROM RedPledge"
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Try
            ...
            If ComboBox1.Text <> "" And ComboBox2.Text = "" Then
                ...
                Call conns()
                str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM   RedPledge where vYear= '" & ComboBox1.Text & "'   "
                ...
                If numbs_pay = 0 Then
                    ...
                    str_sql_user_select = "SELECT *  FROM RedPledge  where vYear= '" & ComboBox1.Text & "'   "
            ...
            If ComboBox1.Text <> "" And ComboBox2.Text <> "" Then
                ...
                Call conns()
                str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM   RedPledge where vYear= '" & ComboBox1.Text & "'   and vMonth ='" & ComboBox2.Text & "' "
                'comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
                'myreader = comUserSelect.ExecuteReader()
                ...
                If numbs_pay = 0 Then
                    ...
                    Me.ListItems.Items.Clear()
                    str_sql_user_select = "SELECT *  FROM RedPledge  where vYear= '" & ComboBox1.Text & "'   and vMonth ='" & ComboBox2.Text & "' "
            ...
            If ComboBox1.Text <> "" And ComboBox2.Text = "" Then
                e.Graphics.DrawString("YEARLY REDEEM PLEDGE  DETAILS", headfont, Brushes.Black, X1 + 50, Y + 70)


                e.Graphics.DrawString("SURNAME: ", tablefont, Brushes.Black, CInt(X1) + 40, CInt(Y) + 110)

                e.Graphics.DrawString("FIRT NAME: ", tablefont, Brushes.Black, CInt(X1) + 200, CInt(Y) + 110)

                e.Graphics.DrawString("DATE: ", tablefont, Brushes.Black, CInt(X1) + 350, CInt(Y) + 110)
                ...
                For Each i As String In Me.ListItems.Items(itm).ToString
                    ...
                    str_sql_user_select = "SELECT  dpaydate ,vPurpose,vSurName,vFName ,mAmount  FROM RedPledge where vYear= '" & ComboBox1.Text & "'  "
                    ...
                    While myAccessReader.Read
                        ...
                        e.Graphics.DrawString(myAccessReader("vFName"), titlefont, Brushes.Black, CInt(X1) + 200, CInt(Y) + 130)


                        e.Graphics.DrawString(myAccessReader("dpaydate"), titlefont, Brushes.Black, CInt(X1) + 350, CInt(Y) + 130)
            ...
            If ComboBox1.Text <> "" And ComboBox2.Text <> "" Then
                e.Graphics.DrawString("MONTHLY REDEEM PLEDGE  DETAILS", headfont, Brushes.Black, X1 + 50, Y + 70)
                ...
                For Each i As String In Me.ListItems.Items(itm).ToString
                    ...
                    str_sql_user_select = "SELECT  dpaydate ,vPurpose,vSurName,vFName ,mAmount  FROM RedPledge where vYear= '" & ComboBox1.Text & "'   and dpaydate = '" & studentid & "'"
        ...
        Try
            ...
            If Choices = vbYes Then
                ...
                If ComboBox2.Text <> "" Then
                    ...
                    str_sql_user_select = "SELECT  SUM(mAmount)AS [SALARY]FROM RedPledge WHERE vMonth='" & ComboBox2.Text & "' "
                ...
                If ComboBox1.Text <> "" And ComboBox1.Text <> "" Then
                    ...
                    str_sql_user_select = "SELECT  SUM(mAmount)AS [SALARY]FROM RedPledge WHERE vYear='" & ComboBox1.Text & "'"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            If ComboBox2.Text <> "" And ComboBox1.Text <> "" Then
                ...
                str_sql_user_select = "SELECT  SUM(mAmount)AS [SALARY]FROM RedPledge WHERE vMonth='" & ComboBox2.Text & "' and  vYear='" & ComboBox1.Text & "'"
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        Try
            ...
            Call conns()
            str_sql_user_select = " SELECT count(dpaydate)AS [RecordCount]  FROM RedPledge where vYear= '" & ComboBox1.Text & "' "
            ...
            If rows <> 0 Then
                ...
                str_sql_user_select = " SELECT DISTINCT(trim(vMonth))AS [RecordCount]  FROM RedPledge where vYear ='" & ComboBox1.Text & " '"
    ...
    Private Sub ComboBox2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox2.SelectedIndexChanged
        Try
            ...
            Call conns()
            str_sql_user_select = " SELECT Count(dpaydate)AS [RecordCount]  FROM RedPledge where vYear= '" & ComboBox1.Text & "' and vMonth ='" & ComboBox2.Text & "'"
