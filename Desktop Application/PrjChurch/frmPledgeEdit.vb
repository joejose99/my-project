...
Public Class frmPledgeEdit
    ...
    Private Sub frmPledgeEdit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Left = 0
            Me.Top = 100
            Me.Width = 713
            ...
            Call conns()
            str_sql_user_select = " SELECT COUNT(dpaydate)AS [RecordCount]  FROM FinPledge"
            ...
            If rows <> 0 Then
                ...
                str_sql_user_select = " SELECT DISTINCT(trim(vYear))AS [RecordCount]  FROM FinPledge"
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Try
            ...
            If ComboBox1.Text <> "" And ComboBox2.Text = "" Then
                ...
                Call conns()
                str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM   FinPledge where vYear= '" & ComboBox1.Text & "'   "
                ...
                If numbs_pay = 0 Then
                    ...
                    str_sql_user_select = "SELECT *  FROM FinPledge  where vYear= '" & ComboBox1.Text & "'   "
            ...
            If ComboBox1.Text <> "" And ComboBox2.Text <> "" Then
                ...
                Call conns()
                str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM     FinPledge where vYear= '" & ComboBox1.Text & "'   and vMonth ='" & ComboBox2.Text & "' "
                'comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
                'myreader = comUserSelect.ExecuteReader()
                ...
                If numbs_pay = 0 Then
                    ...
                    Me.ListItems.Items.Clear()
                    str_sql_user_select = "SELECT *  FROM FinPledge  where vYear= '" & ComboBox1.Text & "'   and vMonth ='" & ComboBox2.Text & "' "
            ...
            If ComboBox1.Text <> "" And ComboBox2.Text = "" Then
                e.Graphics.DrawString("YEARLY FINANCIAL PLEDGE  DETAILS", headfont, Brushes.Black, X1 + 50, Y + 70)


                e.Graphics.DrawString("SURNAME: ", tablefont, Brushes.Black, CInt(X1) + 40, CInt(Y) + 110)

                e.Graphics.DrawString("FIRT NAME: ", tablefont, Brushes.Black, CInt(X1) + 150, CInt(Y) + 110)

                e.Graphics.DrawString("PHONE: ", tablefont, Brushes.Black, CInt(X1) + 280, CInt(Y) + 110)

                e.Graphics.DrawString("DATE: ", tablefont, Brushes.Black, CInt(X1) + 400, CInt(Y) + 110)


                e.Graphics.DrawString("AMOUNT: ", tablefont, Brushes.Black, CInt(X1) + 500, CInt(Y) + 110)
                ...
                For Each i As String In Me.ListItems.Items(itm).ToString
                    ...
                    str_sql_user_select = "SELECT vPhoneNo, dpaydate ,vPurpose,vSurName,vFName ,mAmount  FROM FinPledge where vYear= '" & ComboBox1.Text & "'  "
                    ...
                    While myAccessReader.Read
                        ...
                        e.Graphics.DrawString(myAccessReader("vSurName"), titlefont, Brushes.Black, CInt(X1) + 40, CInt(Y) + 130)



                        e.Graphics.DrawString(myAccessReader("vFName"), titlefont, Brushes.Black, CInt(X1) + 150, CInt(Y) + 130)

                        e.Graphics.DrawString(myAccessReader("vPhoneNo"), titlefont, Brushes.Black, CInt(X1) + 280, CInt(Y) + 130)


                        e.Graphics.DrawString(myAccessReader("dpaydate"), titlefont, Brushes.Black, CInt(X1) + 400, CInt(Y) + 130)


                        e.Graphics.DrawString(myAccessReader("mAmount"), titlefont, Brushes.Black, CInt(X1) + 510, CInt(Y) + 130)
                ...
                e.Graphics.DrawString("GROUND TOTAL : ", tablefont, Brushes.Black, CInt(X1) + 300, CInt(Y) + 140)
                e.Graphics.DrawString(salsum, titlefont, Brushes.Black, CInt(X1) + 510, CInt(Y) + 140)
                e.Graphics.DrawString("---------------", titlefont, Brushes.Black, CInt(X1) + 500, CInt(Y) + 150)
            End If
            ...
            If ComboBox1.Text <> "" And ComboBox2.Text <> "" Then
                e.Graphics.DrawString("MONTHLY FINANCIAL PLEDGE  DETAILS", headfont, Brushes.Black, X1 + 50, Y + 70)
                ...
                For Each i As String In Me.ListItems.Items(itm).ToString
                    ...
                    str_sql_user_select = "SELECT  dpaydate ,vPurpose,vSurName,vFName,vPhoneNo ,mAmount  FROM FinPledge where vYear= '" & ComboBox1.Text & "'   and dpaydate = '" & studentid & "'"
                ...
                e.Graphics.DrawString(salsum1, titlefont, Brushes.Black, CInt(X1) + 510, CInt(Y) + 140)
        ...
        Try
            ...
            If Choices = vbYes Then
                ...
                If ComboBox2.Text <> "" Then
                    ...
                    str_sql_user_select = "SELECT  SUM(mAmount)AS [SALARY]FROM FinPledge WHERE vMonth='" & ComboBox2.Text & "' "
                ...
                If ComboBox1.Text <> "" And ComboBox1.Text <> "" Then
                    ...
                    str_sql_user_select = "SELECT  SUM(mAmount)AS [SALARY]FROM FinPledge WHERE vYear='" & ComboBox1.Text & "'"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            If ComboBox2.Text <> "" And ComboBox1.Text <> "" Then
                ...
                str_sql_user_select = "SELECT  SUM(mAmount)AS [SALARY]FROM FinPledge WHERE vMonth='" & ComboBox2.Text & "' and  vYear='" & ComboBox1.Text & "'"
    ...
    Private Sub querrydel()
        Try
            ...
            If rows <> 0 Then
                ...
                str_sql_user_select = "SELECT *  FROM FinPledge    "
                ...
                While myAccessReader.Read()
                    ...
                    dtptEdit.Rows(ro).Cells(3).Value = (myAccessReader("vPhoneNo"))

                    dtptEdit.Rows(ro).Cells(4).Value = (myAccessReader("mAmount"))
                    'dtptEdit.Rows(ro).Cells(4).Value = myAccessReader("vName")
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        Try
            ...
            Call conns()
            str_sql_user_select = " SELECT count(dpaydate)AS [RecordCount]  FROM FinPledge where vYear= '" & ComboBox1.Text & "' "
            ...
            If rows <> 0 Then
                ...
                str_sql_user_select = " SELECT DISTINCT(trim(vMonth))AS [RecordCount]  FROM   FinPledge where vYear ='" & ComboBox1.Text & " '"
    ...
    Private Sub ComboBox2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox2.SelectedIndexChanged
        Try
            ...
            Call conns()
            str_sql_user_select = " SELECT Count(dpaydate)AS [RecordCount]  FROM FinPledge where vYear= '" & ComboBox1.Text & "' and vMonth ='" & ComboBox2.Text & "'"
    ...
    Private Sub dtptEdit_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dtptEdit.CellDoubleClick
        id = dtptEdit.CurrentRow.Cells(0).Value()
    End Sub
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Try
            ...
            If id = "" Then
                MsgBox("Double Click the Content to Delete", MsgBoxStyle.Information, "Information")
                Exit Sub
            End If

            Choice = MsgBox("Are you sure you want to Delete Pledge?", vbYesNo + vbInformation, "Delete")
            If Choice = vbYes Then
                Call conns()
                str_sql_user_select = "Delete from [FinPledge] where id=" & id & ""
