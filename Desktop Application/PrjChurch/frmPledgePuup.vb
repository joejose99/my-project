...
Imports System.IO
Public Class frmPledgePuup

    Private Sub frmPledgePuup_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub dtStudent_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dtStudent.DoubleClick
        Try
            ...
            frmPledgeRedeem.AddMebId = dtStudent.CurrentRow.Cells(0).Value
        ...
        Try
            ...
            If rows <> 0 Then
                ...
                While myAccessReader.Read()
                    ...
                    dtStudent.Rows(ro).Cells(2).Value = myAccessReader("vFName")
                    dtStudent.Rows(ro).Cells(3).Value = myAccessReader("vPhoneNo")
    ...
    Private Sub TextBox2_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextBox2.KeyUp
        Try
            ...
            Call conns()
            Dim ro As Integer = 0
            str_sql_user_select = "SELECT COUNT(vMemberId) AS [RecordCount] FROM  [FinPledge]  "
            ...
            Call conns()
            ro = 0
            str_sql_user_select = "SELECT * FROM FinPledge  where vSurname  like '" & TextBox2.Text & "%' "
    ...
    Private Sub TextBox3_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextBox3.KeyUp
        Try
            ...
            Call conns()
            ro = 0
            str_sql_user_select = "SELECT * FROM FinPledge  where vMemberId  like '" & TextBox3.Text & "%'  "
    ...
    Private Sub TextBox4_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextBox4.KeyUp
        Try
            ...
            Call conns()
            ro = 0
            str_sql_user_select = "SELECT * FROM FinPledge  where vFname  like '" & TextBox4.Text & "%'  "
