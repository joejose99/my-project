...
Public Class frmPledge

    Private Sub frmPledge_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Left = 0
        Me.Top = 100
    ...
    Public Property AddMebId() As String
        ...
        Set(ByVal value As String)
            ...
            Try
                ...
                str_sql_user_select = "SELECT * FROM  Church where vMemberId= '" & TextBox6.Text & "'"
                ...
                While myAccessReader.Read()
                    ...
                    TextBox7.Text = myAccessReader("vMobile")
    ...
    Private Sub generateId()
        Try
            ...
            Call conns()
            str_sql_user_select = "SELECT COUNT(vMemberId) AS [RecordCount] FROM  [FinPledge] where vAuto ='" & status & "'  "
            ...
            If rows <> 0 Then
                ...
                Dim maxId As String = ""
                Call conns()
                str_sql_user_select = "select max(id)AS  [Studentid] from FinPledge where vAuto ='" & status & "'  "
                'comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
                'myreader = comUserSelect.ExecuteReader()
                ...
                Call conns()
                str_sql_user_select = "select  [dpaydate] from FinPledge where vAuto ='" & status & "' and id =" & maxId & "  "
                'comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
                'myreader = comUserSelect.ExecuteReader()
    ...
    Private Sub butEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butEdit.Click
        ...
        Try
            ...
            Dim sqlString As String = ""
            sqlString = "INSERT INTO  FinPledge(dpaydate,vYear,vMonth,vSurName,vFName,vPhoneNo,vMemberId,vPurpose,vAuto,mAmount) VALUES(" & _
            "'" & dateapp & "'," & _
             "'" & dYear & "'," & _
              "'" & dMonth1 & "'," & _
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Try
            ...
            Dim dts1 As Integer
            Call conns()
            str_sql_user_select = "select max(id )AS  [Studentid] from FinPledge  "
            ' comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
            'myreader = comUserSelect.ExecuteReader()
            ...
            Call conns()
            str_sql_user_select = "SELECT COUNT(*) AS [RecordCount] FROM   FinPledge  where  vFName= '" & TextBox3.Text.Trim & "'  and  id =" & dts1 & "  "
            ' comUserSelect = New SqlClient.SqlCommand(str_sql_user_select, mycon)
            'myreader = comUserSelect.ExecuteReader()
            comUserSelectS = New OleDbCommand(str_sql_user_select, strconss)
            myAccessReader = comUserSelectS.ExecuteReader()
            ...
            If numbs_pay = 0 Then
                ...
                str_sql_user_select = "SELECT *  FROM FinPledge WHERE vFName ='" & TextBox3.Text.Trim & "'  and    id =" & dts1 & "  "
            ...
            If TextBox1.Text <> "" And TextBox2.Text <> "" Then
                ...
                For Each i As String In Me.ListItems.Items(itm).ToString
                    ...
                    While myAccessReader.Read
                        ...
                        e.Graphics.DrawString("TITHE : ", tablefont, Brushes.Black, X1 + 440, Y + 110)
